...
(function (box2d) {
    ...
    function b2AddVV(a, b, out) {
        out.x = a.x + b.x;
        out.y = a.y + b.y;
        return out;
    }
    box2d.b2AddVV = b2AddVV;
    function b2SubVV(a, b, out) {
        out.x = a.x - b.x;
        out.y = a.y - b.y;
        return out;
    }
    box2d.b2SubVV = b2SubVV;
    function b2MulSV(s, v, out) {
        out.x = v.x * s;
        out.y = v.y * s;
        return out;
    }
    box2d.b2MulSV = b2MulSV;
    function b2AddVMulSV(a, s, b, out) {
        out.x = a.x + (s * b.x);
        out.y = a.y + (s * b.y);
        return out;
    }
    box2d.b2AddVMulSV = b2AddVMulSV;
    function b2SubVMulSV(a, s, b, out) {
        out.x = a.x - (s * b.x);
        out.y = a.y - (s * b.y);
        return out;
    }
    ...
    function b2MidVV(a, b, out) {
        out.x = (a.x + b.x) * 0.5;
        out.y = (a.y + b.y) * 0.5;
        return out;
    }
    box2d.b2MidVV = b2MidVV;
    function b2ExtVV(a, b, out) {
        out.x = (b.x - a.x) * 0.5;
        out.y = (b.y - a.y) * 0.5;
        return out;
    }
...
(function (box2d) {
    ...
    (function (b2DrawFlags) {
        ...
        b2DrawFlags[b2DrawFlags["e_shapeBit"] = 0x0001] = "e_shapeBit";
        b2DrawFlags[b2DrawFlags["e_jointBit"] = 0x0002] = "e_jointBit";
        b2DrawFlags[b2DrawFlags["e_aabbBit"] = 0x0004] = "e_aabbBit";
        b2DrawFlags[b2DrawFlags["e_pairBit"] = 0x0008] = "e_pairBit";
        b2DrawFlags[b2DrawFlags["e_centerOfMassBit"] = 0x0010] = "e_centerOfMassBit";
        b2DrawFlags[b2DrawFlags["e_controllerBit"] = 0x0020] = "e_controllerBit";
        b2DrawFlags[b2DrawFlags["e_all"] = 0x003f] = "e_all";
...
(function (box2d) {
    ...
    var b2CircleShape = (function (_super) {
        ...
        b2CircleShape.prototype.Dump = function () {
            box2d.b2Log("    var shape: b2CircleShape = new b2CircleShape();\n");
...
(function (box2d) {
    ...
    var b2EdgeShape = (function (_super) {
        ...
        b2EdgeShape.prototype.Dump = function () {
            box2d.b2Log("    var shape: b2EdgeShape = new b2EdgeShape();\n");
            box2d.b2Log("    shape.m_radius = %.15f;\n", this.m_radius);
...
(function (box2d) {
    ...
    var b2ChainShape = (function (_super) {
        ...
        b2ChainShape.prototype.Dump = function () {
            box2d.b2Log("    var shape: b2ChainShape = new b2ChainShape();\n");
            box2d.b2Log("    var vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", box2d.b2_maxPolygonVertices);
            for (var i = 0; i < this.m_count; ++i) {
...
(function (box2d) {
    ...
    var b2PolygonShape = (function (_super) {
        ...
        b2PolygonShape.prototype.Dump = function () {
            box2d.b2Log("    var shape: b2PolygonShape = new b2PolygonShape();\n");
            box2d.b2Log("    var vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", box2d.b2_maxPolygonVertices);
            for (var i = 0; i < this.m_count; ++i) {
                box2d.b2Log("    vs[%d].SetXY(%.15f, %.15f);\n", i, this.m_vertices[i].x, this.m_vertices[i].y);
            }
...
(function (box2d) {
    ...
    var b2Fixture = (function () {
        ...
        b2Fixture.prototype.Dump = function (bodyIndex) {
            if (box2d.DEBUG) {
                box2d.b2Log("    var fd: b2FixtureDef = new b2FixtureDef();\n");
...
(function (box2d) {
    ...
    (function (b2ContactFlag) {
        ...
        b2ContactFlag[b2ContactFlag["e_islandFlag"] = 0x0001] = "e_islandFlag";
        b2ContactFlag[b2ContactFlag["e_touchingFlag"] = 0x0002] = "e_touchingFlag";
        b2ContactFlag[b2ContactFlag["e_enabledFlag"] = 0x0004] = "e_enabledFlag";
        b2ContactFlag[b2ContactFlag["e_filterFlag"] = 0x0008] = "e_filterFlag";
        b2ContactFlag[b2ContactFlag["e_bulletHitFlag"] = 0x0010] = "e_bulletHitFlag";
        b2ContactFlag[b2ContactFlag["e_toiFlag"] = 0x0020] = "e_toiFlag"; /// This contact has a valid TOI in m_toi
        ...
        b2Island.prototype.Solve = function (profile, step, gravity, allowSleep) {
            ...
            if (allowSleep) {
                ...
                for (var i = 0; i < this.m_bodyCount; ++i) {
                    ...
                    if ((b.m_flags & 4 /* e_autoSleepFlag */) == 0 || b.m_angularVelocity * b.m_angularVelocity > angTolSqr || box2d.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
                        b.m_sleepTime = 0;
                        minSleepTime = 0;
                    }
                    else {
    ...
    var b2DistanceJoint = (function (_super) {
        ...
        b2DistanceJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                ...
                box2d.b2Log("  var jd: b2DistanceJointDef = new b2DistanceJointDef();\n");
    ...
    var b2WheelJoint = (function (_super) {
        ...
        b2WheelJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2WheelJointDef = new b2WheelJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
    ...
    var b2RevoluteJoint = (function (_super) {
        ...
        b2RevoluteJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2RevoluteJointDef = new b2RevoluteJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
...
(function (box2d) {
    ...
    var b2PrismaticJoint = (function (_super) {
        ...
        b2PrismaticJoint.prototype.GetJointSpeed = function () {
            ...
            var speed = box2d.b2DotVV(d, box2d.b2CrossSV(wA, axis, box2d.b2Vec2.s_t0)) + box2d.b2DotVV(axis, box2d.b2SubVV(box2d.b2AddVCrossSV(vB, wB, rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(vA, wA, rA, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0));
            return speed;
        };
        ...
        b2PrismaticJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2PrismaticJointDef = new b2PrismaticJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
    ...
    var b2PulleyJoint = (function (_super) {
        ...
        b2PulleyJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2PulleyJointDef = new b2PulleyJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
...
(function (box2d) {
    ...
    var b2GearJoint = (function (_super) {
        ...
        b2GearJoint.prototype.SolveVelocityConstraints = function (data) {
            ...
            var Cdot = box2d.b2DotVV(this.m_JvAC, box2d.b2SubVV(vA, vC, box2d.b2Vec2.s_t0)) + box2d.b2DotVV(this.m_JvBD, box2d.b2SubVV(vB, vD, box2d.b2Vec2.s_t0));
        ...
        b2GearJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                ...
                box2d.b2Log("  var jd: b2GearJointDef = new b2GearJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
    ...
    var b2WeldJoint = (function (_super) {
        ...
        b2WeldJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2WeldJointDef = new b2WeldJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
    ...
    var b2FrictionJoint = (function (_super) {
        ...
        b2FrictionJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2FrictionJointDef = new b2FrictionJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
    ...
    var b2RopeJoint = (function (_super) {
        ...
        b2RopeJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2RopeJointDef = new b2RopeJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
                box2d.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
    ...
    var b2MotorJoint = (function (_super) {
        ...
        b2MotorJoint.prototype.Dump = function () {
            if (box2d.DEBUG) {
                var indexA = this.m_bodyA.m_islandIndex;
                var indexB = this.m_bodyB.m_islandIndex;
                box2d.b2Log("  var jd: b2MotorJointDef = new b2MotorJointDef();\n");
                box2d.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                box2d.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                box2d.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
...
(function (box2d) {
    (function (b2WorldFlag) {
        ...
        b2WorldFlag[b2WorldFlag["e_newFixture"] = 0x1] = "e_newFixture";
        b2WorldFlag[b2WorldFlag["e_locked"] = 0x2] = "e_locked";
        b2WorldFlag[b2WorldFlag["e_clearForces"] = 0x4] = "e_clearForces";
    ...
    var b2World = (function () {
        ...
        b2World.prototype.Dump = function () {
            if (box2d.DEBUG) {
                ...
                box2d.b2Log("var g: b2Vec2 = new b2Vec2(%.15f, %.15f);\n", this.m_gravity.x, this.m_gravity.y);
                box2d.b2Log("this.m_world.SetGravity(g);\n");
                box2d.b2Log("var bodies: b2Body[] = new Array(%d);\n", this.m_bodyCount);
                box2d.b2Log("var joints: b2Joint[] = new Array(%d);\n", this.m_jointCount);
                var i = 0;
                for (var b = this.m_bodyList; b; b = b.m_next) {
                    b.m_islandIndex = i;
                    b.Dump();
            ...
            for (;;) {
                ...
                for (var c = this.m_contactManager.m_contactList; c; c = c.m_next) {
                    ...
                    if (c.m_flags & 32 /* e_toiFlag */) {
                        ...
                        var activeA = bA.IsAwake() && typeA != 0 /* b2_staticBody */;
                        var activeB = bB.IsAwake() && typeB != 0 /* b2_staticBody */;
                        // Is at least one body active (awake and dynamic or kinematic)?
                        if (activeA == false && activeB == false) {
                            continue;
                        }
                        var collideA = bA.IsBullet() || typeA != 2 /* b2_dynamicBody */;
                        var collideB = bB.IsBullet() || typeB != 2 /* b2_dynamicBody */;
                ...
                for (var i = 0; i < 2; ++i) {
                    ...
                    if (body.m_type == 2 /* b2_dynamicBody */) {
                        for (var ce = body.m_contactList; ce; ce = ce.next) {
                            ...
                            var other = ce.other;
                            if (other.m_type == 2 /* b2_dynamicBody */ && body.IsBullet() == false && other.IsBullet() == false) {
                                continue;
                            }
                            // Skip sensors.
                            var sensorA = contact.m_fixtureA.m_isSensor;
...
(function (box2d) {
    ...
    (function (b2BodyFlag) {
        ...
        b2BodyFlag[b2BodyFlag["e_islandFlag"] = 0x0001] = "e_islandFlag";
        b2BodyFlag[b2BodyFlag["e_awakeFlag"] = 0x0002] = "e_awakeFlag";
        b2BodyFlag[b2BodyFlag["e_autoSleepFlag"] = 0x0004] = "e_autoSleepFlag";
        b2BodyFlag[b2BodyFlag["e_bulletFlag"] = 0x0008] = "e_bulletFlag";
        b2BodyFlag[b2BodyFlag["e_fixedRotationFlag"] = 0x0010] = "e_fixedRotationFlag";
        b2BodyFlag[b2BodyFlag["e_activeFlag"] = 0x0020] = "e_activeFlag";
        b2BodyFlag[b2BodyFlag["e_toiFlag"] = 0x0040] = "e_toiFlag";
    ...
    var b2Body = (function () {
        ...
        b2Body.prototype.Dump = function () {
            if (box2d.DEBUG) {
                ...
                box2d.b2Log("{\n");
                box2d.b2Log("  var bd: b2BodyDef = new b2BodyDef();\n");
                var type_str = '';
                switch (this.m_type) {
    ...
    (function (Testbed) {
        ...
        var TestEntry = (function () {
            function TestEntry(name, createFcn) {
                this.name = "unknown";
                this.createFcn = function (canvas, settings) {
                    return null;
                };
                this.name = name;
        ...
        var Test = (function (_super) {
            ...
            Test.prototype.DrawTitle = function (title) {
                this.m_debugDraw.DrawString(5, Testbed.DRAW_STRING_NEW_LINE, title);
                this.m_textLine = 2 * Testbed.DRAW_STRING_NEW_LINE;
            };
        ...
        var Car = (function (_super) {
            ...
            function Car(canvas, settings) {
                ...
                if (true) {
                    ...
                    var edge_shape = new box2d.b2EdgeShape();
                    var fd = new box2d.b2FixtureDef();
                    fd.shape = edge_shape;
                    fd.density = 0.0;
                    fd.friction = 0.6;
                ...
                if (true) {
                    ...
                    var wjd = new box2d.b2WheelJointDef();
...
(function (box2d) {
    ...
    (function (Testbed) {
        ...
        Testbed.GetTestEntries = GetTestEntries;
    })(Testbed = box2d.Testbed || (box2d.Testbed = {}));
})(box2d || (box2d = {})); // module box2d.Testbed
///<reference path='../../../Box2D/Testbed/Framework/Render.ts' />
///<reference path='../../../Box2D/Testbed/Framework/Test.ts' />
            ...
            function Main() {
                ...
                var connect_number_input = function (parent, label, id, min, max, step) {
                    ...
                    number_input.addEventListener('change', function (e) {
                        that.m_settings[id] = parseInt(this.value, 10);
                    }, false);
                ...
                var connect_checkbox_input = function (parent, label, id) {
                    ...
                    checkbox_input.addEventListener('click', function (e) {
                        that.m_settings[id] = this.checked;
                    }, false);
