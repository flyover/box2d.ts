...
System.register("Box2D/Common/b2Math", ["Box2D/Common/b2Settings"], function(exports_2, context_2) {
    ...
    exports_2("b2AbsV", b2AbsV);
    function b2MinV(a, b, out) {
        out.x = b2Min(a.x, b.x);
        out.y = b2Min(a.y, b.y);
        return out;
    }
    exports_2("b2MinV", b2MinV);
    function b2MaxV(a, b, out) {
        out.x = b2Max(a.x, b.x);
        out.y = b2Max(a.y, b.y);
        return out;
    }
    exports_2("b2MaxV", b2MaxV);
    function b2ClampV(v, lo, hi, out) {
        out.x = b2Clamp(v.x, lo.x, hi.x);
        out.y = b2Clamp(v.y, lo.y, hi.y);
        return out;
    }
    exports_2("b2ClampV", b2ClampV);
    ...
    exports_2("b2RotateV", b2RotateV);
    function b2DotVV(a, b) {
        return a.x * b.x + a.y * b.y;
    }
    exports_2("b2DotVV", b2DotVV);
    function b2CrossVV(a, b) {
        return a.x * b.y - a.y * b.x;
    }
    exports_2("b2CrossVV", b2CrossVV);
    ...
    exports_2("b2CrossVOne", b2CrossVOne);
    ...
    exports_2("b2CrossV3V3", b2CrossV3V3);
    ...
    exports_2("b2MulM33V3", b2MulM33V3);
    ...
    exports_2("b2MulM33XYZ", b2MulM33XYZ);
    ...
    exports_2("b2MulM33V2", b2MulM33V2);
    function b2MulM33XY(A, x, y, out) {
        out.x = A.ex.x * x + A.ey.x * y;
        out.y = A.ex.y * x + A.ey.y * y;
        return out;
    }
    exports_2("b2MulM33XY", b2MulM33XY);
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Common/b2Draw", ["Box2D/Common/b2Math"], function(exports_3, context_3) {
    "use strict";
...
System.register("Box2D/Collision/b2Distance", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_8, context_8) {
    ...
    var b2Settings_2, b2Settings_3, b2Settings_4, b2Math_2, b2Math_3, b2Math_4, b2Math_5, b2Math_6, b2Math_7, b2Math_8;
    ...
    function b2Distance(output, cache, input) {
        ...
        while (iter < k_maxIters) {
            ...
            switch (simplex.m_count) {
                ...
                case 3:
                    ...
                    break;
                default:
                    if (b2Settings_2.ENABLE_ASSERTS) {
                        b2Settings_2.b2Assert(false);
                    }
                    break;
            }
            ...
            */
            ...
            if (d.GetLengthSquared() < b2Settings_3.b2_epsilon_sq) {
            ...
            vertex.indexA = proxyA.GetSupport(b2Math_7.b2MulTRV(transformA.q, b2Math_4.b2NegV(d, b2Math_2.b2Vec2.s_t0), b2Distance_s_supportA));
            b2Math_8.b2MulXV(transformA, proxyA.GetVertex(vertex.indexA), vertex.wA);
            vertex.indexB = proxyB.GetSupport(b2Math_7.b2MulTRV(transformB.q, d, b2Distance_s_supportB));
            b2Math_8.b2MulXV(transformB, proxyB.GetVertex(vertex.indexB), vertex.wB);
            b2Math_4.b2SubVV(vertex.wB, vertex.wA, vertex.w);
        ...
        exports_8("b2_gjkMaxIters", b2_gjkMaxIters = b2Math_3.b2Max(b2_gjkMaxIters, iter));
        // Prepare output.
        simplex.GetWitnessPoints(output.pointA, output.pointB);
        output.distance = b2Math_6.b2DistanceVV(output.pointA, output.pointB);
        ...
        if (input.useRadii) {
            ...
            if (output.distance > (rA + rB) && output.distance > b2Settings_3.b2_epsilon) {
                ...
                const normal = b2Math_4.b2SubVV(output.pointB, output.pointA, b2Distance_s_normal);
                normal.Normalize();
                ...
                const p = b2Math_4.b2MidVV(output.pointA, output.pointB, b2Distance_s_p);
    ...
    return {
        setters:[
            function (b2Settings_2_1) {
                ...
                b2Settings_3 = b2Settings_2_1;
                b2Settings_4 = b2Settings_2_1;
            },
            function (b2Math_2_1) {
                b2Math_2 = b2Math_2_1;
                b2Math_3 = b2Math_2_1;
        ...
        execute: function() {
            ...
            b2DistanceProxy = class b2DistanceProxy {
                ...
                GetSupport(d) {
                    let bestIndex = 0;
                    let bestValue = b2Math_4.b2DotVV(this.m_vertices[0], d);
                    for (let i = 1; i < this.m_count; ++i) {
                        const value = b2Math_4.b2DotVV(this.m_vertices[i], d);
                        if (value > bestValue) {
                            bestIndex = i;
                            bestValue = value;
                        }
                ...
                GetVertex(index) {
                    if (b2Settings_2.ENABLE_ASSERTS) {
                        b2Settings_2.b2Assert(0 <= index && index < this.m_count);
                    }
            ...
            b2SimplexCache = class b2SimplexCache {
                constructor() {
                    this.metric = 0;
                    this.count = 0;
                    this.indexA = b2Settings_4.b2MakeNumberArray(3);
                    this.indexB = b2Settings_4.b2MakeNumberArray(3);
                }
                Reset() {
                    this.metric = 0;
                    this.count = 0;
            ...
            b2Simplex = class b2Simplex {
                ...
                ReadCache(cache, proxyA, transformA, proxyB, transformB) {
                    if (b2Settings_2.ENABLE_ASSERTS) {
                        b2Settings_2.b2Assert(0 <= cache.count && cache.count <= 3);
                    }
                    ...
                    for (let i = 0; i < this.m_count; ++i) {
                        ...
                        b2Math_8.b2MulXV(transformA, wALocal, v.wA);
                        b2Math_8.b2MulXV(transformB, wBLocal, v.wB);
                        b2Math_4.b2SubVV(v.wB, v.wA, v.w);
                        v.a = 0;
                    }
                ...
                GetSearchDirection(out) {
                    switch (this.m_count) {
                        case 1:
                            return b2Math_4.b2NegV(this.m_v1.w, out);
                        case 2: {
                            const e12 = b2Math_4.b2SubVV(this.m_v2.w, this.m_v1.w, out);
                            const sgn = b2Math_5.b2CrossVV(e12, b2Math_4.b2NegV(this.m_v1.w, b2Math_2.b2Vec2.s_t0));
                            if (sgn > 0) {
                                // Origin is left of e12.
                                return b2Math_5.b2CrossOneV(e12, out);
                            }
                            else {
                                // Origin is right of e12.
                                return b2Math_5.b2CrossVOne(e12, out);
                            }
                        }
                        default:
                            if (b2Settings_2.ENABLE_ASSERTS) {
                ...
                GetMetric() {
                    switch (this.m_count) {
                        ...
                        case 1:
                            return 0;
                        case 2:
                            return b2Math_6.b2DistanceVV(this.m_v1.w, this.m_v2.w);
                        case 3:
                            return b2Math_5.b2CrossVV(b2Math_4.b2SubVV(this.m_v2.w, this.m_v1.w, b2Math_2.b2Vec2.s_t0), b2Math_4.b2SubVV(this.m_v3.w, this.m_v1.w, b2Math_2.b2Vec2.s_t1));
                        default:
                            if (b2Settings_2.ENABLE_ASSERTS) {
                                b2Settings_2.b2Assert(false);
                            }
                ...
                Solve2() {
                    ...
                    const e12 = b2Math_4.b2SubVV(w2, w1, b2Simplex.s_e12);
                    // w1 region
                    const d12_2 = (-b2Math_4.b2DotVV(w1, e12));
                    if (d12_2 <= 0) {
                    ...
                    // w2 region
                    const d12_1 = b2Math_4.b2DotVV(w2, e12);
                    if (d12_1 <= 0) {
                ...
                Solve3() {
                    ...
                    // a3 = 0
                    const e12 = b2Math_4.b2SubVV(w2, w1, b2Simplex.s_e12);
                    const w1e12 = b2Math_4.b2DotVV(w1, e12);
                    const w2e12 = b2Math_4.b2DotVV(w2, e12);
                    const d12_1 = w2e12;
                    const d12_2 = (-w1e12);
                    // Edge13
                    // [1      1     ][a1] = [1]
                    // [w1.e13 w3.e13][a3] = [0]
                    // a2 = 0
                    const e13 = b2Math_4.b2SubVV(w3, w1, b2Simplex.s_e13);
                    const w1e13 = b2Math_4.b2DotVV(w1, e13);
                    const w3e13 = b2Math_4.b2DotVV(w3, e13);
                    const d13_1 = w3e13;
                    const d13_2 = (-w1e13);
                    // Edge23
                    // [1      1     ][a2] = [1]
                    // [w2.e23 w3.e23][a3] = [0]
                    // a1 = 0
                    const e23 = b2Math_4.b2SubVV(w3, w2, b2Simplex.s_e23);
                    const w2e23 = b2Math_4.b2DotVV(w2, e23);
                    const w3e23 = b2Math_4.b2DotVV(w3, e23);
                    const d23_1 = w3e23;
                    const d23_2 = (-w2e23);
                    // Triangle123
                    const n123 = b2Math_5.b2CrossVV(e12, e13);
                    const d123_1 = n123 * b2Math_5.b2CrossVV(w2, w3);
                    const d123_2 = n123 * b2Math_5.b2CrossVV(w3, w1);
                    const d123_3 = n123 * b2Math_5.b2CrossVV(w1, w2);
                    // w1 region
                    if (d12_2 <= 0 && d13_2 <= 0) {
                        this.m_v1.a = 1;
                        this.m_count = 1;
            ...
            b2Distance_s_saveA = b2Settings_4.b2MakeNumberArray(3);
            b2Distance_s_saveB = b2Settings_4.b2MakeNumberArray(3);
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Collision/Shapes/b2Shape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_9, context_9) {
    "use strict";
    var __moduleName = context_9 && context_9.id;
    var b2Settings_5, b2Math_9;
        ...
        execute: function() {
            ...
            b2MassData = class b2MassData {
                constructor() {
                    ...
                    this.center = new b2Math_9.b2Vec2(0, 0);
            ...
            b2Shape = class b2Shape {
                ...
                Clone() {
                    if (b2Settings_5.ENABLE_ASSERTS) {
                        b2Settings_5.b2Assert(false);
                    }
                    return null;
                }
                Copy(other) {
                    if (b2Settings_5.ENABLE_ASSERTS) {
                        b2Settings_5.b2Assert(this.m_type === other.m_type);
                    }
                ...
                GetChildCount() {
                    if (b2Settings_5.ENABLE_ASSERTS) {
                        b2Settings_5.b2Assert(false, "pure virtual");
                    }
                    return 0;
                }
...
System.register("Box2D/Collision/b2Collision", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Distance"], function(exports_10, context_10) {
    ...
    var b2Settings_6, b2Settings_7, b2Settings_8, b2Math_10, b2Math_11, b2Math_12, b2Math_13, b2Math_14, b2Math_15, b2Math_16, b2Distance_1;
    ...
    function b2GetPointStates(state1, state2, manifold1, manifold2) {
        ...
        for (; i < b2Settings_7.b2_maxManifoldPoints; ++i) {
    ...
    function b2ClipSegmentToLine(vOut, vIn, normal, offset, vertexIndexA) {
        ...
        const distance0 = b2Math_12.b2DotVV(normal, vIn0.v) - offset;
        const distance1 = b2Math_12.b2DotVV(normal, vIn1.v) - offset;
    ...
    function b2TestOverlapShape(shapeA, indexA, shapeB, indexB, xfA, xfB) {
        ...
        return output.distance < 10 * b2Settings_7.b2_epsilon;
    }
    ...
    return {
        setters:[
            function (b2Settings_6_1) {
                ...
                b2Settings_7 = b2Settings_6_1;
                b2Settings_8 = b2Settings_6_1;
            },
            function (b2Math_10_1) {
                b2Math_10 = b2Math_10_1;
                b2Math_11 = b2Math_10_1;
                b2Math_12 = b2Math_10_1;
                b2Math_13 = b2Math_10_1;
                b2Math_14 = b2Math_10_1;
                b2Math_15 = b2Math_10_1;
                b2Math_16 = b2Math_10_1;
            },
        ...
        execute: function() {
            ...
            b2ManifoldPoint = class b2ManifoldPoint {
                constructor() {
                    this.localPoint = new b2Math_10.b2Vec2(); ///< usage depends on manifold type
                ...
                static MakeArray(length) {
                    return b2Settings_8.b2MakeArray(length, function (i) { return new b2ManifoldPoint(); });
                }
                Reset() {
            ...
            b2Manifold = class b2Manifold {
                constructor() {
                    this.points = b2ManifoldPoint.MakeArray(b2Settings_7.b2_maxManifoldPoints);
                    this.localNormal = new b2Math_10.b2Vec2();
                    this.localPoint = new b2Math_10.b2Vec2();
                    this.type = -1 /* e_unknown */;
                    this.pointCount = 0;
                }
                Reset() {
                    for (let i = 0, ict = b2Settings_7.b2_maxManifoldPoints; i < ict; ++i) {
                        if (b2Settings_6.ENABLE_ASSERTS) {
                            b2Settings_6.b2Assert(this.points[i] instanceof b2ManifoldPoint);
                        }
                        this.points[i].Reset();
                    }
            ...
            b2WorldManifold = class b2WorldManifold {
                constructor() {
                    this.normal = new b2Math_10.b2Vec2();
                    this.points = b2Math_10.b2Vec2.MakeArray(b2Settings_7.b2_maxManifoldPoints);
                }
                        ...
                        case 0 /* e_circles */:
                            {
                                ...
                                const pointA = b2Math_15.b2MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_pointA);
                                const pointB = b2Math_15.b2MulXV(xfB, manifold.points[0].localPoint, b2WorldManifold.Initialize_s_pointB);
                                if (b2Math_16.b2DistanceSquaredVV(pointA, pointB) > b2Settings_7.b2_epsilon_sq) {
                                    b2Math_12.b2SubVV(pointB, pointA, this.normal).SelfNormalize();
                                }
                                const cA = b2Math_13.b2AddVMulSV(pointA, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
                                const cB = b2Math_13.b2SubVMulSV(pointB, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
                                b2Math_12.b2MidVV(cA, cB, this.points[0]);
                            }
                            break;
                        case 1 /* e_faceA */:
                            {
                                b2Math_14.b2MulRV(xfA.q, manifold.localNormal, this.normal);
                                const planePoint = b2Math_15.b2MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
                                for (let i = 0, ict = manifold.pointCount; i < ict; ++i) {
                                    const clipPoint = b2Math_15.b2MulXV(xfB, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
                                    const s = radiusA - b2Math_12.b2DotVV(b2Math_12.b2SubVV(clipPoint, planePoint, b2Math_10.b2Vec2.s_t0), this.normal);
                                    const cA = b2Math_13.b2AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cA);
                                    const cB = b2Math_13.b2SubVMulSV(clipPoint, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
                                    b2Math_12.b2MidVV(cA, cB, this.points[i]);
                                }
                            }
                            break;
                        case 2 /* e_faceB */:
                            {
                                b2Math_14.b2MulRV(xfB.q, manifold.localNormal, this.normal);
                                const planePoint = b2Math_15.b2MulXV(xfB, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
                                for (let i = 0, ict = manifold.pointCount; i < ict; ++i) {
                                    const clipPoint = b2Math_15.b2MulXV(xfA, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
                                    const s = radiusB - b2Math_12.b2DotVV(b2Math_12.b2SubVV(clipPoint, planePoint, b2Math_10.b2Vec2.s_t0), this.normal);
                                    const cB = b2Math_13.b2AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cB);
                                    const cA = b2Math_13.b2SubVMulSV(clipPoint, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
                                    b2Math_12.b2MidVV(cA, cB, this.points[i]);
                                }
            ...
            b2WorldManifold.Initialize_s_pointA = new b2Math_10.b2Vec2();
            b2WorldManifold.Initialize_s_pointB = new b2Math_10.b2Vec2();
            b2WorldManifold.Initialize_s_cA = new b2Math_10.b2Vec2();
            b2WorldManifold.Initialize_s_cB = new b2Math_10.b2Vec2();
            b2WorldManifold.Initialize_s_planePoint = new b2Math_10.b2Vec2();
            b2WorldManifold.Initialize_s_clipPoint = new b2Math_10.b2Vec2();
            exports_10("b2WorldManifold", b2WorldManifold);
            /// Used for computing contact manifolds.
            b2ClipVertex = class b2ClipVertex {
                constructor() {
                    this.v = new b2Math_10.b2Vec2();
                    this.id = new b2ContactID();
                }
                static MakeArray(length) {
                    return b2Settings_8.b2MakeArray(length, function (i) { return new b2ClipVertex(); });
                }
                Copy(other) {
                    this.v.Copy(other.v);
            ...
            b2RayCastInput = class b2RayCastInput {
                constructor() {
                    this.p1 = new b2Math_10.b2Vec2();
                    this.p2 = new b2Math_10.b2Vec2();
                    this.maxFraction = 1;
                }
                Copy(o) {
                    this.p1.Copy(o.p1);
            ...
            b2AABB = class b2AABB {
                constructor() {
                    this.lowerBound = new b2Math_10.b2Vec2(); ///< the lower vertex
                    this.upperBound = new b2Math_10.b2Vec2(); ///< the upper vertex
                    this.m_cache_center = new b2Math_10.b2Vec2(); // access using GetCenter()
                    this.m_cache_extent = new b2Math_10.b2Vec2(); // access using GetExtents()
                }
                Copy(o) {
                ...
                GetCenter() {
                    return b2Math_12.b2MidVV(this.lowerBound, this.upperBound, this.m_cache_center);
                }
                /// Get the extents of the AABB (half-widths).
                GetExtents() {
                    return b2Math_12.b2ExtVV(this.lowerBound, this.upperBound, this.m_cache_extent);
                }
                ...
                Combine1(aabb) {
                    this.lowerBound.x = b2Math_11.b2Min(this.lowerBound.x, aabb.lowerBound.x);
                    this.lowerBound.y = b2Math_11.b2Min(this.lowerBound.y, aabb.lowerBound.y);
                    this.upperBound.x = b2Math_11.b2Max(this.upperBound.x, aabb.upperBound.x);
                    this.upperBound.y = b2Math_11.b2Max(this.upperBound.y, aabb.upperBound.y);
                    return this;
                }
                /// Combine two AABBs into this one.
                Combine2(aabb1, aabb2) {
                    this.lowerBound.x = b2Math_11.b2Min(aabb1.lowerBound.x, aabb2.lowerBound.x);
                    this.lowerBound.y = b2Math_11.b2Min(aabb1.lowerBound.y, aabb2.lowerBound.y);
                    this.upperBound.x = b2Math_11.b2Max(aabb1.upperBound.x, aabb2.upperBound.x);
                    this.upperBound.y = b2Math_11.b2Max(aabb1.upperBound.y, aabb2.upperBound.y);
                    return this;
                }
                ...
                RayCast(output, input) {
                    let tmin = (-b2Settings_7.b2_maxFloat);
                    let tmax = b2Settings_7.b2_maxFloat;
                    const p_x = input.p1.x;
                    const p_y = input.p1.y;
                    const d_x = input.p2.x - input.p1.x;
                    const d_y = input.p2.y - input.p1.y;
                    const absD_x = b2Math_11.b2Abs(d_x);
                    const absD_y = b2Math_11.b2Abs(d_y);
                    const normal = output.normal;
                    if (absD_x < b2Settings_7.b2_epsilon) {
                        // Parallel.
                        ...
                        // Pull the max down
                        tmax = b2Math_11.b2Min(tmax, t2);
                        if (tmin > tmax) {
                            return false;
                        }
                    }
                    if (absD_y < b2Settings_7.b2_epsilon) {
                        // Parallel.
...
System.register("Box2D/Collision/b2DynamicTree", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2GrowableStack", "Box2D/Collision/b2Collision"], function(exports_11, context_11) {
    ...
    var b2Settings_9, b2Settings_10, b2Math_17, b2Math_18, b2Math_19, b2Math_20, b2GrowableStack_1, b2Collision_1;
    var b2TreeNode, b2DynamicTree;
    return {
        setters:[
            function (b2Settings_9_1) {
                b2Settings_9 = b2Settings_9_1;
                b2Settings_10 = b2Settings_9_1;
            },
            function (b2Math_17_1) {
                b2Math_17 = b2Math_17_1;
                b2Math_18 = b2Math_17_1;
                b2Math_19 = b2Math_17_1;
                b2Math_20 = b2Math_17_1;
            },
        ...
        execute: function() {
            ...
            b2DynamicTree = class b2DynamicTree {
                ...
                GetUserData(proxy) {
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(proxy !== null);
                    }
                ...
                RayCast(callback, input) {
                    ...
                    const p1 = input.p1;
                    const p2 = input.p2;
                    const r = b2Math_19.b2SubVV(p2, p1, b2DynamicTree.s_r);
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(r.GetLengthSquared() > 0);
                    }
                    r.Normalize();
                    // v is perpendicular to the segment.
                    const v = b2Math_20.b2CrossOneV(r, b2DynamicTree.s_v);
                    const abs_v = b2Math_19.b2AbsV(v, b2DynamicTree.s_abs_v);
                    ...
                    segmentAABB.lowerBound.x = b2Math_18.b2Min(p1.x, t_x);
                    segmentAABB.lowerBound.y = b2Math_18.b2Min(p1.y, t_y);
                    segmentAABB.upperBound.x = b2Math_18.b2Max(p1.x, t_x);
                    segmentAABB.upperBound.y = b2Math_18.b2Max(p1.y, t_y);
                    const stack = b2DynamicTree.s_stack.Reset();
                    stack.Push(this.m_root);
                    while (stack.GetCount() > 0) {
                        const node = stack.Pop();
                        ...
                        const separation = b2Math_18.b2Abs(b2Math_19.b2DotVV(v, b2Math_19.b2SubVV(p1, c, b2Math_17.b2Vec2.s_t0))) - b2Math_19.b2DotVV(abs_v, h);
                        if (separation > 0) {
                            continue;
                        }
                        if (node.IsLeaf()) {
                ...
                CreateProxy(aabb, userData) {
                    ...
                    // Fatten the aabb.
                    const r_x = b2Settings_10.b2_aabbExtension;
                    const r_y = b2Settings_10.b2_aabbExtension;
                ...
                DestroyProxy(proxy) {
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(proxy.IsLeaf());
                    }
                ...
                MoveProxy(proxy, aabb, displacement) {
                    ...
                    const r_x = b2Settings_10.b2_aabbExtension + b2Settings_10.b2_aabbMultiplier * (displacement.x > 0 ? displacement.x : (-displacement.x));
                    const r_y = b2Settings_10.b2_aabbExtension + b2Settings_10.b2_aabbMultiplier * (displacement.y > 0 ? displacement.y : (-displacement.y));
                ...
                InsertLeaf(leaf) {
                    ...
                    while (index !== null) {
                        ...
                        child2 = index.child2;
                        if (b2Settings_9.ENABLE_ASSERTS) {
                            b2Settings_9.b2Assert(child1 !== null);
                        }
                        if (b2Settings_9.ENABLE_ASSERTS) {
                            b2Settings_9.b2Assert(child2 !== null);
                        }
                        index.height = 1 + b2Math_18.b2Max(child1.height, child2.height);
                    ...
                    if (balance > 1) {
                        ...
                        if (C.parent !== null) {
                            if (C.parent.child1 === A) {
                                ...
                                if (b2Settings_9.ENABLE_ASSERTS) {
                                    b2Settings_9.b2Assert(C.parent.child2 === A);
                                }
                                C.parent.child2 = C;
                            }
                        }
                        ...
                        if (F.height > G.height) {
                            ...
                            A.height = 1 + b2Math_18.b2Max(B.height, G.height);
                            C.height = 1 + b2Math_18.b2Max(A.height, F.height);
                        }
                        else {
                            C.child2 = G;
                            A.child2 = F;
                            ...
                            A.height = 1 + b2Math_18.b2Max(B.height, F.height);
                            C.height = 1 + b2Math_18.b2Max(A.height, G.height);
                        }
                        return C;
                    }
                    // Rotate B up
                    if (balance < -1) {
                        ...
                        if (B.parent !== null) {
                            if (B.parent.child1 === A) {
                                ...
                                if (b2Settings_9.ENABLE_ASSERTS) {
                                    b2Settings_9.b2Assert(B.parent.child2 === A);
                                }
                                B.parent.child2 = B;
                            }
                        }
                        ...
                        if (D.height > E.height) {
                            ...
                            A.height = 1 + b2Math_18.b2Max(C.height, E.height);
                            B.height = 1 + b2Math_18.b2Max(A.height, D.height);
                        }
                        else {
                            B.child2 = E;
                            A.child1 = D;
                            ...
                            A.height = 1 + b2Math_18.b2Max(C.height, D.height);
                            B.height = 1 + b2Math_18.b2Max(A.height, E.height);
                        }
                        return B;
                    }
                    return A;
                ...
                ComputeHeightNode(node) {
                    ...
                    return 1 + b2Math_18.b2Max(height1, height2);
                }
                ComputeHeight() {
                ...
                ValidateStructure(index) {
                    ...
                    if (index === this.m_root) {
                        if (b2Settings_9.ENABLE_ASSERTS) {
                            b2Settings_9.b2Assert(index.parent === null);
                        }
                    }
                    const node = index;
                    ...
                    if (node.IsLeaf()) {
                        ...
                        if (b2Settings_9.ENABLE_ASSERTS) {
                            b2Settings_9.b2Assert(node.height === 0);
                        }
                        return;
                    }
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(child1.parent === index);
                    }
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(child2.parent === index);
                    }
                ...
                ValidateMetrics(index) {
                    ...
                    const height = 1 + b2Math_18.b2Max(height1, height2);
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(node.height === height);
                    }
                    const aabb = b2DynamicTree.s_aabb;
                    aabb.Combine2(child1.aabb, child2.aabb);
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(aabb.lowerBound === node.aabb.lowerBound);
                    }
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(aabb.upperBound === node.aabb.upperBound);
                    }
                ...
                Validate() {
                    ...
                    if (b2Settings_9.ENABLE_ASSERTS) {
                        b2Settings_9.b2Assert(this.GetHeight() === this.ComputeHeight());
                    }
                }
                GetMaxBalance() {
                    const GetMaxBalanceNode = function (node, maxBalance) {
                        ...
                        if (b2Settings_9.ENABLE_ASSERTS) {
                            b2Settings_9.b2Assert(node.IsLeaf() === false);
                        }
                        const child1 = node.child1;
                        const child2 = node.child2;
                        const balance = b2Math_18.b2Abs(child2.height - child1.height);
                        return b2Math_18.b2Max(maxBalance, balance);
                    };
            ...
            b2DynamicTree.s_r = new b2Math_17.b2Vec2();
            b2DynamicTree.s_v = new b2Math_17.b2Vec2();
            b2DynamicTree.s_abs_v = new b2Math_17.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Collision/b2BroadPhase", ["Box2D/Collision/b2Collision", "Box2D/Collision/b2DynamicTree"], function(exports_12, context_12) {
    "use strict";
    ...
    exports_12("b2PairLessThan", b2PairLessThan);
    return {
        setters:[
        ...
        execute: function() {
            ...
            exports_12("b2BroadPhase", b2BroadPhase);
        }
    }
});
/*
...
System.register("Box2D/Collision/b2TimeOfImpact", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Timer", "Box2D/Collision/b2Distance"], function(exports_13, context_13) {
    ...
    var b2Settings_11, b2Settings_12, b2Settings_13, b2Math_21, b2Math_22, b2Math_23, b2Math_24, b2Math_25, b2Math_26, b2Timer_1, b2Distance_2;
    ...
    function b2TimeOfImpact(output, input) {
        ...
        const target = b2Math_22.b2Max(b2Settings_12.b2_linearSlop, totalRadius - 3 * b2Settings_12.b2_linearSlop);
        const tolerance = 0.25 * b2Settings_12.b2_linearSlop;
        if (b2Settings_11.ENABLE_ASSERTS) {
            b2Settings_11.b2Assert(target > tolerance);
        }
        let t1 = 0;
            ...
            */
            ...
            for (;;) {
                ...
                for (;;) {
                    ...
                    if (b2Math_22.b2Abs(s - target) < tolerance) {
                ...
                exports_13("b2_toiMaxRootIters", b2_toiMaxRootIters = b2Math_22.b2Max(b2_toiMaxRootIters, rootIterCount));
                ++pushBackIter;
                if (pushBackIter === b2Settings_12.b2_maxPolygonVertices) {
                    break;
                }
            }
            ++iter;
        ...
        exports_13("b2_toiMaxIters", b2_toiMaxIters = b2Math_22.b2Max(b2_toiMaxIters, iter));
        const time = timer.GetMilliseconds();
        exports_13("b2_toiMaxTime", b2_toiMaxTime = b2Math_22.b2Max(b2_toiMaxTime, time));
    ...
    return {
        setters:[
            function (b2Settings_11_1) {
                ...
                b2Settings_12 = b2Settings_11_1;
                b2Settings_13 = b2Settings_11_1;
            },
            function (b2Math_21_1) {
                b2Math_21 = b2Math_21_1;
                b2Math_22 = b2Math_21_1;
                b2Math_23 = b2Math_21_1;
                b2Math_24 = b2Math_21_1;
                b2Math_25 = b2Math_21_1;
                b2Math_26 = b2Math_21_1;
            },
        ...
        execute: function() {
            ...
            b2TimeOfImpact_s_xfA = new b2Math_21.b2Transform();
            b2TimeOfImpact_s_xfB = new b2Math_21.b2Transform();
            b2TimeOfImpact_s_pointA = new b2Math_21.b2Vec2();
            b2TimeOfImpact_s_pointB = new b2Math_21.b2Vec2();
            b2TimeOfImpact_s_normal = new b2Math_21.b2Vec2();
            b2TimeOfImpact_s_axisA = new b2Math_21.b2Vec2();
            b2TimeOfImpact_s_axisB = new b2Math_21.b2Vec2();
            ...
            b2TOIInput = class b2TOIInput {
                constructor() {
                    ...
                    this.sweepA = new b2Math_21.b2Sweep();
                    this.sweepB = new b2Math_21.b2Sweep();
            ...
            b2SeparationFunction = class b2SeparationFunction {
                constructor() {
                    this.m_proxyA = null;
                    this.m_proxyB = null;
                    this.m_sweepA = new b2Math_21.b2Sweep();
                    this.m_sweepB = new b2Math_21.b2Sweep();
                    this.m_type = -1 /* e_unknown */;
                    this.m_localPoint = new b2Math_21.b2Vec2();
                    this.m_axis = new b2Math_21.b2Vec2();
                }
                Initialize(cache, proxyA, sweepA, proxyB, sweepB, t1) {
                    ...
                    if (b2Settings_11.ENABLE_ASSERTS) {
                        b2Settings_11.b2Assert(0 < count && count < 3);
                    }
                    ...
                    if (count === 1) {
                        ...
                        const pointA = b2Math_26.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
                        const pointB = b2Math_26.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
                        b2Math_23.b2SubVV(pointB, pointA, this.m_axis);
                        ...
                        b2Math_24.b2CrossVOne(b2Math_23.b2SubVV(localPointB2, localPointB1, b2Math_21.b2Vec2.s_t0), this.m_axis).SelfNormalize();
                        const normal = b2Math_25.b2MulRV(xfB.q, this.m_axis, b2TimeOfImpact_s_normal);
                        b2Math_23.b2MidVV(localPointB1, localPointB2, this.m_localPoint);
                        const pointB = b2Math_26.b2MulXV(xfB, this.m_localPoint, b2TimeOfImpact_s_pointB);
                        const localPointA = this.m_proxyA.GetVertex(cache.indexA[0]);
                        const pointA = b2Math_26.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
                        let s = b2Math_23.b2DotVV(b2Math_23.b2SubVV(pointA, pointB, b2Math_21.b2Vec2.s_t0), normal);
                        if (s < 0) {
                            this.m_axis.SelfNeg();
                            s = -s;
                        }
                        ...
                        b2Math_24.b2CrossVOne(b2Math_23.b2SubVV(localPointA2, localPointA1, b2Math_21.b2Vec2.s_t0), this.m_axis).SelfNormalize();
                        const normal = b2Math_25.b2MulRV(xfA.q, this.m_axis, b2TimeOfImpact_s_normal);
                        b2Math_23.b2MidVV(localPointA1, localPointA2, this.m_localPoint);
                        const pointA = b2Math_26.b2MulXV(xfA, this.m_localPoint, b2TimeOfImpact_s_pointA);
                        const localPointB = this.m_proxyB.GetVertex(cache.indexB[0]);
                        const pointB = b2Math_26.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
                        let s = b2Math_23.b2DotVV(b2Math_23.b2SubVV(pointB, pointA, b2Math_21.b2Vec2.s_t0), normal);
                        if (s < 0) {
                            this.m_axis.SelfNeg();
                            s = -s;
                        }
                ...
                FindMinSeparation(indexA, indexB, t) {
                    ...
                    switch (this.m_type) {
                        case 0 /* e_points */: {
                            const axisA = b2Math_25.b2MulTRV(xfA.q, this.m_axis, b2TimeOfImpact_s_axisA);
                            const axisB = b2Math_25.b2MulTRV(xfB.q, b2Math_23.b2NegV(this.m_axis, b2Math_21.b2Vec2.s_t0), b2TimeOfImpact_s_axisB);
                            ...
                            const pointA = b2Math_26.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
                            const pointB = b2Math_26.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
                            const separation = b2Math_23.b2DotVV(b2Math_23.b2SubVV(pointB, pointA, b2Math_21.b2Vec2.s_t0), this.m_axis);
                            return separation;
                        }
                        case 1 /* e_faceA */: {
                            const normal = b2Math_25.b2MulRV(xfA.q, this.m_axis, b2TimeOfImpact_s_normal);
                            const pointA = b2Math_26.b2MulXV(xfA, this.m_localPoint, b2TimeOfImpact_s_pointA);
                            const axisB = b2Math_25.b2MulTRV(xfB.q, b2Math_23.b2NegV(normal, b2Math_21.b2Vec2.s_t0), b2TimeOfImpact_s_axisB);
                            indexA[0] = -1;
                            indexB[0] = this.m_proxyB.GetSupport(axisB);
                            const localPointB = this.m_proxyB.GetVertex(indexB[0]);
                            const pointB = b2Math_26.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
                            const separation = b2Math_23.b2DotVV(b2Math_23.b2SubVV(pointB, pointA, b2Math_21.b2Vec2.s_t0), normal);
                            return separation;
                        }
                        case 2 /* e_faceB */: {
                            const normal = b2Math_25.b2MulRV(xfB.q, this.m_axis, b2TimeOfImpact_s_normal);
                            const pointB = b2Math_26.b2MulXV(xfB, this.m_localPoint, b2TimeOfImpact_s_pointB);
                            const axisA = b2Math_25.b2MulTRV(xfA.q, b2Math_23.b2NegV(normal, b2Math_21.b2Vec2.s_t0), b2TimeOfImpact_s_axisA);
                            indexB[0] = -1;
                            indexA[0] = this.m_proxyA.GetSupport(axisA);
                            const localPointA = this.m_proxyA.GetVertex(indexA[0]);
                            const pointA = b2Math_26.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
                            const separation = b2Math_23.b2DotVV(b2Math_23.b2SubVV(pointA, pointB, b2Math_21.b2Vec2.s_t0), normal);
                            return separation;
                        }
                        default:
                            if (b2Settings_11.ENABLE_ASSERTS) {
                                b2Settings_11.b2Assert(false);
                            }
                            indexA[0] = -1;
                            indexB[0] = -1;
                            return 0;
            ...
            b2TimeOfImpact_s_indexA = b2Settings_13.b2MakeNumberArray(1);
            b2TimeOfImpact_s_indexB = b2Settings_13.b2MakeNumberArray(1);
            b2TimeOfImpact_s_sweepA = new b2Math_21.b2Sweep();
            b2TimeOfImpact_s_sweepB = new b2Math_21.b2Sweep();
        }
    }
});
System.register("Box2D/Collision/b2CollideCircle", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_14, context_14) {
    "use strict";
    var __moduleName = context_14 && context_14.id;
    var b2Settings_14, b2Math_27, b2Math_28, b2Math_29, b2Math_30;
    ...
    function b2CollideCircles(manifold, circleA, xfA, circleB, xfB) {
        ...
        const pA = b2Math_30.b2MulXV(xfA, circleA.m_p, b2CollideCircles_s_pA);
        const pB = b2Math_30.b2MulXV(xfB, circleB.m_p, b2CollideCircles_s_pB);
        const distSqr = b2Math_29.b2DistanceSquaredVV(pA, pB);
    ...
    exports_14("b2CollideCircles", b2CollideCircles);
    function b2CollidePolygonAndCircle(manifold, polygonA, xfA, circleB, xfB) {
        manifold.pointCount = 0;
        // Compute circle position in the frame of the polygon.
        const c = b2Math_30.b2MulXV(xfB, circleB.m_p, b2CollidePolygonAndCircle_s_c);
        const cLocal = b2Math_30.b2MulTXV(xfA, c, b2CollidePolygonAndCircle_s_cLocal);
        // Find the min separating edge.
        let normalIndex = 0;
        let separation = (-b2Settings_14.b2_maxFloat);
        const radius = polygonA.m_radius + circleB.m_radius;
        const vertexCount = polygonA.m_count;
        const vertices = polygonA.m_vertices;
        const normals = polygonA.m_normals;
        for (let i = 0; i < vertexCount; ++i) {
            const s = b2Math_28.b2DotVV(normals[i], b2Math_28.b2SubVV(cLocal, vertices[i], b2Math_27.b2Vec2.s_t0));
            if (s > radius) {
                // Early out.
                return;
            }
        ...
        if (separation < b2Settings_14.b2_epsilon) {
            manifold.pointCount = 1;
            manifold.type = 1 /* e_faceA */;
            manifold.localNormal.Copy(normals[normalIndex]);
            b2Math_28.b2MidVV(v1, v2, manifold.localPoint);
            manifold.points[0].localPoint.Copy(circleB.m_p);
            manifold.points[0].id.key = 0;
            return;
        }
        // Compute barycentric coordinates
        const u1 = b2Math_28.b2DotVV(b2Math_28.b2SubVV(cLocal, v1, b2Math_27.b2Vec2.s_t0), b2Math_28.b2SubVV(v2, v1, b2Math_27.b2Vec2.s_t1));
        const u2 = b2Math_28.b2DotVV(b2Math_28.b2SubVV(cLocal, v2, b2Math_27.b2Vec2.s_t0), b2Math_28.b2SubVV(v1, v2, b2Math_27.b2Vec2.s_t1));
        if (u1 <= 0) {
            if (b2Math_29.b2DistanceSquaredVV(cLocal, v1) > radius * radius) {
                return;
            }
            manifold.pointCount = 1;
            manifold.type = 1 /* e_faceA */;
            b2Math_28.b2SubVV(cLocal, v1, manifold.localNormal).SelfNormalize();
            manifold.localPoint.Copy(v1);
            manifold.points[0].localPoint.Copy(circleB.m_p);
            manifold.points[0].id.key = 0;
        }
        else if (u2 <= 0) {
            if (b2Math_29.b2DistanceSquaredVV(cLocal, v2) > radius * radius) {
                return;
            }
            manifold.pointCount = 1;
            manifold.type = 1 /* e_faceA */;
            b2Math_28.b2SubVV(cLocal, v2, manifold.localNormal).SelfNormalize();
            manifold.localPoint.Copy(v2);
            manifold.points[0].localPoint.Copy(circleB.m_p);
            manifold.points[0].id.key = 0;
        }
        else {
            const faceCenter = b2Math_28.b2MidVV(v1, v2, b2CollidePolygonAndCircle_s_faceCenter);
            separation = b2Math_28.b2DotVV(b2Math_28.b2SubVV(cLocal, faceCenter, b2Math_27.b2Vec2.s_t1), normals[vertIndex1]);
    ...
    return {
        setters:[
            ...
            function (b2Math_27_1) {
                ...
                b2Math_28 = b2Math_27_1;
                b2Math_29 = b2Math_27_1;
                b2Math_30 = b2Math_27_1;
            }],
        execute: function() {
            b2CollideCircles_s_pA = new b2Math_27.b2Vec2();
            b2CollideCircles_s_pB = new b2Math_27.b2Vec2();
            b2CollidePolygonAndCircle_s_c = new b2Math_27.b2Vec2();
            b2CollidePolygonAndCircle_s_cLocal = new b2Math_27.b2Vec2();
            b2CollidePolygonAndCircle_s_faceCenter = new b2Math_27.b2Vec2();
        }
    }
});
System.register("Box2D/Collision/b2CollidePolygon", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision"], function(exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    var b2Settings_15, b2Settings_16, b2Settings_17, b2Math_31, b2Math_32, b2Math_33, b2Math_34, b2Math_35, b2Collision_3;
    ...
    function b2EdgeSeparation(poly1, xf1, edge1, poly2, xf2) {
        ...
        if (b2Settings_15.ENABLE_ASSERTS) {
            b2Settings_15.b2Assert(0 <= edge1 && edge1 < count1);
        }
        // Convert normal from poly1's frame into poly2's frame.
        const normal1World = b2Math_34.b2MulRV(xf1.q, normals1[edge1], b2EdgeSeparation_s_normal1World);
        const normal1 = b2Math_34.b2MulTRV(xf2.q, normal1World, b2EdgeSeparation_s_normal1);
        // Find support vertex on poly2 for -normal.
        let index = 0;
        let minDot = b2Settings_16.b2_maxFloat;
        for (let i = 0; i < count2; ++i) {
            const dot = b2Math_32.b2DotVV(vertices2[i], normal1);
            if (dot < minDot) {
                minDot = dot;
                index = i;
            }
        }
        const v1 = b2Math_35.b2MulXV(xf1, vertices1[edge1], b2EdgeSeparation_s_v1);
        const v2 = b2Math_35.b2MulXV(xf2, vertices2[index], b2EdgeSeparation_s_v2);
        const separation = b2Math_32.b2DotVV(b2Math_32.b2SubVV(v2, v1, b2Math_31.b2Vec2.s_t0), normal1World);
        return separation;
    }
    function b2FindMaxSeparation(edgeIndex, poly1, xf1, poly2, xf2) {
        ...
        const d = b2Math_32.b2SubVV(b2Math_35.b2MulXV(xf2, poly2.m_centroid, b2Math_31.b2Vec2.s_t0), b2Math_35.b2MulXV(xf1, poly1.m_centroid, b2Math_31.b2Vec2.s_t1), b2FindMaxSeparation_s_d);
        const dLocal1 = b2Math_34.b2MulTRV(xf1.q, d, b2FindMaxSeparation_s_dLocal1);
        // Find edge normal on poly1 that has the largest projection onto d.
        let edge = 0;
        let maxDot = (-b2Settings_16.b2_maxFloat);
        for (let i = 0; i < count1; ++i) {
            const dot = b2Math_32.b2DotVV(normals1[i], dLocal1);
            if (dot > maxDot) {
                maxDot = dot;
                edge = i;
            }
    ...
    function b2FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
        ...
        const normal1 = b2Math_34.b2MulTRV(xf2.q, b2Math_34.b2MulRV(xf1.q, normals1[edge1], b2Math_31.b2Vec2.s_t0), b2FindIncidentEdge_s_normal1);
        // Find the incident edge on poly2.
        let index = 0;
        let minDot = b2Settings_16.b2_maxFloat;
        for (let i = 0; i < count2; ++i) {
            const dot = b2Math_32.b2DotVV(normal1, normals2[i]);
            if (dot < minDot) {
                minDot = dot;
                index = i;
            }
        ...
        const c0 = c[0];
        b2Math_35.b2MulXV(xf2, vertices2[i1], c0.v);
        const cf0 = c0.id.cf;
        cf0.indexA = edge1;
        cf0.indexB = i1;
        cf0.typeA = 1 /* e_face */;
        ...
        const c1 = c[1];
        b2Math_35.b2MulXV(xf2, vertices2[i2], c1.v);
        const cf1 = c1.id.cf;
        cf1.indexA = edge1;
        cf1.indexB = i2;
        cf1.typeA = 1 /* e_face */;
    ...
    function b2CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
        ...
        const localTangent = b2Math_32.b2SubVV(local_v12, local_v11, b2CollidePolygons_s_localTangent);
        localTangent.Normalize();
        const localNormal = b2Math_33.b2CrossVOne(localTangent, b2CollidePolygons_s_localNormal);
        const planePoint = b2Math_32.b2MidVV(local_v11, local_v12, b2CollidePolygons_s_planePoint);
        const tangent = b2Math_34.b2MulRV(xf1.q, localTangent, b2CollidePolygons_s_tangent);
        const normal = b2Math_33.b2CrossVOne(tangent, b2CollidePolygons_s_normal);
        const v11 = b2Math_35.b2MulXV(xf1, local_v11, b2CollidePolygons_s_v11);
        const v12 = b2Math_35.b2MulXV(xf1, local_v12, b2CollidePolygons_s_v12);
        // Face offset.
        const frontOffset = b2Math_32.b2DotVV(normal, v11);
        // Side offsets, extended by polytope skin thickness.
        const sideOffset1 = -b2Math_32.b2DotVV(tangent, v11) + totalRadius;
        const sideOffset2 = b2Math_32.b2DotVV(tangent, v12) + totalRadius;
        // Clip incident edge against extruded edge1 side edges.
        const clipPoints1 = b2CollidePolygons_s_clipPoints1;
        const clipPoints2 = b2CollidePolygons_s_clipPoints2;
        let np;
        // Clip to box side 1
        const ntangent = b2Math_32.b2NegV(tangent, b2CollidePolygons_s_ntangent);
        np = b2Collision_3.b2ClipSegmentToLine(clipPoints1, incidentEdge, ntangent, sideOffset1, iv1);
        if (np < 2)
            return;
        // Clip to negative box side 1
        np = b2Collision_3.b2ClipSegmentToLine(clipPoints2, clipPoints1, tangent, sideOffset2, iv2);
        if (np < 2) {
            return;
        }
        ...
        let pointCount = 0;
        for (let i = 0; i < b2Settings_16.b2_maxManifoldPoints; ++i) {
            const cv = clipPoints2[i];
            const separation = b2Math_32.b2DotVV(normal, cv.v) - frontOffset;
            if (separation <= totalRadius) {
                const cp = manifold.points[pointCount];
                b2Math_35.b2MulTXV(xf2, cv.v, cp.localPoint);
                cp.id.Copy(cv.id);
                if (flip) {
                    // Swap features
                    const cf = cp.id.cf;
    ...
    return {
        setters:[
            function (b2Settings_15_1) {
                ...
                b2Settings_16 = b2Settings_15_1;
                b2Settings_17 = b2Settings_15_1;
            },
            function (b2Math_31_1) {
                b2Math_31 = b2Math_31_1;
                b2Math_32 = b2Math_31_1;
                b2Math_33 = b2Math_31_1;
                b2Math_34 = b2Math_31_1;
                b2Math_35 = b2Math_31_1;
            },
            function (b2Collision_3_1) {
                b2Collision_3 = b2Collision_3_1;
            }],
        execute: function() {
            b2EdgeSeparation_s_normal1World = new b2Math_31.b2Vec2();
            b2EdgeSeparation_s_normal1 = new b2Math_31.b2Vec2();
            b2EdgeSeparation_s_v1 = new b2Math_31.b2Vec2();
            b2EdgeSeparation_s_v2 = new b2Math_31.b2Vec2();
            b2FindMaxSeparation_s_d = new b2Math_31.b2Vec2();
            b2FindMaxSeparation_s_dLocal1 = new b2Math_31.b2Vec2();
            b2FindIncidentEdge_s_normal1 = new b2Math_31.b2Vec2();
            ...
            b2CollidePolygons_s_edgeA = b2Settings_17.b2MakeNumberArray(1);
            b2CollidePolygons_s_edgeB = b2Settings_17.b2MakeNumberArray(1);
            b2CollidePolygons_s_localTangent = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_localNormal = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_planePoint = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_normal = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_tangent = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_ntangent = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_v11 = new b2Math_31.b2Vec2();
            b2CollidePolygons_s_v12 = new b2Math_31.b2Vec2();
        }
    }
});
System.register("Box2D/Collision/b2CollideEdge", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision"], function(exports_16, context_16) {
    "use strict";
    var __moduleName = context_16 && context_16.id;
    var b2Settings_18, b2Settings_19, b2Settings_20, b2Math_36, b2Math_37, b2Math_38, b2Math_39, b2Math_40, b2Math_41, b2Math_42, b2Collision_4, b2Collision_5;
    ...
    function b2CollideEdgeAndCircle(manifold, edgeA, xfA, circleB, xfB) {
        ...
        const Q = b2Math_41.b2MulTXV(xfA, b2Math_41.b2MulXV(xfB, circleB.m_p, b2Math_36.b2Vec2.s_t0), b2CollideEdgeAndCircle_s_Q);
        const A = edgeA.m_vertex1;
        const B = edgeA.m_vertex2;
        const e = b2Math_38.b2SubVV(B, A, b2CollideEdgeAndCircle_s_e);
        // Barycentric coordinates
        const u = b2Math_38.b2DotVV(e, b2Math_38.b2SubVV(B, Q, b2Math_36.b2Vec2.s_t0));
        const v = b2Math_38.b2DotVV(e, b2Math_38.b2SubVV(Q, A, b2Math_36.b2Vec2.s_t0));
        ...
        if (v <= 0) {
            const P = A;
            const d = b2Math_38.b2SubVV(Q, P, b2CollideEdgeAndCircle_s_d);
            const dd = b2Math_38.b2DotVV(d, d);
            if (dd > radius * radius) {
                return;
            }
            ...
            if (edgeA.m_hasVertex0) {
                ...
                const B1 = A;
                const e1 = b2Math_38.b2SubVV(B1, A1, b2CollideEdgeAndCircle_s_e1);
                const u1 = b2Math_38.b2DotVV(e1, b2Math_38.b2SubVV(B1, Q, b2Math_36.b2Vec2.s_t0));
        ...
        if (u <= 0) {
            ...
            if (edgeA.m_hasVertex3) {
                ...
                const A2 = B;
                const e2 = b2Math_38.b2SubVV(B2, A2, b2CollideEdgeAndCircle_s_e2);
                const v2 = b2Math_38.b2DotVV(e2, b2Math_38.b2SubVV(Q, A2, b2Math_36.b2Vec2.s_t0));
        ...
        // Region AB
        const den = b2Math_38.b2DotVV(e, e);
        if (b2Settings_18.ENABLE_ASSERTS) {
            b2Settings_18.b2Assert(den > 0);
        }
        ...
        if (b2Math_38.b2DotVV(n, b2Math_38.b2SubVV(Q, A, b2Math_36.b2Vec2.s_t0)) < 0) {
            n.SetXY(-n.x, -n.y);
        }
        n.Normalize();
        id.cf.indexA = 0;
    ...
    exports_16("b2CollideEdgeAndCircle", b2CollideEdgeAndCircle);
    ...
    return {
        setters:[
            function (b2Settings_18_1) {
                ...
                b2Settings_20 = b2Settings_18_1;
            },
            function (b2Math_36_1) {
                b2Math_36 = b2Math_36_1;
                b2Math_37 = b2Math_36_1;
                b2Math_38 = b2Math_36_1;
                b2Math_39 = b2Math_36_1;
                b2Math_40 = b2Math_36_1;
                b2Math_41 = b2Math_36_1;
                b2Math_42 = b2Math_36_1;
            },
        ...
        execute: function() {
            ...
            b2TempPolygon = class b2TempPolygon {
                constructor() {
                    this.vertices = b2Math_36.b2Vec2.MakeArray(b2Settings_20.b2_maxPolygonVertices);
                    this.normals = b2Math_36.b2Vec2.MakeArray(b2Settings_20.b2_maxPolygonVertices);
                    this.count = 0;
                }
            };
            ...
            b2EPCollider = class b2EPCollider {
                ...
                Collide(manifold, edgeA, xfA, polygonB, xfB) {
                    b2Math_42.b2MulTXX(xfA, xfB, this.m_xf);
                    b2Math_41.b2MulXV(this.m_xf, polygonB.m_centroid, this.m_centroidB);
                    ...
                    const edge1 = b2Math_38.b2SubVV(this.m_v2, this.m_v1, b2EPCollider.s_edge1);
                    edge1.Normalize();
                    this.m_normal1.SetXY(edge1.y, -edge1.x);
                    const offset1 = b2Math_38.b2DotVV(this.m_normal1, b2Math_38.b2SubVV(this.m_centroidB, this.m_v1, b2Math_36.b2Vec2.s_t0));
                    let offset0 = 0;
                    let offset2 = 0;
                    let convex1 = false;
                    let convex2 = false;
                    ...
                    if (hasVertex0) {
                        const edge0 = b2Math_38.b2SubVV(this.m_v1, this.m_v0, b2EPCollider.s_edge0);
                        edge0.Normalize();
                        this.m_normal0.SetXY(edge0.y, -edge0.x);
                        convex1 = b2Math_39.b2CrossVV(edge0, edge1) >= 0;
                        offset0 = b2Math_38.b2DotVV(this.m_normal0, b2Math_38.b2SubVV(this.m_centroidB, this.m_v0, b2Math_36.b2Vec2.s_t0));
                    }
                    // Is there a following edge?
                    if (hasVertex3) {
                        const edge2 = b2Math_38.b2SubVV(this.m_v3, this.m_v2, b2EPCollider.s_edge2);
                        edge2.Normalize();
                        this.m_normal2.SetXY(edge2.y, -edge2.x);
                        convex2 = b2Math_39.b2CrossVV(edge1, edge2) > 0;
                        offset2 = b2Math_38.b2DotVV(this.m_normal2, b2Math_38.b2SubVV(this.m_centroidB, this.m_v2, b2Math_36.b2Vec2.s_t0));
                    }
                    ...
                    for (let i = 0, ict = polygonB.m_count; i < ict; ++i) {
                        b2Math_41.b2MulXV(this.m_xf, polygonB.m_vertices[i], this.m_polygonB.vertices[i]);
                        b2Math_40.b2MulRV(this.m_xf.q, polygonB.m_normals[i], this.m_polygonB.normals[i]);
                    }
                    this.m_radius = 2 * b2Settings_20.b2_polygonRadius;
                    manifold.pointCount = 0;
                    ...
                    if (primaryAxis.type === 1 /* e_edgeA */) {
                        ...
                        let bestIndex = 0;
                        let bestValue = b2Math_38.b2DotVV(this.m_normal, this.m_polygonB.normals[0]);
                        for (let i = 1, ict = this.m_polygonB.count; i < ict; ++i) {
                            const value = b2Math_38.b2DotVV(this.m_normal, this.m_polygonB.normals[i]);
                            if (value < bestValue) {
                                bestValue = value;
                                bestIndex = i;
                            }
                    ...
                    rf.sideOffset1 = b2Math_38.b2DotVV(rf.sideNormal1, rf.v1);
                    rf.sideOffset2 = b2Math_38.b2DotVV(rf.sideNormal2, rf.v2);
                    // Clip incident edge against extruded edge1 side edges.
                    const clipPoints1 = b2EPCollider.s_clipPoints1;
                    const clipPoints2 = b2EPCollider.s_clipPoints2;
                    let np = 0;
                    // Clip to box side 1
                    np = b2Collision_5.b2ClipSegmentToLine(clipPoints1, ie, rf.sideNormal1, rf.sideOffset1, rf.i1);
                    if (np < b2Settings_19.b2_maxManifoldPoints) {
                        return;
                    }
                    // Clip to negative box side 1
                    np = b2Collision_5.b2ClipSegmentToLine(clipPoints2, clipPoints1, rf.sideNormal2, rf.sideOffset2, rf.i2);
                    if (np < b2Settings_19.b2_maxManifoldPoints) {
                        return;
                    }
                    // Now clipPoints2 contains the clipped points.
                    ...
                    let pointCount = 0;
                    for (let i = 0, ict = b2Settings_19.b2_maxManifoldPoints; i < ict; ++i) {
                        let separation;
                        separation = b2Math_38.b2DotVV(rf.normal, b2Math_38.b2SubVV(clipPoints2[i].v, rf.v1, b2Math_36.b2Vec2.s_t0));
                        if (separation <= this.m_radius) {
                            const cp = manifold.points[pointCount];
                            if (primaryAxis.type === 1 /* e_edgeA */) {
                                b2Math_41.b2MulTXV(this.m_xf, clipPoints2[i].v, cp.localPoint);
                ...
                ComputeEdgeSeparation(out) {
                    ...
                    axis.separation = b2Settings_19.b2_maxFloat;
                    for (let i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
                        const s = b2Math_38.b2DotVV(this.m_normal, b2Math_38.b2SubVV(this.m_polygonB.vertices[i], this.m_v1, b2Math_36.b2Vec2.s_t0));
                ...
                ComputePolygonSeparation(out) {
                    ...
                    for (let i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
                        const n = b2Math_38.b2NegV(this.m_polygonB.normals[i], b2EPCollider.s_n);
                        const s1 = b2Math_38.b2DotVV(n, b2Math_38.b2SubVV(this.m_polygonB.vertices[i], this.m_v1, b2Math_36.b2Vec2.s_t0));
                        const s2 = b2Math_38.b2DotVV(n, b2Math_38.b2SubVV(this.m_polygonB.vertices[i], this.m_v2, b2Math_36.b2Vec2.s_t0));
                        const s = b2Math_37.b2Min(s1, s2);
                        if (s > this.m_radius) {
                            // No collision
                            axis.type = 2 /* e_edgeB */;
                            axis.index = i;
                        ...
                        // Adjacency
                        if (b2Math_38.b2DotVV(n, perp) >= 0) {
                            if (b2Math_38.b2DotVV(b2Math_38.b2SubVV(n, this.m_upperLimit, b2Math_36.b2Vec2.s_t0), this.m_normal) < -b2Settings_20.b2_angularSlop) {
                                continue;
                            }
                        }
                        else {
                            if (b2Math_38.b2DotVV(b2Math_38.b2SubVV(n, this.m_lowerLimit, b2Math_36.b2Vec2.s_t0), this.m_normal) < -b2Settings_20.b2_angularSlop) {
                                continue;
                            }
                        }
                        if (s > axis.separation) {
...
System.register("Box2D/Collision/Shapes/b2CircleShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape"], function(exports_17, context_17) {
    ...
    var b2Settings_21, b2Settings_22, b2Math_43, b2Math_44, b2Math_45, b2Math_46, b2Math_47, b2Shape_1;
    var b2CircleShape;
    return {
        setters:[
            function (b2Settings_21_1) {
                b2Settings_21 = b2Settings_21_1;
                b2Settings_22 = b2Settings_21_1;
            },
            function (b2Math_43_1) {
                b2Math_43 = b2Math_43_1;
                b2Math_44 = b2Math_43_1;
                b2Math_45 = b2Math_43_1;
                b2Math_46 = b2Math_43_1;
                b2Math_47 = b2Math_43_1;
            },
        ...
        execute: function() {
            ...
            b2CircleShape = class b2CircleShape extends b2Shape_1.b2Shape {
                ...
                Copy(other) {
                    super.Copy(other);
                    if (b2Settings_21.ENABLE_ASSERTS) {
                        b2Settings_21.b2Assert(other instanceof b2CircleShape);
                    }
                ...
                TestPoint(transform, p) {
                    const center = b2Math_47.b2MulXV(transform, this.m_p, b2CircleShape.TestPoint_s_center);
                    const d = b2Math_45.b2SubVV(p, center, b2CircleShape.TestPoint_s_d);
                    return b2Math_45.b2DotVV(d, d) <= b2Math_44.b2Sq(this.m_radius);
                }
                RayCast(output, input, transform, childIndex) {
                    const position = b2Math_47.b2MulXV(transform, this.m_p, b2CircleShape.RayCast_s_position);
                    const s = b2Math_45.b2SubVV(input.p1, position, b2CircleShape.RayCast_s_s);
                    const b = b2Math_45.b2DotVV(s, s) - b2Math_44.b2Sq(this.m_radius);
                    // Solve quadratic equation.
                    const r = b2Math_45.b2SubVV(input.p2, input.p1, b2CircleShape.RayCast_s_r);
                    const c = b2Math_45.b2DotVV(s, r);
                    const rr = b2Math_45.b2DotVV(r, r);
                    const sigma = c * c - rr * b;
                    // Check for negative discriminant and short segment.
                    if (sigma < 0 || rr < b2Settings_22.b2_epsilon) {
                        return false;
                    }
                    // Find the point of intersection of the line with the circle.
                    let a = (-(c + b2Math_44.b2Sqrt(sigma)));
                    // Is the intersection point on the segment?
                    if (0 <= a && a <= input.maxFraction * rr) {
                        a /= rr;
                        output.fraction = a;
                        b2Math_46.b2AddVMulSV(s, a, r, output.normal).SelfNormalize();
                        return true;
                    }
                    return false;
                }
                ComputeAABB(aabb, transform, childIndex) {
                    const p = b2Math_47.b2MulXV(transform, this.m_p, b2CircleShape.ComputeAABB_s_p);
                    aabb.lowerBound.SetXY(p.x - this.m_radius, p.y - this.m_radius);
                    aabb.upperBound.SetXY(p.x + this.m_radius, p.y + this.m_radius);
                }
                /// @see b2Shape::ComputeMass
                ComputeMass(massData, density) {
                    const radius_sq = b2Math_44.b2Sq(this.m_radius);
                    massData.mass = density * b2Settings_22.b2_pi * radius_sq;
                    massData.center.Copy(this.m_p);
                    // inertia about the local origin
                    massData.I = massData.mass * (0.5 * radius_sq + b2Math_45.b2DotVV(this.m_p, this.m_p));
                }
                SetupDistanceProxy(proxy, index) {
                    proxy.m_vertices = [];
                ...
                ComputeSubmergedArea(normal, offset, xf, c) {
                    const p = b2Math_47.b2MulXV(xf, this.m_p, new b2Math_43.b2Vec2());
                    const l = (-(b2Math_45.b2DotVV(normal, p) - offset));
                    if (l < (-this.m_radius) + b2Settings_22.b2_epsilon) {
                        // Completely dry
                        return 0;
                    }
                    if (l > this.m_radius) {
                        // Completely wet
                        c.Copy(p);
                        return b2Settings_22.b2_pi * this.m_radius * this.m_radius;
                    }
                    // Magic
                    const r2 = this.m_radius * this.m_radius;
                    const l2 = l * l;
                    const area = r2 * (b2Math_44.b2Asin(l / this.m_radius) + b2Settings_22.b2_pi / 2) + l * b2Math_44.b2Sqrt(r2 - l2);
                    const com = (-2 / 3 * b2Math_44.b2Pow(r2 - l2, 1.5) / area);
                    c.x = p.x + normal.x * com;
                    c.y = p.y + normal.y * com;
                    return area;
                }
                Dump() {
                    b2Settings_21.b2Log("    const shape: b2CircleShape = new b2CircleShape();\n");
                    b2Settings_21.b2Log("    shape.m_radius = %.15f;\n", this.m_radius);
                    b2Settings_21.b2Log("    shape.m_p.SetXY(%.15f, %.15f);\n", this.m_p.x, this.m_p.y);
                }
            };
            /// Implement b2Shape.
            b2CircleShape.TestPoint_s_center = new b2Math_43.b2Vec2();
            b2CircleShape.TestPoint_s_d = new b2Math_43.b2Vec2();
            /// Implement b2Shape.
            // Collision Detection in Interactive 3D Environments by Gino van den Bergen
            // From Section 3.1.2
            // x = s + a * r
            // norm(x) = radius
            b2CircleShape.RayCast_s_position = new b2Math_43.b2Vec2();
            b2CircleShape.RayCast_s_s = new b2Math_43.b2Vec2();
            b2CircleShape.RayCast_s_r = new b2Math_43.b2Vec2();
            /// @see b2Shape::ComputeAABB
            b2CircleShape.ComputeAABB_s_p = new b2Math_43.b2Vec2();
...
System.register("Box2D/Collision/Shapes/b2PolygonShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape"], function(exports_18, context_18) {
    ...
    var b2Settings_23, b2Settings_24, b2Settings_25, b2Settings_26, b2Math_48, b2Math_49, b2Math_50, b2Math_51, b2Math_52, b2Math_53, b2Shape_2, b2Shape_3;
    var b2PolygonShape;
    return {
        setters:[
            function (b2Settings_23_1) {
                b2Settings_23 = b2Settings_23_1;
                b2Settings_24 = b2Settings_23_1;
                b2Settings_25 = b2Settings_23_1;
                b2Settings_26 = b2Settings_23_1;
            },
            function (b2Math_48_1) {
                b2Math_48 = b2Math_48_1;
                b2Math_49 = b2Math_48_1;
                b2Math_50 = b2Math_48_1;
                b2Math_51 = b2Math_48_1;
                b2Math_52 = b2Math_48_1;
                b2Math_53 = b2Math_48_1;
            },
            function (b2Shape_2_1) {
                b2Shape_2 = b2Shape_2_1;
                b2Shape_3 = b2Shape_2_1;
            }],
        execute: function() {
            ...
            b2PolygonShape = class b2PolygonShape extends b2Shape_3.b2Shape {
                constructor() {
                    super(2 /* e_polygonShape */, b2Settings_25.b2_polygonRadius);
                    this.m_centroid = new b2Math_48.b2Vec2(0, 0);
                    this.m_vertices = b2Math_48.b2Vec2.MakeArray(b2Settings_25.b2_maxPolygonVertices);
                    this.m_normals = b2Math_48.b2Vec2.MakeArray(b2Settings_25.b2_maxPolygonVertices);
                    this.m_count = 0;
                }
                /// Implement b2Shape.
                Clone() {
                ...
                Copy(other) {
                    super.Copy(other);
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(other instanceof b2PolygonShape);
                    }
                ...
                SetAsVector(vertices, count) {
                    ...
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(3 <= count && count <= b2Settings_25.b2_maxPolygonVertices);
                    }
                    if (count < 3) {
                        return this.SetAsBox(1, 1);
                    }
                    const n = b2Math_49.b2Min(count, b2Settings_25.b2_maxPolygonVertices);
                    ...
                    for (;;) {
                        ...
                        for (let j = 1; j < n; ++j) {
                            ...
                            const r = b2Math_50.b2SubVV(ps[ie], ps[hull[m]], b2PolygonShape.SetAsVector_s_r);
                            const v = b2Math_50.b2SubVV(ps[j], ps[hull[m]], b2PolygonShape.SetAsVector_s_v);
                            const c = b2Math_51.b2CrossVV(r, v);
                            if (c < 0) {
                                ie = j;
                            }
                            // Collinearity check
                    ...
                    for (let i = 0, ict = m; i < ict; ++i) {
                        ...
                        const edge = b2Math_50.b2SubVV(vertexi2, vertexi1, b2Math_48.b2Vec2.s_t0); // edge uses s_t0
                        if (b2Settings_23.ENABLE_ASSERTS) {
                            b2Settings_23.b2Assert(edge.GetLengthSquared() > b2Settings_24.b2_epsilon_sq);
                        }
                        b2Math_51.b2CrossVOne(edge, this.m_normals[i]).SelfNormalize();
                    }
                ...
                SetAsOrientedBox(hx, hy, center, angle) {
                    ...
                    const xf = new b2Math_48.b2Transform();
                    xf.SetPosition(center);
                    xf.SetRotationAngleRadians(angle);
                    // Transform vertices and normals.
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        b2Math_53.b2MulXV(xf, this.m_vertices[i], this.m_vertices[i]);
                        b2Math_52.b2MulRV(xf.q, this.m_normals[i], this.m_normals[i]);
                    }
                    return this;
                }
                TestPoint(xf, p) {
                    const pLocal = b2Math_53.b2MulTXV(xf, p, b2PolygonShape.TestPoint_s_pLocal);
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        const dot = b2Math_50.b2DotVV(this.m_normals[i], b2Math_50.b2SubVV(pLocal, this.m_vertices[i], b2Math_48.b2Vec2.s_t0));
                        if (dot > 0) {
                            return false;
                        }
                    }
                ...
                RayCast(output, input, xf, childIndex) {
                    ...
                    const p1 = b2Math_53.b2MulTXV(xf, input.p1, b2PolygonShape.RayCast_s_p1);
                    const p2 = b2Math_53.b2MulTXV(xf, input.p2, b2PolygonShape.RayCast_s_p2);
                    const d = b2Math_50.b2SubVV(p2, p1, b2PolygonShape.RayCast_s_d);
                    ...
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        const numerator = b2Math_50.b2DotVV(this.m_normals[i], b2Math_50.b2SubVV(this.m_vertices[i], p1, b2Math_48.b2Vec2.s_t0));
                        const denominator = b2Math_50.b2DotVV(this.m_normals[i], d);
                        if (denominator === 0) {
                            if (numerator < 0) {
                                return false;
                            }
                    ...
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(0 <= lower && lower <= input.maxFraction);
                    }
                    if (index >= 0) {
                        output.fraction = lower;
                        b2Math_52.b2MulRV(xf.q, this.m_normals[index], output.normal);
                        return true;
                    }
                    return false;
                }
                ComputeAABB(aabb, xf, childIndex) {
                    const lower = b2Math_53.b2MulXV(xf, this.m_vertices[0], aabb.lowerBound);
                    const upper = aabb.upperBound.Copy(lower);
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        const v = b2Math_53.b2MulXV(xf, this.m_vertices[i], b2PolygonShape.ComputeAABB_s_v);
                        b2Math_50.b2MinV(v, lower, lower);
                        b2Math_50.b2MaxV(v, upper, upper);
                    }
                ...
                ComputeMass(massData, density) {
                    ...
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(this.m_count >= 3);
                    }
                    ...
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        // Triangle vertices.
                        const e1 = b2Math_50.b2SubVV(this.m_vertices[i], s, b2PolygonShape.ComputeMass_s_e1);
                        const e2 = b2Math_50.b2SubVV(this.m_vertices[(i + 1) % ict], s, b2PolygonShape.ComputeMass_s_e2);
                        const D = b2Math_51.b2CrossVV(e1, e2);
                        const triangleArea = 0.5 * D;
                        area += triangleArea;
                        // Area weighted centroid
                        center.SelfAdd(b2Math_50.b2MulSV(triangleArea * k_inv3, b2Math_50.b2AddVV(e1, e2, b2Math_48.b2Vec2.s_t0), b2Math_48.b2Vec2.s_t1));
                        const ex1 = e1.x;
                        const ey1 = e1.y;
                        const ex2 = e2.x;
                        const ey2 = e2.y;
                    ...
                    // Center of mass
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(area > b2Settings_24.b2_epsilon);
                    }
                    center.SelfMul(1 / area);
                    b2Math_50.b2AddVV(center, s, massData.center);
                    // Inertia tensor relative to the local origin (point s).
                    massData.I = density * I;
                    // Shift to center of mass then to original body origin.
                    massData.I += massData.mass * (b2Math_50.b2DotVV(massData.center, massData.center) - b2Math_50.b2DotVV(center, center));
                }
                Validate() {
                    for (let i = 0; i < this.m_count; ++i) {
                        const i1 = i;
                        ...
                        const e = b2Math_50.b2SubVV(this.m_vertices[i2], p, b2PolygonShape.Validate_s_e);
                        for (let j = 0; j < this.m_count; ++j) {
                            if (j === i1 || j === i2) {
                                continue;
                            }
                            const v = b2Math_50.b2SubVV(this.m_vertices[j], p, b2PolygonShape.Validate_s_v);
                            const c = b2Math_51.b2CrossVV(e, v);
                            if (c < 0) {
                                return false;
                            }
                        }
                ...
                ComputeSubmergedArea(normal, offset, xf, c) {
                    ...
                    const normalL = b2Math_52.b2MulTRV(xf.q, normal, b2PolygonShape.ComputeSubmergedArea_s_normalL);
                    const offsetL = offset - b2Math_50.b2DotVV(normal, xf.p);
                    ...
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        depths[i] = b2Math_50.b2DotVV(normalL, this.m_vertices[i]) - offsetL;
                        const isSubmerged = depths[i] < (-b2Settings_24.b2_epsilon);
                        if (i > 0) {
                            if (isSubmerged) {
                                if (!lastSubmerged) {
                                    intoIndex = i - 1;
                    ...
                    switch (diveCount) {
                        case 0:
                            if (lastSubmerged) {
                                ...
                                b2Math_53.b2MulXV(xf, md.center, c);
                                return md.mass;
                            }
                            else {
                                // Completely dry
                    ...
                    center.SelfMul(1 / area);
                    b2Math_53.b2MulXV(xf, center, c);
                    return area;
                }
                Dump() {
                    b2Settings_23.b2Log("    const shape: b2PolygonShape = new b2PolygonShape();\n");
                    b2Settings_23.b2Log("    const vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", b2Settings_25.b2_maxPolygonVertices);
                    for (let i = 0; i < this.m_count; ++i) {
                        b2Settings_23.b2Log("    vs[%d].SetXY(%.15f, %.15f);\n", i, this.m_vertices[i].x, this.m_vertices[i].y);
                    }
                    b2Settings_23.b2Log("    shape.SetAsVector(vs, %d);\n", this.m_count);
                }
                static ComputeCentroid(vs, count, out) {
                    if (b2Settings_23.ENABLE_ASSERTS) {
                        b2Settings_23.b2Assert(count >= 3);
                    }
                    const c = out;
                    c.SetZero();
                    let area = 0;
                    ...
                    */
                    ...
                    for (let i = 0; i < count; ++i) {
                        ...
                        const e1 = b2Math_50.b2SubVV(p2, p1, b2PolygonShape.ComputeCentroid_s_e1);
                        const e2 = b2Math_50.b2SubVV(p3, p1, b2PolygonShape.ComputeCentroid_s_e2);
                        const D = b2Math_51.b2CrossVV(e1, e2);
                        const triangleArea = 0.5 * D;
                        area += triangleArea;
                        // Area weighted centroid
            ...
            b2PolygonShape.SetAsVector_s_ps = b2Math_48.b2Vec2.MakeArray(b2Settings_25.b2_maxPolygonVertices);
            b2PolygonShape.SetAsVector_s_hull = b2Settings_26.b2MakeNumberArray(b2Settings_25.b2_maxPolygonVertices);
            b2PolygonShape.SetAsVector_s_r = new b2Math_48.b2Vec2();
            b2PolygonShape.SetAsVector_s_v = new b2Math_48.b2Vec2();
            /// @see b2Shape::TestPoint
            b2PolygonShape.TestPoint_s_pLocal = new b2Math_48.b2Vec2();
            /// Implement b2Shape.
            b2PolygonShape.RayCast_s_p1 = new b2Math_48.b2Vec2();
            b2PolygonShape.RayCast_s_p2 = new b2Math_48.b2Vec2();
            b2PolygonShape.RayCast_s_d = new b2Math_48.b2Vec2();
            /// @see b2Shape::ComputeAABB
            b2PolygonShape.ComputeAABB_s_v = new b2Math_48.b2Vec2();
            /// @see b2Shape::ComputeMass
            b2PolygonShape.ComputeMass_s_center = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeMass_s_s = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeMass_s_e1 = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeMass_s_e2 = new b2Math_48.b2Vec2();
            b2PolygonShape.Validate_s_e = new b2Math_48.b2Vec2();
            b2PolygonShape.Validate_s_v = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeSubmergedArea_s_normalL = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeSubmergedArea_s_depths = b2Settings_26.b2MakeNumberArray(b2Settings_25.b2_maxPolygonVertices);
            b2PolygonShape.ComputeSubmergedArea_s_md = new b2Shape_2.b2MassData();
            b2PolygonShape.ComputeSubmergedArea_s_intoVec = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeSubmergedArea_s_outoVec = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeSubmergedArea_s_center = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeCentroid_s_pRef = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeCentroid_s_e1 = new b2Math_48.b2Vec2();
            b2PolygonShape.ComputeCentroid_s_e2 = new b2Math_48.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Collision/Shapes/b2EdgeShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape"], function(exports_19, context_19) {
    "use strict";
    var __moduleName = context_19 && context_19.id;
    var b2Settings_27, b2Settings_28, b2Math_54, b2Math_55, b2Math_56, b2Math_57, b2Shape_4;
    var b2EdgeShape;
    return {
        setters:[
            function (b2Settings_27_1) {
                b2Settings_27 = b2Settings_27_1;
                b2Settings_28 = b2Settings_27_1;
            },
            function (b2Math_54_1) {
                b2Math_54 = b2Math_54_1;
                b2Math_55 = b2Math_54_1;
                b2Math_56 = b2Math_54_1;
                b2Math_57 = b2Math_54_1;
            },
        ...
        execute: function() {
            ...
            b2EdgeShape = class b2EdgeShape extends b2Shape_4.b2Shape {
                constructor() {
                    super(1 /* e_edgeShape */, b2Settings_28.b2_polygonRadius);
                    this.m_vertex1 = new b2Math_54.b2Vec2();
                    this.m_vertex2 = new b2Math_54.b2Vec2();
                    this.m_vertex0 = new b2Math_54.b2Vec2();
                    this.m_vertex3 = new b2Math_54.b2Vec2();
                ...
                Copy(other) {
                    super.Copy(other);
                    if (b2Settings_27.ENABLE_ASSERTS) {
                        b2Settings_27.b2Assert(other instanceof b2EdgeShape);
                    }
                ...
                RayCast(output, input, xf, childIndex) {
                    ...
                    const p1 = b2Math_57.b2MulTXV(xf, input.p1, b2EdgeShape.RayCast_s_p1);
                    const p2 = b2Math_57.b2MulTXV(xf, input.p2, b2EdgeShape.RayCast_s_p2);
                    const d = b2Math_55.b2SubVV(p2, p1, b2EdgeShape.RayCast_s_d);
                    const v1 = this.m_vertex1;
                    const v2 = this.m_vertex2;
                    const e = b2Math_55.b2SubVV(v2, v1, b2EdgeShape.RayCast_s_e);
                    const normal = output.normal.SetXY(e.y, -e.x).SelfNormalize();
                    // q = p1 + t * d
                    // dot(normal, q - v1) = 0
                    // dot(normal, p1 - v1) + t * dot(normal, d) = 0
                    const numerator = b2Math_55.b2DotVV(normal, b2Math_55.b2SubVV(v1, p1, b2Math_54.b2Vec2.s_t0));
                    const denominator = b2Math_55.b2DotVV(normal, d);
                    if (denominator === 0) {
                        return false;
                    }
                    ...
                    const q = b2Math_56.b2AddVMulSV(p1, t, d, b2EdgeShape.RayCast_s_q);
                    // q = v1 + s * r
                    // s = dot(q - v1, r) / dot(r, r)
                    const r = b2Math_55.b2SubVV(v2, v1, b2EdgeShape.RayCast_s_r);
                    const rr = b2Math_55.b2DotVV(r, r);
                    if (rr === 0) {
                        return false;
                    }
                    const s = b2Math_55.b2DotVV(b2Math_55.b2SubVV(q, v1, b2Math_54.b2Vec2.s_t0), r) / rr;
                    if (s < 0 || 1 < s) {
                        return false;
                    }
                    output.fraction = t;
                ...
                ComputeAABB(aabb, xf, childIndex) {
                    const v1 = b2Math_57.b2MulXV(xf, this.m_vertex1, b2EdgeShape.ComputeAABB_s_v1);
                    const v2 = b2Math_57.b2MulXV(xf, this.m_vertex2, b2EdgeShape.ComputeAABB_s_v2);
                    b2Math_55.b2MinV(v1, v2, aabb.lowerBound);
                    b2Math_55.b2MaxV(v1, v2, aabb.upperBound);
                    const r = this.m_radius;
                ...
                ComputeMass(massData, density) {
                    massData.mass = 0;
                    b2Math_55.b2MidVV(this.m_vertex1, this.m_vertex2, massData.center);
                    massData.I = 0;
                }
                SetupDistanceProxy(proxy, index) {
                ...
                Dump() {
                    b2Settings_27.b2Log("    const shape: b2EdgeShape = new b2EdgeShape();\n");
                    b2Settings_27.b2Log("    shape.m_radius = %.15f;\n", this.m_radius);
                    b2Settings_27.b2Log("    shape.m_vertex0.SetXY(%.15f, %.15f);\n", this.m_vertex0.x, this.m_vertex0.y);
                    b2Settings_27.b2Log("    shape.m_vertex1.SetXY(%.15f, %.15f);\n", this.m_vertex1.x, this.m_vertex1.y);
                    b2Settings_27.b2Log("    shape.m_vertex2.SetXY(%.15f, %.15f);\n", this.m_vertex2.x, this.m_vertex2.y);
                    b2Settings_27.b2Log("    shape.m_vertex3.SetXY(%.15f, %.15f);\n", this.m_vertex3.x, this.m_vertex3.y);
                    b2Settings_27.b2Log("    shape.m_hasVertex0 = %s;\n", this.m_hasVertex0);
                    b2Settings_27.b2Log("    shape.m_hasVertex3 = %s;\n", this.m_hasVertex3);
                }
            };
            /// Implement b2Shape.
            // p = p1 + t * d
            ...
            // p1 + t * d = v1 + s * e
            // s * e - t * d = p1 - v1
            b2EdgeShape.RayCast_s_p1 = new b2Math_54.b2Vec2();
            b2EdgeShape.RayCast_s_p2 = new b2Math_54.b2Vec2();
            b2EdgeShape.RayCast_s_d = new b2Math_54.b2Vec2();
            b2EdgeShape.RayCast_s_e = new b2Math_54.b2Vec2();
            b2EdgeShape.RayCast_s_q = new b2Math_54.b2Vec2();
            b2EdgeShape.RayCast_s_r = new b2Math_54.b2Vec2();
            /// @see b2Shape::ComputeAABB
            b2EdgeShape.ComputeAABB_s_v1 = new b2Math_54.b2Vec2();
            b2EdgeShape.ComputeAABB_s_v2 = new b2Math_54.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Collision/Shapes/b2ChainShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape", "Box2D/Collision/Shapes/b2EdgeShape"], function(exports_20, context_20) {
    "use strict";
    var __moduleName = context_20 && context_20.id;
    var b2Settings_29, b2Settings_30, b2Settings_31, b2Math_58, b2Math_59, b2Math_60, b2Math_61, b2Shape_5, b2EdgeShape_1;
    var b2ChainShape;
    return {
        setters:[
            ...
            function (b2Math_58_1) {
                b2Math_58 = b2Math_58_1;
                b2Math_59 = b2Math_58_1;
                b2Math_60 = b2Math_58_1;
                b2Math_61 = b2Math_58_1;
            },
        ...
        execute: function() {
            ...
            b2ChainShape = class b2ChainShape extends b2Shape_5.b2Shape {
                constructor() {
                    super(3 /* e_chainShape */, b2Settings_31.b2_polygonRadius);
                    this.m_vertices = null;
                    this.m_count = 0;
                    this.m_prevVertex = new b2Math_58.b2Vec2();
                    this.m_nextVertex = new b2Math_58.b2Vec2();
                ...
                CreateLoop(vertices, count = vertices.length) {
                    ...
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(this.m_vertices === null && this.m_count === 0);
                    }
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(count >= 3);
                    }
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        for (let i = 1; i < count; ++i) {
                            ...
                            b2Settings_29.b2Assert(b2Math_60.b2DistanceSquaredVV(v1, v2) > b2Settings_30.b2_linearSlop * b2Settings_30.b2_linearSlop);
                        }
                    }
                    this.m_count = count + 1;
                    this.m_vertices = b2Math_58.b2Vec2.MakeArray(this.m_count);
                    for (let i = 0; i < count; ++i) {
                ...
                CreateChain(vertices, count = vertices.length) {
                    ...
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(count >= 2);
                    }
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        for (let i = 1; i < count; ++i) {
                            const v1 = vertices[i - 1];
                    ...
                    this.m_count = count;
                    this.m_vertices = b2Math_58.b2Vec2.MakeArray(count);
                    for (let i = 0; i < count; ++i) {
                        this.m_vertices[i].Copy(vertices[i]);
                    }
                    this.m_hasPrevVertex = false;
                ...
                Copy(other) {
                    super.Copy(other);
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(other instanceof b2ChainShape);
                    }
                ...
                GetChildEdge(edge, index) {
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(0 <= index && index < this.m_count - 1);
                    }
                ...
                RayCast(output, input, xf, childIndex) {
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(childIndex < this.m_count);
                    }
                ...
                ComputeAABB(aabb, xf, childIndex) {
                    ...
                    const v1 = b2Math_61.b2MulXV(xf, vertexi1, b2ChainShape.ComputeAABB_s_v1);
                    const v2 = b2Math_61.b2MulXV(xf, vertexi2, b2ChainShape.ComputeAABB_s_v2);
                    b2Math_59.b2MinV(v1, v2, aabb.lowerBound);
                    b2Math_59.b2MaxV(v1, v2, aabb.upperBound);
                }
                ...
                SetupDistanceProxy(proxy, index) {
                    if (b2Settings_29.ENABLE_ASSERTS) {
                        b2Settings_29.b2Assert(0 <= index && index < this.m_count);
                    }
                ...
                Dump() {
                    b2Settings_29.b2Log("    const shape: b2ChainShape = new b2ChainShape();\n");
                    b2Settings_29.b2Log("    const vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", b2Settings_31.b2_maxPolygonVertices);
                    for (let i = 0; i < this.m_count; ++i) {
                        b2Settings_29.b2Log("    vs[%d].SetXY(%.15f, %.15f);\n", i, this.m_vertices[i].x, this.m_vertices[i].y);
                    }
                    b2Settings_29.b2Log("    shape.CreateChain(vs, %d);\n", this.m_count);
                    b2Settings_29.b2Log("    shape.m_prevVertex.SetXY(%.15f, %.15f);\n", this.m_prevVertex.x, this.m_prevVertex.y);
                    b2Settings_29.b2Log("    shape.m_nextVertex.SetXY(%.15f, %.15f);\n", this.m_nextVertex.x, this.m_nextVertex.y);
                    b2Settings_29.b2Log("    shape.m_hasPrevVertex = %s;\n", (this.m_hasPrevVertex) ? ("true") : ("false"));
                    b2Settings_29.b2Log("    shape.m_hasNextVertex = %s;\n", (this.m_hasNextVertex) ? ("true") : ("false"));
                }
            };
            /// Implement b2Shape.
            b2ChainShape.RayCast_s_edgeShape = new b2EdgeShape_1.b2EdgeShape();
            /// @see b2Shape::ComputeAABB
            b2ChainShape.ComputeAABB_s_v1 = new b2Math_58.b2Vec2();
            b2ChainShape.ComputeAABB_s_v2 = new b2Math_58.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2TimeStep", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_21, context_21) {
    "use strict";
    var __moduleName = context_21 && context_21.id;
    var b2Settings_32, b2Math_62;
    ...
    return {
        setters:[
            ...
            function (b2Math_62_1) {
                b2Math_62 = b2Math_62_1;
            }],
        execute: function() {
            ...
            exports_21("b2Profile", b2Profile);
            ...
            b2Position = class b2Position {
                constructor() {
                    this.c = new b2Math_62.b2Vec2();
                    this.a = 0;
                }
                static MakeArray(length) {
                    return b2Settings_32.b2MakeArray(length, function (i) { return new b2Position(); });
                }
            };
            exports_21("b2Position", b2Position);
            b2Velocity = class b2Velocity {
                constructor() {
                    this.v = new b2Math_62.b2Vec2();
                    this.w = 0;
                }
                static MakeArray(length) {
                    return b2Settings_32.b2MakeArray(length, function (i) { return new b2Velocity(); });
                }
            };
            exports_21("b2Velocity", b2Velocity);
            ...
            exports_21("b2SolverData", b2SolverData);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2Joint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_22, context_22) {
    "use strict";
    var __moduleName = context_22 && context_22.id;
    var b2Settings_33, b2Math_63;
    ...
    return {
        setters:[
            ...
            function (b2Math_63_1) {
                b2Math_63 = b2Math_63_1;
            }],
        execute: function() {
            b2Jacobian = class b2Jacobian {
                constructor() {
                    this.linear = new b2Math_63.b2Vec2();
                    this.angularA = 0;
                    this.angularB = 0;
                }
                SetZero() {
            ...
            exports_22("b2Jacobian", b2Jacobian);
            ...
            exports_22("b2JointEdge", b2JointEdge);
            ...
            exports_22("b2JointDef", b2JointDef);
            ...
            b2Joint = class b2Joint {
                constructor(def) {
                    ...
                    if (b2Settings_33.ENABLE_ASSERTS) {
                        b2Settings_33.b2Assert(def.bodyA !== def.bodyB);
                    }
                ...
                Dump() {
                    if (b2Settings_33.DEBUG) {
                        b2Settings_33.b2Log("// Dump is not supported for this joint type.\n");
                    }
                }
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2WorldCallbacks", ["Box2D/Common/b2Settings"], function(exports_23, context_23) {
    "use strict";
    var __moduleName = context_23 && context_23.id;
    var b2Settings_34, b2Settings_35;
    ...
    return {
        ...
        execute: function() {
            ...
            exports_23("b2DestructionListener", b2DestructionListener);
            ...
            exports_23("b2ContactFilter", b2ContactFilter);
            /// Contact impulses for reporting. Impulses are used instead of forces because
            /// sub-step forces may approach infinity for rigid body collisions. These
            /// match up one-to-one with the contact points in b2Manifold.
            b2ContactImpulse = class b2ContactImpulse {
                constructor() {
                    this.normalImpulses = b2Settings_35.b2MakeNumberArray(b2Settings_34.b2_maxManifoldPoints);
                    this.tangentImpulses = b2Settings_35.b2MakeNumberArray(b2Settings_34.b2_maxManifoldPoints);
                    this.count = 0;
                }
            };
            exports_23("b2ContactImpulse", b2ContactImpulse);
            ...
            exports_23("b2ContactListener", b2ContactListener);
            ...
            exports_23("b2QueryCallback", b2QueryCallback);
            ...
            exports_23("b2RayCastCallback", b2RayCastCallback);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2Contact", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Collision/b2TimeOfImpact"], function(exports_24, context_24) {
    "use strict";
    var __moduleName = context_24 && context_24.id;
    var b2Settings_36, b2Math_64, b2Collision_6, b2Collision_7, b2TimeOfImpact_1, b2TimeOfImpact_2, b2TimeOfImpact_3;
    var b2ContactEdge, b2Contact;
    /// Friction mixing law. The idea is to allow either fixture to drive the restitution to zero.
    /// For example, anything slides on ice.
    function b2MixFriction(friction1, friction2) {
        return b2Math_64.b2Sqrt(friction1 * friction2);
    }
    ...
    return {
        setters:[
            ...
            function (b2Math_64_1) {
                b2Math_64 = b2Math_64_1;
            },
        ...
        execute: function() {
            ...
            exports_24("b2ContactEdge", b2ContactEdge);
            b2Contact = class b2Contact {
                ...
                ComputeTOI(sweepA, sweepB) {
                    ...
                    input.tMax = b2Settings_36.b2_linearSlop;
            ...
            exports_24("b2Contact", b2Contact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2DistanceJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_25, context_25) {
    "use strict";
    var __moduleName = context_25 && context_25.id;
    var b2Settings_37, b2Settings_38, b2Settings_39, b2Settings_40, b2Math_65, b2Math_66, b2Math_67, b2Math_68, b2Math_69, b2Math_70, b2Math_71, b2Math_72, b2Joint_1;
    ...
    return {
        setters:[
            function (b2Settings_37_1) {
                ...
                b2Settings_39 = b2Settings_37_1;
                b2Settings_40 = b2Settings_37_1;
            },
            function (b2Math_65_1) {
                b2Math_65 = b2Math_65_1;
                b2Math_66 = b2Math_65_1;
                b2Math_67 = b2Math_65_1;
                b2Math_68 = b2Math_65_1;
                b2Math_69 = b2Math_65_1;
                b2Math_70 = b2Math_65_1;
                b2Math_71 = b2Math_65_1;
                b2Math_72 = b2Math_65_1;
            },
        ...
        execute: function() {
            ...
            b2DistanceJointDef = class b2DistanceJointDef extends b2Joint_1.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_66.b2Vec2();
                    this.localAnchorB = new b2Math_66.b2Vec2();
                    this.length = 1;
                    this.frequencyHz = 0;
                    this.dampingRatio = 0;
                }
                Initialize(b1, b2, anchor1, anchor2) {
                    ...
                    this.length = b2Math_67.b2DistanceVV(anchor1, anchor2);
                    this.frequencyHz = 0;
                    this.dampingRatio = 0;
                }
            };
            exports_25("b2DistanceJointDef", b2DistanceJointDef);
            b2DistanceJoint = class b2DistanceJoint extends b2Joint_1.b2Joint {
                constructor(def) {
                    ...
                    this.m_lalcA = null;
                    this.m_lalcB = null;
                    this.m_u = new b2Math_66.b2Vec2();
                    this.m_rA = new b2Math_66.b2Vec2();
                    this.m_rB = new b2Math_66.b2Vec2();
                    this.m_localCenterA = new b2Math_66.b2Vec2();
                    this.m_localCenterB = new b2Math_66.b2Vec2();
                    this.m_qA = new b2Math_71.b2Rot();
                    this.m_qB = new b2Math_71.b2Rot();
                    this.m_lalcA = new b2Math_66.b2Vec2();
                    this.m_lalcB = new b2Math_66.b2Vec2();
                ...
                Dump() {
                    if (b2Settings_37.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_37.b2Log("  const jd: b2DistanceJointDef = new b2DistanceJointDef();\n");
                        b2Settings_37.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_37.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_37.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_37.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_37.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_37.b2Log("  jd.length = %.15f;\n", this.m_length);
                        b2Settings_37.b2Log("  jd.frequencyHz = %.15f;\n", this.m_frequencyHz);
                        b2Settings_37.b2Log("  jd.dampingRatio = %.15f;\n", this.m_dampingRatio);
                        b2Settings_37.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
                InitVelocityConstraints(data) {
                    ...
                    b2Math_68.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    b2Math_72.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_68.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_72.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // m_u = cB + m_rB - cA - m_rA;
                    this.m_u.x = cB.x + this.m_rB.x - cA.x - this.m_rA.x;
                    this.m_u.y = cB.y + this.m_rB.y - cA.y - this.m_rA.y;
                    // Handle singularity.
                    const length = this.m_u.GetLength();
                    if (length > b2Settings_38.b2_linearSlop) {
                    ...
                    const crAu = b2Math_69.b2CrossVV(this.m_rA, this.m_u);
                    // float32 crBu = b2Cross(m_rB, m_u);
                    const crBu = b2Math_69.b2CrossVV(this.m_rB, this.m_u);
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        // Frequency
                        const omega = 2 * b2Settings_40.b2_pi * this.m_frequencyHz;
                        // Damping coefficient
                    ...
                    if (data.step.warmStarting) {
                        ...
                        const P = b2Math_68.b2MulSV(this.m_impulse, this.m_u, b2DistanceJoint.InitVelocityConstraints_s_P);
                        // vA -= m_invMassA * P;
                        vA.SelfMulSub(this.m_invMassA, P);
                        // wA -= m_invIA * b2Cross(m_rA, P);
                        wA -= this.m_invIA * b2Math_69.b2CrossVV(this.m_rA, P);
                        // vB += m_invMassB * P;
                        vB.SelfMulAdd(this.m_invMassB, P);
                        // wB += m_invIB * b2Cross(m_rB, P);
                        wB += this.m_invIB * b2Math_69.b2CrossVV(this.m_rB, P);
                    }
                    else {
                        this.m_impulse = 0;
                    }
                ...
                SolveVelocityConstraints(data) {
                    ...
                    const vpA = b2Math_70.b2AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                    // b2Vec2 vpB = vB + b2Cross(wB, m_rB);
                    const vpB = b2Math_70.b2AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                    // float32 Cdot = b2Dot(m_u, vpB - vpA);
                    const Cdot = b2Math_69.b2DotVV(this.m_u, b2Math_68.b2SubVV(vpB, vpA, b2Math_66.b2Vec2.s_t0));
                    const impulse = (-this.m_mass * (Cdot + this.m_bias + this.m_gamma * this.m_impulse));
                    this.m_impulse += impulse;
                    // b2Vec2 P = impulse * m_u;
                    const P = b2Math_68.b2MulSV(impulse, this.m_u, b2DistanceJoint.SolveVelocityConstraints_s_P);
                    // vA -= m_invMassA * P;
                    vA.SelfMulSub(this.m_invMassA, P);
                    // wA -= m_invIA * b2Cross(m_rA, P);
                    wA -= this.m_invIA * b2Math_69.b2CrossVV(this.m_rA, P);
                ...
                SolvePositionConstraints(data) {
                    ...
                    const rA = b2Math_72.b2MulRV(this.m_qA, this.m_lalcA, this.m_rA); // use m_rA
                    // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    const rB = b2Math_72.b2MulRV(this.m_qB, this.m_lalcB, this.m_rB); // use m_rB
                    ...
                    C = b2Math_65.b2Clamp(C, (-b2Settings_39.b2_maxLinearCorrection), b2Settings_39.b2_maxLinearCorrection);
                    const impulse = (-this.m_mass * C);
                    // b2Vec2 P = impulse * u;
                    const P = b2Math_68.b2MulSV(impulse, u, b2DistanceJoint.SolvePositionConstraints_s_P);
                    // cA -= m_invMassA * P;
                    cA.SelfMulSub(this.m_invMassA, P);
                    // aA -= m_invIA * b2Cross(rA, P);
                    aA -= this.m_invIA * b2Math_69.b2CrossVV(rA, P);
                    // cB += m_invMassB * P;
                    cB.SelfMulAdd(this.m_invMassB, P);
                    // aB += m_invIB * b2Cross(rB, P);
                    aB += this.m_invIB * b2Math_69.b2CrossVV(rB, P);
                    // data.positions[this.m_indexA].c = cA;
                    data.positions[this.m_indexA].a = aA;
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return b2Math_65.b2Abs(C) < b2Settings_38.b2_linearSlop;
                }
            };
            b2DistanceJoint.InitVelocityConstraints_s_P = new b2Math_66.b2Vec2();
            b2DistanceJoint.SolveVelocityConstraints_s_vpA = new b2Math_66.b2Vec2();
            b2DistanceJoint.SolveVelocityConstraints_s_vpB = new b2Math_66.b2Vec2();
            b2DistanceJoint.SolveVelocityConstraints_s_P = new b2Math_66.b2Vec2();
            b2DistanceJoint.SolvePositionConstraints_s_P = new b2Math_66.b2Vec2();
            exports_25("b2DistanceJoint", b2DistanceJoint);
        }
    }
});
System.register("Box2D/Dynamics/Joints/b2AreaJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint", "Box2D/Dynamics/Joints/b2DistanceJoint"], function(exports_26, context_26) {
    "use strict";
    var __moduleName = context_26 && context_26.id;
    var b2Settings_41, b2Settings_42, b2Settings_43, b2Settings_44, b2Settings_45, b2Math_73, b2Math_74, b2Math_75, b2Math_76, b2Math_77, b2Joint_2, b2DistanceJoint_1;
    ...
    return {
        setters:[
            function (b2Settings_41_1) {
                ...
                b2Settings_43 = b2Settings_41_1;
                b2Settings_44 = b2Settings_41_1;
                b2Settings_45 = b2Settings_41_1;
            },
            function (b2Math_73_1) {
                b2Math_73 = b2Math_73_1;
                b2Math_74 = b2Math_73_1;
                b2Math_75 = b2Math_73_1;
                b2Math_76 = b2Math_73_1;
                b2Math_77 = b2Math_73_1;
            },
        ...
        execute: function() {
            ...
            exports_26("b2AreaJointDef", b2AreaJointDef);
            b2AreaJoint = class b2AreaJoint extends b2Joint_2.b2Joint {
                constructor(def) {
                    ...
                    this.m_deltas = null;
                    this.m_delta = null;
                    if (b2Settings_41.ENABLE_ASSERTS) {
                        b2Settings_41.b2Assert(def.bodies.length >= 3, "You cannot create an area joint with less than three bodies.");
                    }
                    this.m_bodies = def.bodies;
                    this.m_frequencyHz = def.frequencyHz;
                    this.m_dampingRatio = def.dampingRatio;
                    this.m_targetLengths = b2Settings_45.b2MakeNumberArray(def.bodies.length);
                    this.m_normals = b2Math_74.b2Vec2.MakeArray(def.bodies.length);
                    this.m_joints = new Array(def.bodies.length);
                    this.m_deltas = b2Math_74.b2Vec2.MakeArray(def.bodies.length);
                    this.m_delta = new b2Math_74.b2Vec2();
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        this.m_targetLengths[i] = b2Math_75.b2DistanceVV(body_c, next_c);
                        this.m_targetArea += b2Math_77.b2CrossVV(body_c, next_c);
                ...
                Dump() {
                    if (b2Settings_41.DEBUG) {
                        b2Settings_41.b2Log("Area joint dumping is not supported.\n");
                    }
                }
                InitVelocityConstraints(data) {
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        b2Math_76.b2SubVV(next_c, prev_c, delta);
                    }
                    if (data.step.warmStarting) {
                        this.m_impulse *= data.step.dtRatio;
                        for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                ...
                SolveVelocityConstraints(data) {
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        crossMassSum += b2Math_77.b2CrossVV(body_v, delta);
                    }
                ...
                SolvePositionConstraints(data) {
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        const next_c = data.positions[next.m_islandIndex].c;
                        const delta = b2Math_76.b2SubVV(next_c, body_c, this.m_delta);
                        let dist = delta.GetLength();
                        if (dist < b2Settings_42.b2_epsilon) {
                            dist = 1;
                        }
                        this.m_normals[i].x = delta.y / dist;
                        this.m_normals[i].y = -delta.x / dist;
                        perimeter += dist;
                        area += b2Math_77.b2CrossVV(body_c, next_c);
                    }
                    area *= 0.5;
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        const delta = b2Math_76.b2AddVV(this.m_normals[i], this.m_normals[next_i], this.m_delta);
                        delta.SelfMul(toExtrude);
                        const norm_sq = delta.GetLengthSquared();
                        if (norm_sq > b2Math_73.b2Sq(b2Settings_44.b2_maxLinearCorrection)) {
                            delta.SelfMul(b2Settings_44.b2_maxLinearCorrection / b2Math_73.b2Sqrt(norm_sq));
                        }
                        if (norm_sq > b2Math_73.b2Sq(b2Settings_43.b2_linearSlop)) {
                            done = false;
                        }
                        body_c.x += delta.x;
                        body_c.y += delta.y;
            ...
            exports_26("b2AreaJoint", b2AreaJoint);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2FrictionJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_27, context_27) {
    "use strict";
    var __moduleName = context_27 && context_27.id;
    var b2Settings_46, b2Math_78, b2Math_79, b2Math_80, b2Math_81, b2Math_82, b2Math_83, b2Math_84, b2Math_85, b2Math_86, b2Joint_3;
    ...
    return {
        setters:[
            ...
            function (b2Math_78_1) {
                b2Math_78 = b2Math_78_1;
                b2Math_79 = b2Math_78_1;
                b2Math_80 = b2Math_78_1;
                b2Math_81 = b2Math_78_1;
                b2Math_82 = b2Math_78_1;
                b2Math_83 = b2Math_78_1;
                b2Math_84 = b2Math_78_1;
                b2Math_85 = b2Math_78_1;
                b2Math_86 = b2Math_78_1;
            },
        ...
        execute: function() {
            ...
            b2FrictionJointDef = class b2FrictionJointDef extends b2Joint_3.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_79.b2Vec2();
                    this.localAnchorB = new b2Math_79.b2Vec2();
                    this.maxForce = 0;
                    this.maxTorque = 0;
                }
            ...
            exports_27("b2FrictionJointDef", b2FrictionJointDef);
            b2FrictionJoint = class b2FrictionJoint extends b2Joint_3.b2Joint {
                constructor(def) {
                    super(def); // base class constructor
                    this.m_localAnchorA = new b2Math_79.b2Vec2();
                    this.m_localAnchorB = new b2Math_79.b2Vec2();
                    // Solver shared
                    this.m_linearImpulse = new b2Math_79.b2Vec2();
                    ...
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_rA = new b2Math_79.b2Vec2();
                    this.m_rB = new b2Math_79.b2Vec2();
                    this.m_localCenterA = new b2Math_79.b2Vec2();
                    this.m_localCenterB = new b2Math_79.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_linearMass = new b2Math_83.b2Mat22();
                    this.m_angularMass = 0;
                    this.m_qA = new b2Math_85.b2Rot();
                    this.m_qB = new b2Math_85.b2Rot();
                    this.m_lalcA = new b2Math_79.b2Vec2();
                    this.m_lalcB = new b2Math_79.b2Vec2();
                    this.m_K = new b2Math_83.b2Mat22();
                ...
                InitVelocityConstraints(data) {
                    ...
                    // Compute the effective mass matrix.
                    // m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_80.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_86.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_80.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_86.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    ...
                    if (data.step.warmStarting) {
                        ...
                        wA -= iA * (b2Math_81.b2CrossVV(this.m_rA, P) + this.m_angularImpulse);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        // wB += iB * (b2Cross(m_rB, P) + m_angularImpulse);
                        wB += iB * (b2Math_81.b2CrossVV(this.m_rB, P) + this.m_angularImpulse);
                    }
                    else {
                        this.m_linearImpulse.SetZero();
                        this.m_angularImpulse = 0;
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (true) {
                        ...
                        this.m_angularImpulse = b2Math_78.b2Clamp(this.m_angularImpulse + impulse, (-maxImpulse), maxImpulse);
                    ...
                    if (true) {
                        ...
                        const Cdot_v2 = b2Math_80.b2SubVV(b2Math_82.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_79.b2Vec2.s_t0), b2Math_82.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_79.b2Vec2.s_t1), b2FrictionJoint.SolveVelocityConstraints_s_Cdot_v2);
                        // b2Vec2 impulse = -b2Mul(m_linearMass, Cdot);
                        const impulseV = b2Math_84.b2MulMV(this.m_linearMass, Cdot_v2, b2FrictionJoint.SolveVelocityConstraints_s_impulseV).SelfNeg();
                        ...
                        b2Math_80.b2SubVV(this.m_linearImpulse, oldImpulseV, impulseV);
                        // vA -= mA * impulse;
                        vA.SelfMulSub(mA, impulseV);
                        // wA -= iA * b2Cross(m_rA, impulse);
                        wA -= iA * b2Math_81.b2CrossVV(this.m_rA, impulseV);
                        // vB += mB * impulse;
                        vB.SelfMulAdd(mB, impulseV);
                        // wB += iB * b2Cross(m_rB, impulse);
                        wB += iB * b2Math_81.b2CrossVV(this.m_rB, impulseV);
                    }
                    // data.velocities[this.m_indexA].v = vA;
                    data.velocities[this.m_indexA].w = wA;
                    // data.velocities[this.m_indexB].v = vB;
                ...
                Dump() {
                    if (b2Settings_46.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_46.b2Log("  const jd: b2FrictionJointDef = new b2FrictionJointDef();\n");
                        b2Settings_46.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_46.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_46.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_46.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_46.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_46.b2Log("  jd.maxForce = %.15f;\n", this.m_maxForce);
                        b2Settings_46.b2Log("  jd.maxTorque = %.15f;\n", this.m_maxTorque);
                        b2Settings_46.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2FrictionJoint.SolveVelocityConstraints_s_Cdot_v2 = new b2Math_79.b2Vec2();
            b2FrictionJoint.SolveVelocityConstraints_s_impulseV = new b2Math_79.b2Vec2();
            b2FrictionJoint.SolveVelocityConstraints_s_oldImpulseV = new b2Math_79.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2PrismaticJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_28, context_28) {
    "use strict";
    var __moduleName = context_28 && context_28.id;
    var b2Settings_47, b2Settings_48, b2Settings_49, b2Settings_50, b2Math_87, b2Math_88, b2Math_89, b2Math_90, b2Math_91, b2Math_92, b2Math_93, b2Math_94, b2Math_95, b2Math_96, b2Math_97, b2Math_98, b2Joint_4;
    var b2PrismaticJointDef, b2PrismaticJoint;
    return {
        setters:[
            function (b2Settings_47_1) {
                b2Settings_47 = b2Settings_47_1;
                b2Settings_48 = b2Settings_47_1;
                b2Settings_49 = b2Settings_47_1;
                b2Settings_50 = b2Settings_47_1;
            },
            function (b2Math_87_1) {
                b2Math_87 = b2Math_87_1;
                b2Math_88 = b2Math_87_1;
                b2Math_89 = b2Math_87_1;
                b2Math_90 = b2Math_87_1;
                b2Math_91 = b2Math_87_1;
                b2Math_92 = b2Math_87_1;
                b2Math_93 = b2Math_87_1;
                b2Math_94 = b2Math_87_1;
                b2Math_95 = b2Math_87_1;
                b2Math_96 = b2Math_87_1;
                b2Math_97 = b2Math_87_1;
                b2Math_98 = b2Math_87_1;
            },
        ...
        execute: function() {
            ...
            b2PrismaticJointDef = class b2PrismaticJointDef extends b2Joint_4.b2JointDef {
                constructor() {
                    ...
                    this.motorSpeed = 0;
                    this.localAnchorA = new b2Math_88.b2Vec2();
                    this.localAnchorB = new b2Math_88.b2Vec2();
                    this.localAxisA = new b2Math_88.b2Vec2(1, 0);
                }
            ...
            exports_28("b2PrismaticJointDef", b2PrismaticJointDef);
            b2PrismaticJoint = class b2PrismaticJoint extends b2Joint_4.b2Joint {
                constructor(def) {
                    ...
                    this.m_localYAxisA = b2Math_91.b2CrossOneV(this.m_localXAxisA, new b2Math_88.b2Vec2());
                    this.m_referenceAngle = def.referenceAngle;
                    this.m_impulse = new b2Math_94.b2Vec3(0, 0, 0);
                    ...
                    this.m_localCenterA = new b2Math_88.b2Vec2();
                    this.m_localCenterB = new b2Math_88.b2Vec2();
                    this.m_axis = new b2Math_88.b2Vec2(0, 0);
                    this.m_perp = new b2Math_88.b2Vec2(0, 0);
                    this.m_K = new b2Math_96.b2Mat33();
                    this.m_K3 = new b2Math_96.b2Mat33();
                    this.m_K2 = new b2Math_95.b2Mat22();
                    this.m_qA = new b2Math_97.b2Rot();
                    this.m_qB = new b2Math_97.b2Rot();
                    this.m_lalcA = new b2Math_88.b2Vec2();
                    this.m_lalcB = new b2Math_88.b2Vec2();
                    this.m_rA = new b2Math_88.b2Vec2();
                    this.m_rB = new b2Math_88.b2Vec2();
                }
                InitVelocityConstraints(data) {
                    this.m_indexA = this.m_bodyA.m_islandIndex;
                    this.m_indexB = this.m_bodyB.m_islandIndex;
                    ...
                    // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_89.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_98.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_89.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_98.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // b2Vec2 d = (cB - cA) + rB - rA;
                    const d = b2Math_89.b2AddVV(b2Math_89.b2SubVV(cB, cA, b2Math_88.b2Vec2.s_t0), b2Math_89.b2SubVV(rB, rA, b2Math_88.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_d);
                    const mA = this.m_invMassA, mB = this.m_invMassB;
                    const iA = this.m_invIA, iB = this.m_invIB;
                    // Compute motor Jacobian and effective mass.
                    {
                        // m_axis = b2Mul(qA, m_localXAxisA);
                        b2Math_98.b2MulRV(qA, this.m_localXAxisA, this.m_axis);
                        // m_a1 = b2Cross(d + rA, m_axis);
                        this.m_a1 = b2Math_90.b2CrossVV(b2Math_89.b2AddVV(d, rA, b2Math_88.b2Vec2.s_t0), this.m_axis);
                        // m_a2 = b2Cross(rB, m_axis);
                        this.m_a2 = b2Math_90.b2CrossVV(rB, this.m_axis);
                    ...
                    // Prismatic constraint.
                    {
                        ...
                        b2Math_98.b2MulRV(qA, this.m_localYAxisA, this.m_perp);
                        // m_s1 = b2Cross(d + rA, m_perp);
                        this.m_s1 = b2Math_90.b2CrossVV(b2Math_89.b2AddVV(d, rA, b2Math_88.b2Vec2.s_t0), this.m_perp);
                        // m_s2 = b2Cross(rB, m_perp);
                        this.m_s2 = b2Math_90.b2CrossVV(rB, this.m_perp);
                    ...
                    if (this.m_enableLimit) {
                        ...
                        const jointTranslation = b2Math_90.b2DotVV(this.m_axis, d);
                        if (b2Math_87.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings_49.b2_linearSlop) {
                    ...
                    if (data.step.warmStarting) {
                        ...
                        const P = b2Math_89.b2AddVV(b2Math_89.b2MulSV(this.m_impulse.x, this.m_perp, b2Math_88.b2Vec2.s_t0), b2Math_89.b2MulSV((this.m_motorImpulse + this.m_impulse.z), this.m_axis, b2Math_88.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_P);
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (this.m_enableMotor && this.m_limitState !== 3 /* e_equalLimits */) {
                        ...
                        const Cdot = b2Math_90.b2DotVV(this.m_axis, b2Math_89.b2SubVV(vB, vA, b2Math_88.b2Vec2.s_t0)) + this.m_a2 * wB - this.m_a1 * wA;
                        let impulse = this.m_motorMass * (this.m_motorSpeed - Cdot);
                        const oldImpulse = this.m_motorImpulse;
                        const maxImpulse = data.step.dt * this.m_maxMotorForce;
                        this.m_motorImpulse = b2Math_87.b2Clamp(this.m_motorImpulse + impulse, (-maxImpulse), maxImpulse);
                        impulse = this.m_motorImpulse - oldImpulse;
                        // b2Vec2 P = impulse * m_axis;
                        const P = b2Math_89.b2MulSV(impulse, this.m_axis, b2PrismaticJoint.SolveVelocityConstraints_s_P);
                    ...
                    const Cdot1_x = b2Math_90.b2DotVV(this.m_perp, b2Math_89.b2SubVV(vB, vA, b2Math_88.b2Vec2.s_t0)) + this.m_s2 * wB - this.m_s1 * wA;
                    // Cdot1.y = wB - wA;
                    const Cdot1_y = wB - wA;
                    if (this.m_enableLimit && this.m_limitState !== 0 /* e_inactiveLimit */) {
                        ...
                        const Cdot2 = b2Math_90.b2DotVV(this.m_axis, b2Math_89.b2SubVV(vB, vA, b2Math_88.b2Vec2.s_t0)) + this.m_a2 * wB - this.m_a1 * wA;
                        ...
                        if (this.m_limitState === 1 /* e_atLowerLimit */) {
                            this.m_impulse.z = b2Math_87.b2Max(this.m_impulse.z, 0);
                        }
                        else if (this.m_limitState === 2 /* e_atUpperLimit */) {
                            this.m_impulse.z = b2Math_87.b2Min(this.m_impulse.z, 0);
                        }
                        ...
                        const P = b2Math_89.b2AddVV(b2Math_89.b2MulSV(df3.x, this.m_perp, b2Math_88.b2Vec2.s_t0), b2Math_89.b2MulSV(df3.z, this.m_axis, b2Math_88.b2Vec2.s_t1), b2PrismaticJoint.SolveVelocityConstraints_s_P);
                        ...
                        const P = b2Math_89.b2MulSV(df2.x, this.m_perp, b2PrismaticJoint.SolveVelocityConstraints_s_P);
                ...
                SolvePositionConstraints(data) {
                    ...
                    const d = b2Math_89.b2SubVV(b2Math_89.b2AddVV(cB, rB, b2Math_88.b2Vec2.s_t0), b2Math_89.b2AddVV(cA, rA, b2Math_88.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_d);
                    // b2Vec2 axis = b2Mul(qA, m_localXAxisA);
                    const axis = b2Math_98.b2MulRV(qA, this.m_localXAxisA, this.m_axis);
                    // float32 a1 = b2Cross(d + rA, axis);
                    const a1 = b2Math_90.b2CrossVV(b2Math_89.b2AddVV(d, rA, b2Math_88.b2Vec2.s_t0), axis);
                    // float32 a2 = b2Cross(rB, axis);
                    const a2 = b2Math_90.b2CrossVV(rB, axis);
                    // b2Vec2 perp = b2Mul(qA, m_localYAxisA);
                    const perp = b2Math_98.b2MulRV(qA, this.m_localYAxisA, this.m_perp);
                    // float32 s1 = b2Cross(d + rA, perp);
                    const s1 = b2Math_90.b2CrossVV(b2Math_89.b2AddVV(d, rA, b2Math_88.b2Vec2.s_t0), perp);
                    // float32 s2 = b2Cross(rB, perp);
                    const s2 = b2Math_90.b2CrossVV(rB, perp);
                    // b2Vec3 impulse;
                    let impulse = b2PrismaticJoint.SolvePositionConstraints_s_impulse;
                    // b2Vec2 C1;
                    // C1.x = b2Dot(perp, d);
                    const C1_x = b2Math_90.b2DotVV(perp, d);
                    // C1.y = aB - aA - m_referenceAngle;
                    const C1_y = aB - aA - this.m_referenceAngle;
                    let linearError = b2Math_87.b2Abs(C1_x);
                    let angularError = b2Math_87.b2Abs(C1_y);
                    let active = false;
                    let C2 = 0;
                    if (this.m_enableLimit) {
                        // float32 translation = b2Dot(axis, d);
                        const translation = b2Math_90.b2DotVV(axis, d);
                        if (b2Math_87.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings_49.b2_linearSlop) {
                            // Prevent large angular corrections
                            C2 = b2Math_87.b2Clamp(translation, (-b2Settings_50.b2_maxLinearCorrection), b2Settings_50.b2_maxLinearCorrection);
                            linearError = b2Math_87.b2Max(linearError, b2Math_87.b2Abs(translation));
                            active = true;
                        }
                        else if (translation <= this.m_lowerTranslation) {
                            // Prevent large linear corrections and allow some slop.
                            C2 = b2Math_87.b2Clamp(translation - this.m_lowerTranslation + b2Settings_49.b2_linearSlop, (-b2Settings_50.b2_maxLinearCorrection), 0);
                            linearError = b2Math_87.b2Max(linearError, this.m_lowerTranslation - translation);
                            active = true;
                        }
                        else if (translation >= this.m_upperTranslation) {
                            // Prevent large linear corrections and allow some slop.
                            C2 = b2Math_87.b2Clamp(translation - this.m_upperTranslation - b2Settings_49.b2_linearSlop, 0, b2Settings_50.b2_maxLinearCorrection);
                            linearError = b2Math_87.b2Max(linearError, translation - this.m_upperTranslation);
                            active = true;
                        }
                    }
                    if (active) {
                    ...
                    const P = b2Math_89.b2AddVV(b2Math_89.b2MulSV(impulse.x, perp, b2Math_88.b2Vec2.s_t0), b2Math_89.b2MulSV(impulse.z, axis, b2Math_88.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_P);
                    ...
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return linearError <= b2Settings_49.b2_linearSlop && angularError <= b2Settings_48.b2_angularSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                GetJointSpeed() {
                    ...
                    b2Math_89.b2SubVV(this.m_localAnchorA, bA.m_sweep.localCenter, this.m_lalcA);
                    const rA = b2Math_98.b2MulRV(bA.m_xf.q, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(bB->m_xf.q, m_localAnchorB - bB->m_sweep.localCenter);
                    b2Math_89.b2SubVV(this.m_localAnchorB, bB.m_sweep.localCenter, this.m_lalcB);
                    const rB = b2Math_98.b2MulRV(bB.m_xf.q, this.m_lalcB, this.m_rB);
                    // b2Vec2 pA = bA->m_sweep.c + rA;
                    const pA = b2Math_89.b2AddVV(bA.m_sweep.c, rA, b2Math_88.b2Vec2.s_t0); // pA uses s_t0
                    // b2Vec2 pB = bB->m_sweep.c + rB;
                    const pB = b2Math_89.b2AddVV(bB.m_sweep.c, rB, b2Math_88.b2Vec2.s_t1); // pB uses s_t1
                    // b2Vec2 d = pB - pA;
                    const d = b2Math_89.b2SubVV(pB, pA, b2Math_88.b2Vec2.s_t2); // d uses s_t2
                    ...
                    const speed = b2Math_90.b2DotVV(d, b2Math_92.b2CrossSV(wA, axis, b2Math_88.b2Vec2.s_t0)) +
                        b2Math_90.b2DotVV(axis, b2Math_89.b2SubVV(b2Math_93.b2AddVCrossSV(vB, wB, rB, b2Math_88.b2Vec2.s_t0), b2Math_93.b2AddVCrossSV(vA, wA, rA, b2Math_88.b2Vec2.s_t1), b2Math_88.b2Vec2.s_t0));
                    return speed;
                }
                IsLimitEnabled() {
                ...
                Dump() {
                    if (b2Settings_47.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_47.b2Log("  const jd: b2PrismaticJointDef = new b2PrismaticJointDef();\n");
                        b2Settings_47.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_47.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_47.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_47.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_47.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_47.b2Log("  jd.localAxisA.SetXY(%.15f, %.15f);\n", this.m_localXAxisA.x, this.m_localXAxisA.y);
                        b2Settings_47.b2Log("  jd.referenceAngle = %.15f;\n", this.m_referenceAngle);
                        b2Settings_47.b2Log("  jd.enableLimit = %s;\n", (this.m_enableLimit) ? ("true") : ("false"));
                        b2Settings_47.b2Log("  jd.lowerTranslation = %.15f;\n", this.m_lowerTranslation);
                        b2Settings_47.b2Log("  jd.upperTranslation = %.15f;\n", this.m_upperTranslation);
                        b2Settings_47.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ("true") : ("false"));
                        b2Settings_47.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
                        b2Settings_47.b2Log("  jd.maxMotorForce = %.15f;\n", this.m_maxMotorForce);
                        b2Settings_47.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2PrismaticJoint.InitVelocityConstraints_s_d = new b2Math_88.b2Vec2();
            b2PrismaticJoint.InitVelocityConstraints_s_P = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolveVelocityConstraints_s_P = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolveVelocityConstraints_s_f2r = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolveVelocityConstraints_s_f1 = new b2Math_94.b2Vec3();
            b2PrismaticJoint.SolveVelocityConstraints_s_df3 = new b2Math_94.b2Vec3();
            b2PrismaticJoint.SolveVelocityConstraints_s_df2 = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolvePositionConstraints_s_d = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolvePositionConstraints_s_impulse = new b2Math_94.b2Vec3();
            b2PrismaticJoint.SolvePositionConstraints_s_impulse1 = new b2Math_88.b2Vec2();
            b2PrismaticJoint.SolvePositionConstraints_s_P = new b2Math_88.b2Vec2();
            b2PrismaticJoint.GetJointTranslation_s_pA = new b2Math_88.b2Vec2();
            b2PrismaticJoint.GetJointTranslation_s_pB = new b2Math_88.b2Vec2();
            b2PrismaticJoint.GetJointTranslation_s_d = new b2Math_88.b2Vec2();
            b2PrismaticJoint.GetJointTranslation_s_axis = new b2Math_88.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2RevoluteJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_29, context_29) {
    "use strict";
    var __moduleName = context_29 && context_29.id;
    var b2Settings_51, b2Settings_52, b2Settings_53, b2Settings_54, b2Math_99, b2Math_100, b2Math_101, b2Math_102, b2Math_103, b2Math_104, b2Math_105, b2Math_106, b2Math_107, b2Math_108, b2Joint_5;
    var b2RevoluteJointDef, b2RevoluteJoint;
    return {
        setters:[
            function (b2Settings_51_1) {
                b2Settings_51 = b2Settings_51_1;
                b2Settings_52 = b2Settings_51_1;
                b2Settings_53 = b2Settings_51_1;
                b2Settings_54 = b2Settings_51_1;
            },
            function (b2Math_99_1) {
                b2Math_99 = b2Math_99_1;
                b2Math_100 = b2Math_99_1;
                b2Math_101 = b2Math_99_1;
                b2Math_102 = b2Math_99_1;
                b2Math_103 = b2Math_99_1;
                b2Math_104 = b2Math_99_1;
                b2Math_105 = b2Math_99_1;
                b2Math_106 = b2Math_99_1;
                b2Math_107 = b2Math_99_1;
                b2Math_108 = b2Math_99_1;
            },
        ...
        execute: function() {
            ...
            b2RevoluteJointDef = class b2RevoluteJointDef extends b2Joint_5.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_100.b2Vec2(0, 0);
                    this.localAnchorB = new b2Math_100.b2Vec2(0, 0);
                    this.referenceAngle = 0;
                    this.enableLimit = false;
                    this.lowerAngle = 0;
                    this.upperAngle = 0;
            ...
            exports_29("b2RevoluteJointDef", b2RevoluteJointDef);
            b2RevoluteJoint = class b2RevoluteJoint extends b2Joint_5.b2Joint {
                constructor(def) {
                    super(def); // base class constructor
                    // Solver shared
                    this.m_localAnchorA = new b2Math_100.b2Vec2();
                    this.m_localAnchorB = new b2Math_100.b2Vec2();
                    this.m_impulse = new b2Math_104.b2Vec3();
                    this.m_motorImpulse = 0;
                    this.m_enableMotor = false;
                    ...
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_rA = new b2Math_100.b2Vec2();
                    this.m_rB = new b2Math_100.b2Vec2();
                    this.m_localCenterA = new b2Math_100.b2Vec2();
                    this.m_localCenterB = new b2Math_100.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_mass = new b2Math_106.b2Mat33(); // effective mass for point-to-point constraint.
                    this.m_motorMass = 0; // effective mass for motor/limit angular constraint.
                    this.m_limitState = 0 /* e_inactiveLimit */;
                    this.m_qA = new b2Math_107.b2Rot();
                    this.m_qB = new b2Math_107.b2Rot();
                    this.m_lalcA = new b2Math_100.b2Vec2();
                    this.m_lalcB = new b2Math_100.b2Vec2();
                    this.m_K = new b2Math_105.b2Mat22();
                    this.m_localAnchorA.Copy(def.localAnchorA);
                    this.m_localAnchorB.Copy(def.localAnchorB);
                    this.m_referenceAngle = def.referenceAngle;
                    this.m_impulse.SetZero();
                ...
                InitVelocityConstraints(data) {
                    ...
                    const qA = this.m_qA.SetAngleRadians(aA), qB = this.m_qB.SetAngleRadians(aB);
                    // m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_101.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    b2Math_108.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_101.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_108.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // J = [-I -r1_skew I r2_skew]
                    //     [ 0       -1 0       1]
                    // r_skew = [-ry; rx]
                    // Matlab
                    ...
                    if (this.m_enableLimit && fixedRotation === false) {
                        ...
                        if (b2Math_99.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * b2Settings_52.b2_angularSlop) {
                            this.m_limitState = 3 /* e_equalLimits */;
                        }
                    ...
                    if (data.step.warmStarting) {
                        ...
                        // vA -= mA * P;
                        vA.SelfMulSub(mA, P);
                        wA -= iA * (b2Math_102.b2CrossVV(this.m_rA, P) + this.m_motorImpulse + this.m_impulse.z);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        wB += iB * (b2Math_102.b2CrossVV(this.m_rB, P) + this.m_motorImpulse + this.m_impulse.z);
                    }
                    else {
                        this.m_impulse.SetZero();
                        this.m_motorImpulse = 0;
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (this.m_enableMotor && this.m_limitState !== 3 /* e_equalLimits */ && fixedRotation === false) {
                        ...
                        this.m_motorImpulse = b2Math_99.b2Clamp(this.m_motorImpulse + impulse, -maxImpulse, maxImpulse);
                        impulse = this.m_motorImpulse - oldImpulse;
                        wA -= iA * impulse;
                        wB += iB * impulse;
                    }
                    ...
                    if (this.m_enableLimit && this.m_limitState !== 0 /* e_inactiveLimit */ && fixedRotation === false) {
                        ...
                        const Cdot1 = b2Math_101.b2SubVV(b2Math_103.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_100.b2Vec2.s_t0), b2Math_103.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_100.b2Vec2.s_t1), b2RevoluteJoint.SolveVelocityConstraints_s_Cdot1);
                        const Cdot2 = wB - wA;
                        // b2Vec3 Cdot(Cdot1.x, Cdot1.y, Cdot2);
                        ...
                        // vA -= mA * P;
                        vA.SelfMulSub(mA, P);
                        wA -= iA * (b2Math_102.b2CrossVV(this.m_rA, P) + impulse_v3.z);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        wB += iB * (b2Math_102.b2CrossVV(this.m_rB, P) + impulse_v3.z);
                    }
                    else {
                        // Solve point-to-point constraint
                        // b2Vec2 Cdot = vB + b2Cross(wB, m_rB) - vA - b2Cross(wA, m_rA);
                        const Cdot_v2 = b2Math_101.b2SubVV(b2Math_103.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_100.b2Vec2.s_t0), b2Math_103.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_100.b2Vec2.s_t1), b2RevoluteJoint.SolveVelocityConstraints_s_Cdot_v2);
                        ...
                        wA -= iA * b2Math_102.b2CrossVV(this.m_rA, impulse_v2);
                        // vB += mB * impulse;
                        vB.SelfMulAdd(mB, impulse_v2);
                        wB += iB * b2Math_102.b2CrossVV(this.m_rB, impulse_v2);
                    }
                    // data.velocities[this.m_indexA].v = vA;
                    data.velocities[this.m_indexA].w = wA;
                    // data.velocities[this.m_indexB].v = vB;
                ...
                SolvePositionConstraints(data) {
                    ...
                    if (this.m_enableLimit && this.m_limitState !== 0 /* e_inactiveLimit */ && fixedRotation === false) {
                        ...
                        if (this.m_limitState === 3 /* e_equalLimits */) {
                            // Prevent large angular corrections
                            const C = b2Math_99.b2Clamp(angle - this.m_lowerAngle, -b2Settings_54.b2_maxAngularCorrection, b2Settings_54.b2_maxAngularCorrection);
                            limitImpulse = -this.m_motorMass * C;
                            angularError = b2Math_99.b2Abs(C);
                        }
                        else if (this.m_limitState === 1 /* e_atLowerLimit */) {
                            let C = angle - this.m_lowerAngle;
                            angularError = -C;
                            // Prevent large angular corrections and allow some slop.
                            C = b2Math_99.b2Clamp(C + b2Settings_52.b2_angularSlop, -b2Settings_54.b2_maxAngularCorrection, 0);
                            limitImpulse = -this.m_motorMass * C;
                        }
                        else if (this.m_limitState === 2 /* e_atUpperLimit */) {
                            ...
                            angularError = C;
                            // Prevent large angular corrections and allow some slop.
                            C = b2Math_99.b2Clamp(C - b2Settings_52.b2_angularSlop, 0, b2Settings_54.b2_maxAngularCorrection);
                            limitImpulse = -this.m_motorMass * C;
                        }
                    ...
                    // Solve point-to-point constraint.
                    {
                        ...
                        // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                        b2Math_101.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                        const rA = b2Math_108.b2MulRV(qA, this.m_lalcA, this.m_rA);
                        // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                        b2Math_101.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                        const rB = b2Math_108.b2MulRV(qB, this.m_lalcB, this.m_rB);
                        // b2Vec2 C = cB + rB - cA - rA;
                        const C_v2 = b2Math_101.b2SubVV(b2Math_101.b2AddVV(cB, rB, b2Math_100.b2Vec2.s_t0), b2Math_101.b2AddVV(cA, rA, b2Math_100.b2Vec2.s_t1), b2RevoluteJoint.SolvePositionConstraints_s_C_v2);
                        ...
                        aA -= iA * b2Math_102.b2CrossVV(rA, impulse);
                        // cB += mB * impulse;
                        cB.SelfMulAdd(mB, impulse);
                        aB += iB * b2Math_102.b2CrossVV(rB, impulse);
                    }
                    // data.positions[this.m_indexA].c = cA;
                    data.positions[this.m_indexA].a = aA;
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return positionError <= b2Settings_53.b2_linearSlop && angularError <= b2Settings_52.b2_angularSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                Dump() {
                    if (b2Settings_51.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_51.b2Log("  const jd: b2RevoluteJointDef = new b2RevoluteJointDef();\n");
                        b2Settings_51.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_51.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_51.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_51.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_51.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_51.b2Log("  jd.referenceAngle = %.15f;\n", this.m_referenceAngle);
                        b2Settings_51.b2Log("  jd.enableLimit = %s;\n", (this.m_enableLimit) ? ("true") : ("false"));
                        b2Settings_51.b2Log("  jd.lowerAngle = %.15f;\n", this.m_lowerAngle);
                        b2Settings_51.b2Log("  jd.upperAngle = %.15f;\n", this.m_upperAngle);
                        b2Settings_51.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ("true") : ("false"));
                        b2Settings_51.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
                        b2Settings_51.b2Log("  jd.maxMotorTorque = %.15f;\n", this.m_maxMotorTorque);
                        b2Settings_51.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2RevoluteJoint.InitVelocityConstraints_s_P = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolveVelocityConstraints_s_P = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolveVelocityConstraints_s_Cdot_v2 = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolveVelocityConstraints_s_Cdot1 = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolveVelocityConstraints_s_impulse_v3 = new b2Math_104.b2Vec3();
            b2RevoluteJoint.SolveVelocityConstraints_s_reduced_v2 = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolveVelocityConstraints_s_impulse_v2 = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolvePositionConstraints_s_C_v2 = new b2Math_100.b2Vec2();
            b2RevoluteJoint.SolvePositionConstraints_s_impulse = new b2Math_100.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2GearJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_30, context_30) {
    "use strict";
    var __moduleName = context_30 && context_30.id;
    var b2Settings_55, b2Settings_56, b2Math_109, b2Math_110, b2Math_111, b2Math_112, b2Math_113, b2Math_114, b2Joint_6;
    var b2GearJointDef, b2GearJoint;
    return {
        setters:[
            function (b2Settings_55_1) {
                b2Settings_55 = b2Settings_55_1;
                b2Settings_56 = b2Settings_55_1;
            },
            function (b2Math_109_1) {
                b2Math_109 = b2Math_109_1;
                b2Math_110 = b2Math_109_1;
                b2Math_111 = b2Math_109_1;
                b2Math_112 = b2Math_109_1;
                b2Math_113 = b2Math_109_1;
                b2Math_114 = b2Math_109_1;
            },
        ...
        execute: function() {
            ...
            exports_30("b2GearJointDef", b2GearJointDef);
            b2GearJoint = class b2GearJoint extends b2Joint_6.b2Joint {
                constructor(def) {
                    ...
                    this.m_bodyD = null;
                    // Solver shared
                    this.m_localAnchorA = new b2Math_110.b2Vec2();
                    this.m_localAnchorB = new b2Math_110.b2Vec2();
                    this.m_localAnchorC = new b2Math_110.b2Vec2();
                    this.m_localAnchorD = new b2Math_110.b2Vec2();
                    this.m_localAxisC = new b2Math_110.b2Vec2();
                    this.m_localAxisD = new b2Math_110.b2Vec2();
                    ...
                    this.m_indexC = 0;
                    this.m_indexD = 0;
                    this.m_lcA = new b2Math_110.b2Vec2();
                    this.m_lcB = new b2Math_110.b2Vec2();
                    this.m_lcC = new b2Math_110.b2Vec2();
                    this.m_lcD = new b2Math_110.b2Vec2();
                    this.m_mA = 0;
                    this.m_mB = 0;
                    this.m_mC = 0;
                    this.m_mD = 0;
                    ...
                    this.m_iC = 0;
                    this.m_iD = 0;
                    this.m_JvAC = new b2Math_110.b2Vec2();
                    this.m_JvBD = new b2Math_110.b2Vec2();
                    this.m_JwA = 0;
                    this.m_JwB = 0;
                    this.m_JwC = 0;
                    this.m_JwD = 0;
                    this.m_mass = 0;
                    this.m_qA = new b2Math_113.b2Rot();
                    this.m_qB = new b2Math_113.b2Rot();
                    this.m_qC = new b2Math_113.b2Rot();
                    this.m_qD = new b2Math_113.b2Rot();
                    this.m_lalcA = new b2Math_110.b2Vec2();
                    this.m_lalcB = new b2Math_110.b2Vec2();
                    this.m_lalcC = new b2Math_110.b2Vec2();
                    this.m_lalcD = new b2Math_110.b2Vec2();
                    this.m_joint1 = def.joint1;
                    this.m_joint2 = def.joint2;
                    this.m_typeA = this.m_joint1.GetType();
                    this.m_typeB = this.m_joint2.GetType();
                    if (b2Settings_55.ENABLE_ASSERTS) {
                        b2Settings_55.b2Assert(this.m_typeA === 1 /* e_revoluteJoint */ || this.m_typeA === 2 /* e_prismaticJoint */);
                    }
                    if (b2Settings_55.ENABLE_ASSERTS) {
                        b2Settings_55.b2Assert(this.m_typeB === 1 /* e_revoluteJoint */ || this.m_typeB === 2 /* e_prismaticJoint */);
                    }
                    ...
                    if (this.m_typeA === 1 /* e_revoluteJoint */) {
                        ...
                        const pA = b2Math_114.b2MulTRV(xfC.q, b2Math_111.b2AddVV(b2Math_114.b2MulRV(xfA.q, this.m_localAnchorA, b2Math_110.b2Vec2.s_t0), b2Math_111.b2SubVV(xfA.p, xfC.p, b2Math_110.b2Vec2.s_t1), b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0); // pA uses s_t0
                        // coordinateA = b2Dot(pA - pC, m_localAxisC);
                        coordinateA = b2Math_112.b2DotVV(b2Math_111.b2SubVV(pA, pC, b2Math_110.b2Vec2.s_t0), this.m_localAxisC);
                    }
                    ...
                    if (this.m_typeB === 1 /* e_revoluteJoint */) {
                        ...
                        const pB = b2Math_114.b2MulTRV(xfD.q, b2Math_111.b2AddVV(b2Math_114.b2MulRV(xfB.q, this.m_localAnchorB, b2Math_110.b2Vec2.s_t0), b2Math_111.b2SubVV(xfB.p, xfD.p, b2Math_110.b2Vec2.s_t1), b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0); // pB uses s_t0
                        // coordinateB = b2Dot(pB - pD, m_localAxisD);
                        coordinateB = b2Math_112.b2DotVV(b2Math_111.b2SubVV(pB, pD, b2Math_110.b2Vec2.s_t0), this.m_localAxisD);
                    }
                ...
                InitVelocityConstraints(data) {
                    ...
                    if (this.m_typeA === 1 /* e_revoluteJoint */) {
                        ...
                        const u = b2Math_114.b2MulRV(qC, this.m_localAxisC, b2GearJoint.InitVelocityConstraints_s_u);
                        // b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
                        b2Math_111.b2SubVV(this.m_localAnchorC, this.m_lcC, this.m_lalcC);
                        const rC = b2Math_114.b2MulRV(qC, this.m_lalcC, b2GearJoint.InitVelocityConstraints_s_rC);
                        // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
                        b2Math_111.b2SubVV(this.m_localAnchorA, this.m_lcA, this.m_lalcA);
                        const rA = b2Math_114.b2MulRV(qA, this.m_lalcA, b2GearJoint.InitVelocityConstraints_s_rA);
                        // m_JvAC = u;
                        this.m_JvAC.Copy(u);
                        // m_JwC = b2Cross(rC, u);
                        this.m_JwC = b2Math_112.b2CrossVV(rC, u);
                        // m_JwA = b2Cross(rA, u);
                        this.m_JwA = b2Math_112.b2CrossVV(rA, u);
                    ...
                    if (this.m_typeB === 1 /* e_revoluteJoint */) {
                        ...
                        const u = b2Math_114.b2MulRV(qD, this.m_localAxisD, b2GearJoint.InitVelocityConstraints_s_u);
                        // b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
                        b2Math_111.b2SubVV(this.m_localAnchorD, this.m_lcD, this.m_lalcD);
                        const rD = b2Math_114.b2MulRV(qD, this.m_lalcD, b2GearJoint.InitVelocityConstraints_s_rD);
                        // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
                        b2Math_111.b2SubVV(this.m_localAnchorB, this.m_lcB, this.m_lalcB);
                        const rB = b2Math_114.b2MulRV(qB, this.m_lalcB, b2GearJoint.InitVelocityConstraints_s_rB);
                        // m_JvBD = m_ratio * u;
                        b2Math_111.b2MulSV(this.m_ratio, u, this.m_JvBD);
                        // m_JwD = m_ratio * b2Cross(rD, u);
                        this.m_JwD = this.m_ratio * b2Math_112.b2CrossVV(rD, u);
                        // m_JwB = m_ratio * b2Cross(rB, u);
                        this.m_JwB = this.m_ratio * b2Math_112.b2CrossVV(rB, u);
                ...
                SolveVelocityConstraints(data) {
                    ...
                    let Cdot = b2Math_112.b2DotVV(this.m_JvAC, b2Math_111.b2SubVV(vA, vC, b2Math_110.b2Vec2.s_t0)) +
                        b2Math_112.b2DotVV(this.m_JvBD, b2Math_111.b2SubVV(vB, vD, b2Math_110.b2Vec2.s_t0));
                ...
                SolvePositionConstraints(data) {
                    ...
                    if (this.m_typeA === 1 /* e_revoluteJoint */) {
                        ...
                        // b2Vec2 u = b2Mul(qC, m_localAxisC);
                        const u = b2Math_114.b2MulRV(qC, this.m_localAxisC, b2GearJoint.SolvePositionConstraints_s_u);
                        // b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
                        const rC = b2Math_114.b2MulRV(qC, this.m_lalcC, b2GearJoint.SolvePositionConstraints_s_rC);
                        // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
                        const rA = b2Math_114.b2MulRV(qA, this.m_lalcA, b2GearJoint.SolvePositionConstraints_s_rA);
                        // JvAC = u;
                        JvAC.Copy(u);
                        // JwC = b2Cross(rC, u);
                        JwC = b2Math_112.b2CrossVV(rC, u);
                        // JwA = b2Cross(rA, u);
                        JwA = b2Math_112.b2CrossVV(rA, u);
                        mass += this.m_mC + this.m_mA + this.m_iC * JwC * JwC + this.m_iA * JwA * JwA;
                        // b2Vec2 pC = m_localAnchorC - m_lcC;
                        const pC = this.m_lalcC;
                        // b2Vec2 pA = b2MulT(qC, rA + (cA - cC));
                        const pA = b2Math_114.b2MulTRV(qC, b2Math_111.b2AddVV(rA, b2Math_111.b2SubVV(cA, cC, b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0); // pA uses s_t0
                        // coordinateA = b2Dot(pA - pC, m_localAxisC);
                        coordinateA = b2Math_112.b2DotVV(b2Math_111.b2SubVV(pA, pC, b2Math_110.b2Vec2.s_t0), this.m_localAxisC);
                    }
                    if (this.m_typeB === 1 /* e_revoluteJoint */) {
                        ...
                        // b2Vec2 u = b2Mul(qD, m_localAxisD);
                        const u = b2Math_114.b2MulRV(qD, this.m_localAxisD, b2GearJoint.SolvePositionConstraints_s_u);
                        // b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
                        const rD = b2Math_114.b2MulRV(qD, this.m_lalcD, b2GearJoint.SolvePositionConstraints_s_rD);
                        // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
                        const rB = b2Math_114.b2MulRV(qB, this.m_lalcB, b2GearJoint.SolvePositionConstraints_s_rB);
                        // JvBD = m_ratio * u;
                        b2Math_111.b2MulSV(this.m_ratio, u, JvBD);
                        // JwD = m_ratio * b2Cross(rD, u);
                        JwD = this.m_ratio * b2Math_112.b2CrossVV(rD, u);
                        // JwB = m_ratio * b2Cross(rB, u);
                        JwB = this.m_ratio * b2Math_112.b2CrossVV(rB, u);
                        mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * JwD * JwD + this.m_iB * JwB * JwB;
                        // b2Vec2 pD = m_localAnchorD - m_lcD;
                        const pD = this.m_lalcD;
                        // b2Vec2 pB = b2MulT(qD, rB + (cB - cD));
                        const pB = b2Math_114.b2MulTRV(qD, b2Math_111.b2AddVV(rB, b2Math_111.b2SubVV(cB, cD, b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0), b2Math_110.b2Vec2.s_t0); // pB uses s_t0
                        // coordinateB = b2Dot(pB - pD, m_localAxisD);
                        coordinateB = b2Math_112.b2DotVV(b2Math_111.b2SubVV(pB, pD, b2Math_110.b2Vec2.s_t0), this.m_localAxisD);
                    }
                    ...
                    return linearError < b2Settings_56.b2_linearSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                GetReactionForce(inv_dt, out) {
                    ...
                    // return inv_dt * P;
                    return b2Math_111.b2MulSV(inv_dt * this.m_impulse, this.m_JvAC, out);
                }
                GetReactionTorque(inv_dt) {
                ...
                SetRatio(ratio) {
                    if (b2Settings_55.ENABLE_ASSERTS) {
                        b2Settings_55.b2Assert(b2Math_109.b2IsValid(ratio));
                    }
                    this.m_ratio = ratio;
                }
                Dump() {
                    if (b2Settings_55.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        const index1 = this.m_joint1.m_index;
                        const index2 = this.m_joint2.m_index;
                        b2Settings_55.b2Log("  const jd: b2GearJointDef = new b2GearJointDef();\n");
                        b2Settings_55.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_55.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_55.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_55.b2Log("  jd.joint1 = joints[%d];\n", index1);
                        b2Settings_55.b2Log("  jd.joint2 = joints[%d];\n", index2);
                        b2Settings_55.b2Log("  jd.ratio = %.15f;\n", this.m_ratio);
                        b2Settings_55.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2GearJoint.InitVelocityConstraints_s_u = new b2Math_110.b2Vec2();
            b2GearJoint.InitVelocityConstraints_s_rA = new b2Math_110.b2Vec2();
            b2GearJoint.InitVelocityConstraints_s_rB = new b2Math_110.b2Vec2();
            b2GearJoint.InitVelocityConstraints_s_rC = new b2Math_110.b2Vec2();
            b2GearJoint.InitVelocityConstraints_s_rD = new b2Math_110.b2Vec2();
            b2GearJoint.SolvePositionConstraints_s_u = new b2Math_110.b2Vec2();
            b2GearJoint.SolvePositionConstraints_s_rA = new b2Math_110.b2Vec2();
            b2GearJoint.SolvePositionConstraints_s_rB = new b2Math_110.b2Vec2();
            b2GearJoint.SolvePositionConstraints_s_rC = new b2Math_110.b2Vec2();
            b2GearJoint.SolvePositionConstraints_s_rD = new b2Math_110.b2Vec2();
            exports_30("b2GearJoint", b2GearJoint);
        }
    }
});
System.register("Box2D/Dynamics/Joints/b2MotorJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_31, context_31) {
    "use strict";
    var __moduleName = context_31 && context_31.id;
    var b2Settings_57, b2Math_115, b2Math_116, b2Math_117, b2Math_118, b2Math_119, b2Math_120, b2Math_121, b2Math_122, b2Math_123, b2Math_124, b2Math_125, b2Joint_7;
    var b2MotorJointDef, b2MotorJoint;
    return {
        setters:[
            function (b2Settings_57_1) {
                b2Settings_57 = b2Settings_57_1;
            },
            function (b2Math_115_1) {
                b2Math_115 = b2Math_115_1;
                b2Math_116 = b2Math_115_1;
                b2Math_117 = b2Math_115_1;
                b2Math_118 = b2Math_115_1;
                b2Math_119 = b2Math_115_1;
                b2Math_120 = b2Math_115_1;
                b2Math_121 = b2Math_115_1;
                b2Math_122 = b2Math_115_1;
                b2Math_123 = b2Math_115_1;
                b2Math_124 = b2Math_115_1;
                b2Math_125 = b2Math_115_1;
            },
        ...
        execute: function() {
            b2MotorJointDef = class b2MotorJointDef extends b2Joint_7.b2JointDef {
                constructor() {
                    ...
                    this.linearOffset = new b2Math_117.b2Vec2(0, 0);
            ...
            exports_31("b2MotorJointDef", b2MotorJointDef);
            b2MotorJoint = class b2MotorJoint extends b2Joint_7.b2Joint {
                constructor(def) {
                    super(def); // base class constructor
                    // Solver shared
                    this.m_linearOffset = new b2Math_117.b2Vec2();
                    this.m_angularOffset = 0;
                    this.m_linearImpulse = new b2Math_117.b2Vec2();
                    this.m_angularImpulse = 0;
                    this.m_maxForce = 0;
                    this.m_maxTorque = 0;
                    ...
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_rA = new b2Math_117.b2Vec2();
                    this.m_rB = new b2Math_117.b2Vec2();
                    this.m_localCenterA = new b2Math_117.b2Vec2();
                    this.m_localCenterB = new b2Math_117.b2Vec2();
                    this.m_linearError = new b2Math_117.b2Vec2();
                    this.m_angularError = 0;
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_linearMass = new b2Math_122.b2Mat22();
                    this.m_angularMass = 0;
                    this.m_qA = new b2Math_124.b2Rot();
                    this.m_qB = new b2Math_124.b2Rot();
                    this.m_K = new b2Math_122.b2Mat22();
                ...
                GetReactionForce(inv_dt, out) {
                    ...
                    return b2Math_119.b2MulSV(inv_dt, this.m_linearImpulse, out);
                }
                GetReactionTorque(inv_dt) {
                    return inv_dt * this.m_angularImpulse;
                }
                SetLinearOffset(linearOffset) {
                    if (!b2Math_118.b2IsEqualToV(linearOffset, this.m_linearOffset)) {
                        this.m_bodyA.SetAwake(true);
                        this.m_bodyB.SetAwake(true);
                ...
                SetMaxForce(force) {
                    if (b2Settings_57.ENABLE_ASSERTS) {
                        b2Settings_57.b2Assert(b2Math_115.b2IsValid(force) && force >= 0);
                    }
                    this.m_maxForce = force;
                }
                GetMaxForce() {
                ...
                SetMaxTorque(torque) {
                    if (b2Settings_57.ENABLE_ASSERTS) {
                        b2Settings_57.b2Assert(b2Math_115.b2IsValid(torque) && torque >= 0);
                    }
                    this.m_maxTorque = torque;
                }
                GetMaxTorque() {
                ...
                InitVelocityConstraints(data) {
                    ...
                    const rA = b2Math_125.b2MulRV(qA, b2Math_119.b2NegV(this.m_localCenterA, b2Math_117.b2Vec2.s_t0), this.m_rA);
                    // this.m_rB = b2Mul(qB, -this.m_localCenterB);
                    const rB = b2Math_125.b2MulRV(qB, b2Math_119.b2NegV(this.m_localCenterB, b2Math_117.b2Vec2.s_t0), this.m_rB);
                    // J = [-I -r1_skew I r2_skew]
                    //     [ 0       -1 0       1]
                    // r_skew = [-ry; rx]
                    // Matlab
                    ...
                    b2Math_119.b2SubVV(b2Math_119.b2SubVV(b2Math_119.b2AddVV(cB, rB, b2Math_117.b2Vec2.s_t0), b2Math_119.b2AddVV(cA, rA, b2Math_117.b2Vec2.s_t1), b2Math_117.b2Vec2.s_t2), b2Math_125.b2MulRV(qA, this.m_linearOffset, b2Math_117.b2Vec2.s_t3), this.m_linearError);
                    ...
                    if (data.step.warmStarting) {
                        ...
                        // vA -= mA * P;
                        vA.SelfMulSub(mA, P);
                        wA -= iA * (b2Math_120.b2CrossVV(rA, P) + this.m_angularImpulse);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        wB += iB * (b2Math_120.b2CrossVV(rB, P) + this.m_angularImpulse);
                    }
                    else {
                        this.m_linearImpulse.SetZero();
                        this.m_angularImpulse = 0;
                ...
                SolveVelocityConstraints(data) {
                    ...
                    // Solve angular friction
                    {
                        ...
                        const oldImpulse = this.m_angularImpulse;
                        const maxImpulse = h * this.m_maxTorque;
                        this.m_angularImpulse = b2Math_116.b2Clamp(this.m_angularImpulse + impulse, -maxImpulse, maxImpulse);
                        impulse = this.m_angularImpulse - oldImpulse;
                        wA -= iA * impulse;
                        wB += iB * impulse;
                    }
                    // Solve linear friction
                    {
                        ...
                        const Cdot_v2 = b2Math_119.b2AddVV(b2Math_119.b2SubVV(b2Math_119.b2AddVV(vB, b2Math_121.b2CrossSV(wB, rB, b2Math_117.b2Vec2.s_t0), b2Math_117.b2Vec2.s_t0), b2Math_119.b2AddVV(vA, b2Math_121.b2CrossSV(wA, rA, b2Math_117.b2Vec2.s_t1), b2Math_117.b2Vec2.s_t1), b2Math_117.b2Vec2.s_t2), b2Math_119.b2MulSV(inv_h * this.m_correctionFactor, this.m_linearError, b2Math_117.b2Vec2.s_t3), b2MotorJoint.SolveVelocityConstraints_s_Cdot_v2);
                        // b2Vec2 impulse = -b2Mul(this.m_linearMass, Cdot);
                        const impulse_v2 = b2Math_123.b2MulMV(this.m_linearMass, Cdot_v2, b2MotorJoint.SolveVelocityConstraints_s_impulse_v2).SelfNeg();
                        ...
                        b2Math_119.b2SubVV(this.m_linearImpulse, oldImpulse_v2, impulse_v2);
                        // vA -= mA * impulse;
                        vA.SelfMulSub(mA, impulse_v2);
                        // wA -= iA * b2CrossVV(rA, impulse);
                        wA -= iA * b2Math_120.b2CrossVV(rA, impulse_v2);
                        // vB += mB * impulse;
                        vB.SelfMulAdd(mB, impulse_v2);
                        // wB += iB * b2CrossVV(rB, impulse);
                        wB += iB * b2Math_120.b2CrossVV(rB, impulse_v2);
                    }
                    // data.velocities[this.m_indexA].v = vA; // vA is a reference
                    data.velocities[this.m_indexA].w = wA;
                    // data.velocities[this.m_indexB].v = vB; // vB is a reference
                ...
                Dump() {
                    if (b2Settings_57.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_57.b2Log("  const jd: b2MotorJointDef = new b2MotorJointDef();\n");
                        b2Settings_57.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_57.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_57.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_57.b2Log("  jd.linearOffset.SetXY(%.15f, %.15f);\n", this.m_linearOffset.x, this.m_linearOffset.y);
                        b2Settings_57.b2Log("  jd.angularOffset = %.15f;\n", this.m_angularOffset);
                        b2Settings_57.b2Log("  jd.maxForce = %.15f;\n", this.m_maxForce);
                        b2Settings_57.b2Log("  jd.maxTorque = %.15f;\n", this.m_maxTorque);
                        b2Settings_57.b2Log("  jd.correctionFactor = %.15f;\n", this.m_correctionFactor);
                        b2Settings_57.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2MotorJoint.SolveVelocityConstraints_s_Cdot_v2 = new b2Math_117.b2Vec2();
            b2MotorJoint.SolveVelocityConstraints_s_impulse_v2 = new b2Math_117.b2Vec2();
            b2MotorJoint.SolveVelocityConstraints_s_oldImpulse_v2 = new b2Math_117.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2MouseJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_32, context_32) {
    "use strict";
    var __moduleName = context_32 && context_32.id;
    var b2Settings_58, b2Settings_59, b2Settings_60, b2Math_126, b2Math_127, b2Math_128, b2Math_129, b2Math_130, b2Math_131, b2Math_132, b2Math_133, b2Math_134, b2Math_135, b2Joint_8;
    var b2MouseJointDef, b2MouseJoint;
    return {
        setters:[
            function (b2Settings_58_1) {
                b2Settings_58 = b2Settings_58_1;
                b2Settings_59 = b2Settings_58_1;
                b2Settings_60 = b2Settings_58_1;
            },
            function (b2Math_126_1) {
                b2Math_126 = b2Math_126_1;
                b2Math_127 = b2Math_126_1;
                b2Math_128 = b2Math_126_1;
                b2Math_129 = b2Math_126_1;
                b2Math_130 = b2Math_126_1;
                b2Math_131 = b2Math_126_1;
                b2Math_132 = b2Math_126_1;
                b2Math_133 = b2Math_126_1;
                b2Math_134 = b2Math_126_1;
                b2Math_135 = b2Math_126_1;
            },
        ...
        execute: function() {
            ...
            b2MouseJointDef = class b2MouseJointDef extends b2Joint_8.b2JointDef {
                constructor() {
                    ...
                    this.target = new b2Math_127.b2Vec2();
                    this.maxForce = 0;
                    this.frequencyHz = 5;
                    this.dampingRatio = 0.7;
                }
            };
            exports_32("b2MouseJointDef", b2MouseJointDef);
            b2MouseJoint = class b2MouseJoint extends b2Joint_8.b2Joint {
                constructor(def) {
                    ...
                    this.m_lalcB = null;
                    this.m_K = null;
                    this.m_localAnchorB = new b2Math_127.b2Vec2();
                    this.m_targetA = new b2Math_127.b2Vec2();
                    this.m_impulse = new b2Math_127.b2Vec2();
                    this.m_rB = new b2Math_127.b2Vec2();
                    this.m_localCenterB = new b2Math_127.b2Vec2();
                    this.m_mass = new b2Math_131.b2Mat22();
                    this.m_C = new b2Math_127.b2Vec2();
                    this.m_qB = new b2Math_133.b2Rot();
                    this.m_lalcB = new b2Math_127.b2Vec2();
                    this.m_K = new b2Math_131.b2Mat22();
                    if (b2Settings_58.ENABLE_ASSERTS) {
                        b2Settings_58.b2Assert(def.target.IsValid());
                    }
                    if (b2Settings_58.ENABLE_ASSERTS) {
                        b2Settings_58.b2Assert(b2Math_126.b2IsValid(def.maxForce) && def.maxForce >= 0);
                    }
                    if (b2Settings_58.ENABLE_ASSERTS) {
                        b2Settings_58.b2Assert(b2Math_126.b2IsValid(def.frequencyHz) && def.frequencyHz >= 0);
                    }
                    if (b2Settings_58.ENABLE_ASSERTS) {
                        b2Settings_58.b2Assert(b2Math_126.b2IsValid(def.dampingRatio) && def.dampingRatio >= 0);
                    }
                    this.m_targetA.Copy(def.target);
                    b2Math_135.b2MulTXV(this.m_bodyB.GetTransform(), this.m_targetA, this.m_localAnchorB);
                    this.m_maxForce = def.maxForce;
                    this.m_impulse.SetZero();
                    this.m_frequencyHz = def.frequencyHz;
                    this.m_dampingRatio = def.dampingRatio;
                ...
                InitVelocityConstraints(data) {
                    ...
                    // Frequency
                    const omega = 2 * b2Settings_60.b2_pi * this.m_frequencyHz;
                    // Damping coefficient
                    ...
                    const h = data.step.dt;
                    if (b2Settings_58.ENABLE_ASSERTS) {
                        b2Settings_58.b2Assert(d + h * k > b2Settings_59.b2_epsilon);
                    }
                    this.m_gamma = h * (d + h * k);
                    if (this.m_gamma !== 0) {
                    ...
                    // Compute the effective mass matrix.
                    b2Math_128.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_134.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    ...
                    if (data.step.warmStarting) {
                        ...
                        wB += this.m_invIB * b2Math_129.b2CrossVV(this.m_rB, this.m_impulse);
                    }
                    else {
                        this.m_impulse.SetZero();
                    }
                ...
                SolveVelocityConstraints(data) {
                    ...
                    const Cdot = b2Math_130.b2AddVCrossSV(vB, wB, this.m_rB, b2MouseJoint.SolveVelocityConstraints_s_Cdot);
                    //  b2Vec2 impulse = b2Mul(m_mass, -(Cdot + m_C + m_gamma * m_impulse));
                    const impulse = b2Math_132.b2MulMV(this.m_mass, b2Math_128.b2AddVV(Cdot, b2Math_128.b2AddVV(this.m_C, b2Math_128.b2MulSV(this.m_gamma, this.m_impulse, b2Math_127.b2Vec2.s_t0), b2Math_127.b2Vec2.s_t0), b2Math_127.b2Vec2.s_t0).SelfNeg(), b2MouseJoint.SolveVelocityConstraints_s_impulse);
                    ...
                    b2Math_128.b2SubVV(this.m_impulse, oldImpulse, impulse);
                    // vB += m_invMassB * impulse;
                    vB.SelfMulAdd(this.m_invMassB, impulse);
                    wB += this.m_invIB * b2Math_129.b2CrossVV(this.m_rB, impulse);
                    // data.velocities[this.m_indexB].v = vB;
                    data.velocities[this.m_indexB].w = wB;
                }
                SolvePositionConstraints(data) {
                ...
                GetReactionForce(inv_dt, out) {
                    return b2Math_128.b2MulSV(inv_dt, this.m_impulse, out);
                }
                GetReactionTorque(inv_dt) {
                    return 0;
                }
                Dump() {
                    if (b2Settings_58.DEBUG) {
                        b2Settings_58.b2Log("Mouse joint dumping is not supported.\n");
                    }
                }
                ShiftOrigin(newOrigin) {
            ...
            b2MouseJoint.SolveVelocityConstraints_s_Cdot = new b2Math_127.b2Vec2();
            b2MouseJoint.SolveVelocityConstraints_s_impulse = new b2Math_127.b2Vec2();
            b2MouseJoint.SolveVelocityConstraints_s_oldImpulse = new b2Math_127.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2PulleyJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_33, context_33) {
    "use strict";
    var __moduleName = context_33 && context_33.id;
    var b2Settings_61, b2Settings_62, b2Settings_63, b2Math_136, b2Math_137, b2Math_138, b2Math_139, b2Math_140, b2Math_141, b2Math_142, b2Math_143, b2Joint_9;
    var b2_minPulleyLength, b2PulleyJointDef, b2PulleyJoint;
    return {
        setters:[
            function (b2Settings_61_1) {
                b2Settings_61 = b2Settings_61_1;
                b2Settings_62 = b2Settings_61_1;
                b2Settings_63 = b2Settings_61_1;
            },
            function (b2Math_136_1) {
                b2Math_136 = b2Math_136_1;
                b2Math_137 = b2Math_136_1;
                b2Math_138 = b2Math_136_1;
                b2Math_139 = b2Math_136_1;
                b2Math_140 = b2Math_136_1;
                b2Math_141 = b2Math_136_1;
                b2Math_142 = b2Math_136_1;
                b2Math_143 = b2Math_136_1;
            },
            function (b2Joint_9_1) {
                b2Joint_9 = b2Joint_9_1;
            }],
        execute: function() {
            exports_33("b2_minPulleyLength", b2_minPulleyLength = 2);
            ...
            b2PulleyJointDef = class b2PulleyJointDef extends b2Joint_9.b2JointDef {
                constructor() {
                    ...
                    this.groundAnchorA = new b2Math_137.b2Vec2(-1, 1);
                    this.groundAnchorB = new b2Math_137.b2Vec2(1, 1);
                    this.localAnchorA = new b2Math_137.b2Vec2(-1, 0);
                    this.localAnchorB = new b2Math_137.b2Vec2(1, 0);
                    this.lengthA = 0;
                    this.lengthB = 0;
                    this.ratio = 1;
                ...
                Initialize(bA, bB, groundA, groundB, anchorA, anchorB, r) {
                    ...
                    this.lengthA = b2Math_138.b2DistanceVV(anchorA, groundA);
                    this.lengthB = b2Math_138.b2DistanceVV(anchorB, groundB);
                    this.ratio = r;
                    if (b2Settings_61.ENABLE_ASSERTS) {
                        b2Settings_61.b2Assert(this.ratio > b2Settings_62.b2_epsilon);
                    }
                }
            };
            ...
            b2PulleyJoint = class b2PulleyJoint extends b2Joint_9.b2Joint {
                constructor(def) {
                    super(def); // base class constructor
                    this.m_groundAnchorA = new b2Math_137.b2Vec2();
                    this.m_groundAnchorB = new b2Math_137.b2Vec2();
                    this.m_lengthA = 0;
                    this.m_lengthB = 0;
                    // Solver shared
                    this.m_localAnchorA = new b2Math_137.b2Vec2();
                    this.m_localAnchorB = new b2Math_137.b2Vec2();
                    this.m_constant = 0;
                    this.m_ratio = 0;
                    this.m_impulse = 0;
                    // Solver temp
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_uA = new b2Math_137.b2Vec2();
                    this.m_uB = new b2Math_137.b2Vec2();
                    this.m_rA = new b2Math_137.b2Vec2();
                    this.m_rB = new b2Math_137.b2Vec2();
                    this.m_localCenterA = new b2Math_137.b2Vec2();
                    this.m_localCenterB = new b2Math_137.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_mass = 0;
                    this.m_qA = new b2Math_142.b2Rot();
                    this.m_qB = new b2Math_142.b2Rot();
                    this.m_lalcA = new b2Math_137.b2Vec2();
                    this.m_lalcB = new b2Math_137.b2Vec2();
                    ...
                    if (b2Settings_61.ENABLE_ASSERTS) {
                        b2Settings_61.b2Assert(def.ratio !== 0);
                    }
                    this.m_ratio = def.ratio;
                ...
                InitVelocityConstraints(data) {
                    ...
                    const qA = this.m_qA.SetAngleRadians(aA), qB = this.m_qB.SetAngleRadians(aB);
                    // m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_139.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    b2Math_143.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_139.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_143.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // Get the pulley axes.
                    ...
                    if (lengthA > 10 * b2Settings_63.b2_linearSlop) {
                        this.m_uA.SelfMul(1 / lengthA);
                    }
                    else {
                        this.m_uA.SetZero();
                    }
                    if (lengthB > 10 * b2Settings_63.b2_linearSlop) {
                    ...
                    // Compute effective mass.
                    const ruA = b2Math_140.b2CrossVV(this.m_rA, this.m_uA);
                    const ruB = b2Math_140.b2CrossVV(this.m_rB, this.m_uB);
                    ...
                    if (data.step.warmStarting) {
                        ...
                        const PA = b2Math_139.b2MulSV(-(this.m_impulse), this.m_uA, b2PulleyJoint.InitVelocityConstraints_s_PA);
                        // b2Vec2 PB = (-m_ratio * m_impulse) * m_uB;
                        const PB = b2Math_139.b2MulSV((-this.m_ratio * this.m_impulse), this.m_uB, b2PulleyJoint.InitVelocityConstraints_s_PB);
                        // vA += m_invMassA * PA;
                        vA.SelfMulAdd(this.m_invMassA, PA);
                        wA += this.m_invIA * b2Math_140.b2CrossVV(this.m_rA, PA);
                        // vB += m_invMassB * PB;
                        vB.SelfMulAdd(this.m_invMassB, PB);
                        wB += this.m_invIB * b2Math_140.b2CrossVV(this.m_rB, PB);
                    }
                    else {
                        this.m_impulse = 0;
                    }
                ...
                SolveVelocityConstraints(data) {
                    ...
                    let wB = data.velocities[this.m_indexB].w;
                    // b2Vec2 vpA = vA + b2Cross(wA, m_rA);
                    const vpA = b2Math_141.b2AddVCrossSV(vA, wA, this.m_rA, b2PulleyJoint.SolveVelocityConstraints_s_vpA);
                    // b2Vec2 vpB = vB + b2Cross(wB, m_rB);
                    const vpB = b2Math_141.b2AddVCrossSV(vB, wB, this.m_rB, b2PulleyJoint.SolveVelocityConstraints_s_vpB);
                    const Cdot = -b2Math_140.b2DotVV(this.m_uA, vpA) - this.m_ratio * b2Math_140.b2DotVV(this.m_uB, vpB);
                    const impulse = -this.m_mass * Cdot;
                    this.m_impulse += impulse;
                    // b2Vec2 PA = -impulse * m_uA;
                    const PA = b2Math_139.b2MulSV(-impulse, this.m_uA, b2PulleyJoint.SolveVelocityConstraints_s_PA);
                    // b2Vec2 PB = -m_ratio * impulse * m_uB;
                    const PB = b2Math_139.b2MulSV(-this.m_ratio * impulse, this.m_uB, b2PulleyJoint.SolveVelocityConstraints_s_PB);
                    // vA += m_invMassA * PA;
                    vA.SelfMulAdd(this.m_invMassA, PA);
                    wA += this.m_invIA * b2Math_140.b2CrossVV(this.m_rA, PA);
                    // vB += m_invMassB * PB;
                ...
                SolvePositionConstraints(data) {
                    ...
                    // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_139.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_143.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_139.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_143.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // Get the pulley axes.
                    ...
                    // Compute effective mass.
                    const ruA = b2Math_140.b2CrossVV(rA, uA);
                    const ruB = b2Math_140.b2CrossVV(rB, uB);
                    const mA = this.m_invMassA + this.m_invIA * ruA * ruA;
                    const mB = this.m_invMassB + this.m_invIB * ruB * ruB;
                    ...
                    const linearError = b2Math_136.b2Abs(C);
                    const impulse = -mass * C;
                    // b2Vec2 PA = -impulse * uA;
                    const PA = b2Math_139.b2MulSV(-impulse, uA, b2PulleyJoint.SolvePositionConstraints_s_PA);
                    // b2Vec2 PB = -m_ratio * impulse * uB;
                    const PB = b2Math_139.b2MulSV(-this.m_ratio * impulse, uB, b2PulleyJoint.SolvePositionConstraints_s_PB);
                    // cA += m_invMassA * PA;
                    cA.SelfMulAdd(this.m_invMassA, PA);
                    aA += this.m_invIA * b2Math_140.b2CrossVV(rA, PA);
                    // cB += m_invMassB * PB;
                    cB.SelfMulAdd(this.m_invMassB, PB);
                    aB += this.m_invIB * b2Math_140.b2CrossVV(rB, PB);
                    // data.positions[this.m_indexA].c = cA;
                    data.positions[this.m_indexA].a = aA;
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return linearError < b2Settings_63.b2_linearSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                GetCurrentLengthA() {
                    ...
                    return b2Math_138.b2DistanceVV(p, s);
                }
                GetCurrentLengthB() {
                ...
                Dump() {
                    if (b2Settings_61.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_61.b2Log("  const jd: b2PulleyJointDef = new b2PulleyJointDef();\n");
                        b2Settings_61.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_61.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_61.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_61.b2Log("  jd.groundAnchorA.SetXY(%.15f, %.15f);\n", this.m_groundAnchorA.x, this.m_groundAnchorA.y);
                        b2Settings_61.b2Log("  jd.groundAnchorB.SetXY(%.15f, %.15f);\n", this.m_groundAnchorB.x, this.m_groundAnchorB.y);
                        b2Settings_61.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_61.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_61.b2Log("  jd.lengthA = %.15f;\n", this.m_lengthA);
                        b2Settings_61.b2Log("  jd.lengthB = %.15f;\n", this.m_lengthB);
                        b2Settings_61.b2Log("  jd.ratio = %.15f;\n", this.m_ratio);
                        b2Settings_61.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
                ShiftOrigin(newOrigin) {
            ...
            b2PulleyJoint.InitVelocityConstraints_s_PA = new b2Math_137.b2Vec2();
            b2PulleyJoint.InitVelocityConstraints_s_PB = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolveVelocityConstraints_s_vpA = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolveVelocityConstraints_s_vpB = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolveVelocityConstraints_s_PA = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolveVelocityConstraints_s_PB = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolvePositionConstraints_s_PA = new b2Math_137.b2Vec2();
            b2PulleyJoint.SolvePositionConstraints_s_PB = new b2Math_137.b2Vec2();
            b2PulleyJoint.GetCurrentLengthA_s_p = new b2Math_137.b2Vec2();
            b2PulleyJoint.GetCurrentLengthB_s_p = new b2Math_137.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2RopeJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_34, context_34) {
    "use strict";
    var __moduleName = context_34 && context_34.id;
    var b2Settings_64, b2Settings_65, b2Settings_66, b2Math_144, b2Math_145, b2Math_146, b2Math_147, b2Math_148, b2Math_149, b2Math_150, b2Joint_10;
    var b2RopeJointDef, b2RopeJoint;
    return {
        setters:[
            function (b2Settings_64_1) {
                b2Settings_64 = b2Settings_64_1;
                b2Settings_65 = b2Settings_64_1;
                b2Settings_66 = b2Settings_64_1;
            },
            function (b2Math_144_1) {
                b2Math_144 = b2Math_144_1;
                b2Math_145 = b2Math_144_1;
                b2Math_146 = b2Math_144_1;
                b2Math_147 = b2Math_144_1;
                b2Math_148 = b2Math_144_1;
                b2Math_149 = b2Math_144_1;
                b2Math_150 = b2Math_144_1;
            },
        ...
        execute: function() {
            ...
            b2RopeJointDef = class b2RopeJointDef extends b2Joint_10.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_145.b2Vec2(-1, 0);
                    this.localAnchorB = new b2Math_145.b2Vec2(1, 0);
                    this.maxLength = 0;
                }
            };
            exports_34("b2RopeJointDef", b2RopeJointDef);
            b2RopeJoint = class b2RopeJoint extends b2Joint_10.b2Joint {
                constructor(def) {
                    super(def); // base class constructor
                    // Solver shared
                    this.m_localAnchorA = new b2Math_145.b2Vec2();
                    this.m_localAnchorB = new b2Math_145.b2Vec2();
                    this.m_maxLength = 0;
                    this.m_length = 0;
                    this.m_impulse = 0;
                    // Solver temp
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_u = new b2Math_145.b2Vec2();
                    this.m_rA = new b2Math_145.b2Vec2();
                    this.m_rB = new b2Math_145.b2Vec2();
                    this.m_localCenterA = new b2Math_145.b2Vec2();
                    this.m_localCenterB = new b2Math_145.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    ...
                    this.m_qA = new b2Math_149.b2Rot();
                    this.m_qB = new b2Math_149.b2Rot();
                    this.m_lalcA = new b2Math_145.b2Vec2();
                    this.m_lalcB = new b2Math_145.b2Vec2();
                    this.m_localAnchorA = def.localAnchorA.Clone();
                    this.m_localAnchorB = def.localAnchorB.Clone();
                ...
                InitVelocityConstraints(data) {
                    ...
                    b2Math_146.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    b2Math_150.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // this.m_rB = b2Mul(qB, this.m_localAnchorB - this.m_localCenterB);
                    b2Math_146.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_150.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    ...
                    if (this.m_length > b2Settings_65.b2_linearSlop) {
                    ...
                    // Compute effective mass.
                    const crA = b2Math_147.b2CrossVV(this.m_rA, this.m_u);
                    const crB = b2Math_147.b2CrossVV(this.m_rB, this.m_u);
                    ...
                    if (data.step.warmStarting) {
                        ...
                        this.m_impulse *= data.step.dtRatio;
                        // b2Vec2 P = m_impulse * m_u;
                        const P = b2Math_146.b2MulSV(this.m_impulse, this.m_u, b2RopeJoint.InitVelocityConstraints_s_P);
                        // vA -= m_invMassA * P;
                        vA.SelfMulSub(this.m_invMassA, P);
                        wA -= this.m_invIA * b2Math_147.b2CrossVV(this.m_rA, P);
                        // vB += m_invMassB * P;
                        vB.SelfMulAdd(this.m_invMassB, P);
                        wB += this.m_invIB * b2Math_147.b2CrossVV(this.m_rB, P);
                    }
                    else {
                        this.m_impulse = 0;
                    }
                ...
                SolveVelocityConstraints(data) {
                    ...
                    // b2Vec2 vpA = vA + b2Cross(wA, m_rA);
                    const vpA = b2Math_148.b2AddVCrossSV(vA, wA, this.m_rA, b2RopeJoint.SolveVelocityConstraints_s_vpA);
                    // b2Vec2 vpB = vB + b2Cross(wB, m_rB);
                    const vpB = b2Math_148.b2AddVCrossSV(vB, wB, this.m_rB, b2RopeJoint.SolveVelocityConstraints_s_vpB);
                    // float32 C = m_length - m_maxLength;
                    const C = this.m_length - this.m_maxLength;
                    // float32 Cdot = b2Dot(m_u, vpB - vpA);
                    let Cdot = b2Math_147.b2DotVV(this.m_u, b2Math_146.b2SubVV(vpB, vpA, b2Math_145.b2Vec2.s_t0));
                    ...
                    this.m_impulse = b2Math_144.b2Min(0, this.m_impulse + impulse);
                    impulse = this.m_impulse - oldImpulse;
                    // b2Vec2 P = impulse * m_u;
                    const P = b2Math_146.b2MulSV(impulse, this.m_u, b2RopeJoint.SolveVelocityConstraints_s_P);
                    // vA -= m_invMassA * P;
                    vA.SelfMulSub(this.m_invMassA, P);
                    wA -= this.m_invIA * b2Math_147.b2CrossVV(this.m_rA, P);
                    // vB += m_invMassB * P;
                ...
                SolvePositionConstraints(data) {
                    ...
                    b2Math_146.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_150.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(qB, this.m_localAnchorB - this.m_localCenterB);
                    b2Math_146.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_150.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // b2Vec2 u = cB + rB - cA - rA;
                    const u = this.m_u.Copy(cB).SelfAdd(rB).SelfSub(cA).SelfSub(rA);
                    const length = u.Normalize();
                    let C = length - this.m_maxLength;
                    C = b2Math_144.b2Clamp(C, 0, b2Settings_66.b2_maxLinearCorrection);
                    const impulse = -this.m_mass * C;
                    // b2Vec2 P = impulse * u;
                    const P = b2Math_146.b2MulSV(impulse, u, b2RopeJoint.SolvePositionConstraints_s_P);
                    // cA -= m_invMassA * P;
                    cA.SelfMulSub(this.m_invMassA, P);
                    aA -= this.m_invIA * b2Math_147.b2CrossVV(rA, P);
                    // cB += m_invMassB * P;
                    cB.SelfMulAdd(this.m_invMassB, P);
                    aB += this.m_invIB * b2Math_147.b2CrossVV(rB, P);
                    // data.positions[this.m_indexA].c = cA;
                    data.positions[this.m_indexA].a = aA;
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return length - this.m_maxLength < b2Settings_65.b2_linearSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                GetReactionForce(inv_dt, out) {
                    const F = b2Math_146.b2MulSV((inv_dt * this.m_impulse), this.m_u, out);
                    return F;
                    // return out.SetXY(inv_dt * this.m_linearImpulse.x, inv_dt * this.m_linearImpulse.y);
                }
                GetReactionTorque(inv_dt) {
                ...
                Dump() {
                    if (b2Settings_64.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_64.b2Log("  const jd: b2RopeJointDef = new b2RopeJointDef();\n");
                        b2Settings_64.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_64.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_64.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_64.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_64.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_64.b2Log("  jd.maxLength = %.15f;\n", this.m_maxLength);
                        b2Settings_64.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2RopeJoint.InitVelocityConstraints_s_P = new b2Math_145.b2Vec2();
            b2RopeJoint.SolveVelocityConstraints_s_vpA = new b2Math_145.b2Vec2();
            b2RopeJoint.SolveVelocityConstraints_s_vpB = new b2Math_145.b2Vec2();
            b2RopeJoint.SolveVelocityConstraints_s_P = new b2Math_145.b2Vec2();
            b2RopeJoint.SolvePositionConstraints_s_P = new b2Math_145.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2WeldJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_35, context_35) {
    "use strict";
    var __moduleName = context_35 && context_35.id;
    var b2Settings_67, b2Settings_68, b2Settings_69, b2Settings_70, b2Math_151, b2Math_152, b2Math_153, b2Math_154, b2Math_155, b2Math_156, b2Math_157, b2Math_158, b2Math_159, b2Math_160, b2Math_161, b2Joint_11;
    var b2WeldJointDef, b2WeldJoint;
    return {
        setters:[
            function (b2Settings_67_1) {
                b2Settings_67 = b2Settings_67_1;
                b2Settings_68 = b2Settings_67_1;
                b2Settings_69 = b2Settings_67_1;
                b2Settings_70 = b2Settings_67_1;
            },
            function (b2Math_151_1) {
                b2Math_151 = b2Math_151_1;
                b2Math_152 = b2Math_151_1;
                b2Math_153 = b2Math_151_1;
                b2Math_154 = b2Math_151_1;
                b2Math_155 = b2Math_151_1;
                b2Math_156 = b2Math_151_1;
                b2Math_157 = b2Math_151_1;
                b2Math_158 = b2Math_151_1;
                b2Math_159 = b2Math_151_1;
                b2Math_160 = b2Math_151_1;
                b2Math_161 = b2Math_151_1;
            },
        ...
        execute: function() {
            ...
            b2WeldJointDef = class b2WeldJointDef extends b2Joint_11.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_152.b2Vec2();
                    this.localAnchorB = new b2Math_152.b2Vec2();
                    this.referenceAngle = 0;
                    this.frequencyHz = 0;
                    this.dampingRatio = 0;
                }
            ...
            exports_35("b2WeldJointDef", b2WeldJointDef);
            b2WeldJoint = class b2WeldJoint extends b2Joint_11.b2Joint {
                constructor(def) {
                    ...
                    this.m_bias = 0;
                    // Solver shared
                    this.m_localAnchorA = new b2Math_152.b2Vec2();
                    this.m_localAnchorB = new b2Math_152.b2Vec2();
                    this.m_referenceAngle = 0;
                    this.m_gamma = 0;
                    this.m_impulse = new b2Math_156.b2Vec3(0, 0, 0);
                    // Solver temp
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_rA = new b2Math_152.b2Vec2();
                    this.m_rB = new b2Math_152.b2Vec2();
                    this.m_localCenterA = new b2Math_152.b2Vec2();
                    this.m_localCenterB = new b2Math_152.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_mass = new b2Math_157.b2Mat33();
                    this.m_qA = new b2Math_160.b2Rot();
                    this.m_qB = new b2Math_160.b2Rot();
                    this.m_lalcA = new b2Math_152.b2Vec2();
                    this.m_lalcB = new b2Math_152.b2Vec2();
                    this.m_K = new b2Math_157.b2Mat33();
                    this.m_frequencyHz = def.frequencyHz;
                    this.m_dampingRatio = def.dampingRatio;
                    this.m_localAnchorA.Copy(def.localAnchorA);
                    this.m_localAnchorB.Copy(def.localAnchorB);
                ...
                InitVelocityConstraints(data) {
                    ...
                    const qA = this.m_qA.SetAngleRadians(aA), qB = this.m_qB.SetAngleRadians(aB);
                    // m_rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_153.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    b2Math_161.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // m_rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_153.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    b2Math_161.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // J = [-I -r1_skew I r2_skew]
                    //     [ 0       -1 0       1]
                    // r_skew = [-ry; rx]
                    // Matlab
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        // Frequency
                        const omega = 2 * b2Settings_70.b2_pi * this.m_frequencyHz;
                        // Damping coefficient
                    ...
                    if (data.step.warmStarting) {
                        ...
                        // vA -= mA * P;
                        vA.SelfMulSub(mA, P);
                        wA -= iA * (b2Math_154.b2CrossVV(this.m_rA, P) + this.m_impulse.z);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        wB += iB * (b2Math_154.b2CrossVV(this.m_rB, P) + this.m_impulse.z);
                    }
                    else {
                        this.m_impulse.SetZero();
                    }
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        const Cdot1 = b2Math_153.b2SubVV(b2Math_155.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_152.b2Vec2.s_t0), b2Math_155.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_152.b2Vec2.s_t1), b2WeldJoint.SolveVelocityConstraints_s_Cdot1);
                        // b2Vec2 impulse1 = -b2Mul22(m_mass, Cdot1);
                        const impulse1 = b2Math_158.b2MulM33XY(this.m_mass, Cdot1.x, Cdot1.y, b2WeldJoint.SolveVelocityConstraints_s_impulse1).SelfNeg();
                        ...
                        wA -= iA * b2Math_154.b2CrossVV(this.m_rA, P);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        // wB += iB * b2Cross(m_rB, P);
                        wB += iB * b2Math_154.b2CrossVV(this.m_rB, P);
                    }
                    else {
                        ...
                        const impulse = b2Math_159.b2MulM33XYZ(this.m_mass, Cdot1.x, Cdot1.y, Cdot2, b2WeldJoint.SolveVelocityConstraints_s_impulse).SelfNeg();
                        this.m_impulse.SelfAdd(impulse);
                        // b2Vec2 P(impulse.x, impulse.y);
                        const P = b2WeldJoint.SolveVelocityConstraints_s_P.SetXY(impulse.x, impulse.y);
                        // vA -= mA * P;
                        vA.SelfMulSub(mA, P);
                        wA -= iA * (b2Math_154.b2CrossVV(this.m_rA, P) + impulse.z);
                        // vB += mB * P;
                        vB.SelfMulAdd(mB, P);
                        wB += iB * (b2Math_154.b2CrossVV(this.m_rB, P) + impulse.z);
                    }
                    // data.velocities[this.m_indexA].v = vA;
                    data.velocities[this.m_indexA].w = wA;
                    // data.velocities[this.m_indexB].v = vB;
                ...
                SolvePositionConstraints(data) {
                    ...
                    // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_153.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_161.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_153.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_161.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        const C1 = b2Math_153.b2SubVV(b2Math_153.b2AddVV(cB, rB, b2Math_152.b2Vec2.s_t0), b2Math_153.b2AddVV(cA, rA, b2Math_152.b2Vec2.s_t1), b2WeldJoint.SolvePositionConstraints_s_C1);
                        ...
                        // cA -= mA * P;
                        cA.SelfMulSub(mA, P);
                        aA -= iA * b2Math_154.b2CrossVV(rA, P);
                        // cB += mB * P;
                        cB.SelfMulAdd(mB, P);
                        aB += iB * b2Math_154.b2CrossVV(rB, P);
                    }
                    else {
                        // b2Vec2 C1 =  cB + rB - cA - rA;
                        const C1 = b2Math_153.b2SubVV(b2Math_153.b2AddVV(cB, rB, b2Math_152.b2Vec2.s_t0), b2Math_153.b2AddVV(cA, rA, b2Math_152.b2Vec2.s_t1), b2WeldJoint.SolvePositionConstraints_s_C1);
                        ...
                        positionError = C1.GetLength();
                        angularError = b2Math_151.b2Abs(C2);
                        ...
                        // cA -= mA * P;
                        cA.SelfMulSub(mA, P);
                        aA -= iA * (b2Math_154.b2CrossVV(this.m_rA, P) + impulse.z);
                        // cB += mB * P;
                        cB.SelfMulAdd(mB, P);
                        aB += iB * (b2Math_154.b2CrossVV(this.m_rB, P) + impulse.z);
                    }
                    // data.positions[this.m_indexA].c = cA;
                    data.positions[this.m_indexA].a = aA;
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return positionError <= b2Settings_69.b2_linearSlop && angularError <= b2Settings_68.b2_angularSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
                ...
                Dump() {
                    if (b2Settings_67.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_67.b2Log("  const jd: b2WeldJointDef = new b2WeldJointDef();\n");
                        b2Settings_67.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_67.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_67.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_67.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_67.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_67.b2Log("  jd.referenceAngle = %.15f;\n", this.m_referenceAngle);
                        b2Settings_67.b2Log("  jd.frequencyHz = %.15f;\n", this.m_frequencyHz);
                        b2Settings_67.b2Log("  jd.dampingRatio = %.15f;\n", this.m_dampingRatio);
                        b2Settings_67.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2WeldJoint.InitVelocityConstraints_s_P = new b2Math_152.b2Vec2();
            b2WeldJoint.SolveVelocityConstraints_s_Cdot1 = new b2Math_152.b2Vec2();
            b2WeldJoint.SolveVelocityConstraints_s_impulse1 = new b2Math_152.b2Vec2();
            b2WeldJoint.SolveVelocityConstraints_s_impulse = new b2Math_156.b2Vec3();
            b2WeldJoint.SolveVelocityConstraints_s_P = new b2Math_152.b2Vec2();
            b2WeldJoint.SolvePositionConstraints_s_C1 = new b2Math_152.b2Vec2();
            b2WeldJoint.SolvePositionConstraints_s_P = new b2Math_152.b2Vec2();
            b2WeldJoint.SolvePositionConstraints_s_impulse = new b2Math_156.b2Vec3();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2WheelJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_36, context_36) {
    "use strict";
    var __moduleName = context_36 && context_36.id;
    var b2Settings_71, b2Settings_72, b2Settings_73, b2Math_162, b2Math_163, b2Math_164, b2Math_165, b2Math_166, b2Math_167, b2Math_168, b2Joint_12;
    var b2WheelJointDef, b2WheelJoint;
    return {
        setters:[
            function (b2Settings_71_1) {
                b2Settings_71 = b2Settings_71_1;
                b2Settings_72 = b2Settings_71_1;
                b2Settings_73 = b2Settings_71_1;
            },
            function (b2Math_162_1) {
                b2Math_162 = b2Math_162_1;
                b2Math_163 = b2Math_162_1;
                b2Math_164 = b2Math_162_1;
                b2Math_165 = b2Math_162_1;
                b2Math_166 = b2Math_162_1;
                b2Math_167 = b2Math_162_1;
                b2Math_168 = b2Math_162_1;
            },
        ...
        execute: function() {
            ...
            b2WheelJointDef = class b2WheelJointDef extends b2Joint_12.b2JointDef {
                constructor() {
                    ...
                    this.localAnchorA = new b2Math_163.b2Vec2(0, 0);
                    this.localAnchorB = new b2Math_163.b2Vec2(0, 0);
                    this.localAxisA = new b2Math_163.b2Vec2(1, 0);
                    this.enableMotor = false;
                    this.maxMotorTorque = 0;
                    this.motorSpeed = 0;
                    this.frequencyHz = 2;
            ...
            exports_36("b2WheelJointDef", b2WheelJointDef);
            b2WheelJoint = class b2WheelJoint extends b2Joint_12.b2Joint {
                constructor(def) {
                    ...
                    this.m_dampingRatio = 0;
                    // Solver shared
                    this.m_localAnchorA = new b2Math_163.b2Vec2();
                    this.m_localAnchorB = new b2Math_163.b2Vec2();
                    this.m_localXAxisA = new b2Math_163.b2Vec2();
                    this.m_localYAxisA = new b2Math_163.b2Vec2();
                    this.m_impulse = 0;
                    this.m_motorImpulse = 0;
                    ...
                    this.m_indexA = 0;
                    this.m_indexB = 0;
                    this.m_localCenterA = new b2Math_163.b2Vec2();
                    this.m_localCenterB = new b2Math_163.b2Vec2();
                    this.m_invMassA = 0;
                    this.m_invMassB = 0;
                    this.m_invIA = 0;
                    this.m_invIB = 0;
                    this.m_ax = new b2Math_163.b2Vec2();
                    this.m_ay = new b2Math_163.b2Vec2();
                    this.m_sAx = 0;
                    this.m_sBx = 0;
                    this.m_sAy = 0;
                    this.m_sBy = 0;
                    ...
                    this.m_bias = 0;
                    this.m_gamma = 0;
                    this.m_qA = new b2Math_167.b2Rot();
                    this.m_qB = new b2Math_167.b2Rot();
                    this.m_lalcA = new b2Math_163.b2Vec2();
                    this.m_lalcB = new b2Math_163.b2Vec2();
                    this.m_rA = new b2Math_163.b2Vec2();
                    this.m_rB = new b2Math_163.b2Vec2();
                    this.m_frequencyHz = def.frequencyHz;
                    this.m_dampingRatio = def.dampingRatio;
                    this.m_localAnchorA.Copy(def.localAnchorA);
                    this.m_localAnchorB.Copy(def.localAnchorB);
                    this.m_localXAxisA.Copy(def.localAxisA);
                    b2Math_166.b2CrossOneV(this.m_localXAxisA, this.m_localYAxisA);
                    this.m_maxMotorTorque = def.maxMotorTorque;
                    this.m_motorSpeed = def.motorSpeed;
                    this.m_enableMotor = def.enableMotor;
                    this.m_ax.SetZero();
                ...
                InitVelocityConstraints(data) {
                    ...
                    // Compute the effective masses.
                    // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
                    b2Math_164.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
                    const rA = b2Math_168.b2MulRV(qA, this.m_lalcA, this.m_rA);
                    // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
                    b2Math_164.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
                    const rB = b2Math_168.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // b2Vec2 d = cB + rB - cA - rA;
                    const d = b2Math_164.b2SubVV(b2Math_164.b2AddVV(cB, rB, b2Math_163.b2Vec2.s_t0), b2Math_164.b2AddVV(cA, rA, b2Math_163.b2Vec2.s_t1), b2WheelJoint.InitVelocityConstraints_s_d);
                    // Point to line constraint
                    {
                        // m_ay = b2Mul(qA, m_localYAxisA);
                        b2Math_168.b2MulRV(qA, this.m_localYAxisA, this.m_ay);
                        // m_sAy = b2Cross(d + rA, m_ay);
                        this.m_sAy = b2Math_165.b2CrossVV(b2Math_164.b2AddVV(d, rA, b2Math_163.b2Vec2.s_t0), this.m_ay);
                        // m_sBy = b2Cross(rB, m_ay);
                        this.m_sBy = b2Math_165.b2CrossVV(rB, this.m_ay);
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        b2Math_168.b2MulRV(qA, this.m_localXAxisA, this.m_ax);
                        // m_sAx = b2Cross(d + rA, m_ax);
                        this.m_sAx = b2Math_165.b2CrossVV(b2Math_164.b2AddVV(d, rA, b2Math_163.b2Vec2.s_t0), this.m_ax);
                        // m_sBx = b2Cross(rB, m_ax);
                        this.m_sBx = b2Math_165.b2CrossVV(rB, this.m_ax);
                        const invMass = mA + mB + iA * this.m_sAx * this.m_sAx + iB * this.m_sBx * this.m_sBx;
                        if (invMass > 0) {
                            this.m_springMass = 1 / invMass;
                            const C = b2Math_165.b2DotVV(d, this.m_ax);
                            // Frequency
                            const omega = 2 * b2Settings_73.b2_pi * this.m_frequencyHz;
                            // Damping coefficient
                    ...
                    if (data.step.warmStarting) {
                        ...
                        const P = b2Math_164.b2AddVV(b2Math_164.b2MulSV(this.m_impulse, this.m_ay, b2Math_163.b2Vec2.s_t0), b2Math_164.b2MulSV(this.m_springImpulse, this.m_ax, b2Math_163.b2Vec2.s_t1), b2WheelJoint.InitVelocityConstraints_s_P);
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (true) {
                        const Cdot = b2Math_165.b2DotVV(this.m_ax, b2Math_164.b2SubVV(vB, vA, b2Math_163.b2Vec2.s_t0)) + this.m_sBx * wB - this.m_sAx * wA;
                        const impulse = -this.m_springMass * (Cdot + this.m_bias + this.m_gamma * this.m_springImpulse);
                        this.m_springImpulse += impulse;
                        // b2Vec2 P = impulse * m_ax;
                        const P = b2Math_164.b2MulSV(impulse, this.m_ax, b2WheelJoint.SolveVelocityConstraints_s_P);
                    ...
                    if (true) {
                        ...
                        const oldImpulse = this.m_motorImpulse;
                        const maxImpulse = data.step.dt * this.m_maxMotorTorque;
                        this.m_motorImpulse = b2Math_162.b2Clamp(this.m_motorImpulse + impulse, -maxImpulse, maxImpulse);
                        impulse = this.m_motorImpulse - oldImpulse;
                        wA -= iA * impulse;
                        wB += iB * impulse;
                    }
                    ...
                    if (true) {
                        const Cdot = b2Math_165.b2DotVV(this.m_ay, b2Math_164.b2SubVV(vB, vA, b2Math_163.b2Vec2.s_t0)) + this.m_sBy * wB - this.m_sAy * wA;
                        const impulse = -this.m_mass * Cdot;
                        this.m_impulse += impulse;
                        // b2Vec2 P = impulse * m_ay;
                        const P = b2Math_164.b2MulSV(impulse, this.m_ay, b2WheelJoint.SolveVelocityConstraints_s_P);
                ...
                SolvePositionConstraints(data) {
                    ...
                    const rB = b2Math_168.b2MulRV(qB, this.m_lalcB, this.m_rB);
                    // b2Vec2 d = (cB - cA) + rB - rA;
                    const d = b2Math_164.b2AddVV(b2Math_164.b2SubVV(cB, cA, b2Math_163.b2Vec2.s_t0), b2Math_164.b2SubVV(rB, rA, b2Math_163.b2Vec2.s_t1), b2WheelJoint.SolvePositionConstraints_s_d);
                    // b2Vec2 ay = b2Mul(qA, m_localYAxisA);
                    const ay = b2Math_168.b2MulRV(qA, this.m_localYAxisA, this.m_ay);
                    // float32 sAy = b2Cross(d + rA, ay);
                    const sAy = b2Math_165.b2CrossVV(b2Math_164.b2AddVV(d, rA, b2Math_163.b2Vec2.s_t0), ay);
                    // float32 sBy = b2Cross(rB, ay);
                    const sBy = b2Math_165.b2CrossVV(rB, ay);
                    // float32 C = b2Dot(d, ay);
                    const C = b2Math_165.b2DotVV(d, this.m_ay);
                    ...
                    // b2Vec2 P = impulse * ay;
                    const P = b2Math_164.b2MulSV(impulse, ay, b2WheelJoint.SolvePositionConstraints_s_P);
                    ...
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return b2Math_162.b2Abs(C) <= b2Settings_72.b2_linearSlop;
                }
                GetDefinition(def) {
                    if (b2Settings_71.ENABLE_ASSERTS) {
                        b2Settings_71.b2Assert(false);
                    } // TODO
                    return def;
                }
                GetAnchorA(out) {
                ...
                GetJointTranslation() {
                    const bA = this.m_bodyA;
                    const bB = this.m_bodyB;
                    const pA = bA.GetWorldPoint(this.m_localAnchorA, new b2Math_163.b2Vec2());
                    const pB = bB.GetWorldPoint(this.m_localAnchorB, new b2Math_163.b2Vec2());
                    const d = b2Math_164.b2SubVV(pB, pA, new b2Math_163.b2Vec2());
                    const axis = bA.GetWorldVector(this.m_localXAxisA, new b2Math_163.b2Vec2());
                    const translation = b2Math_165.b2DotVV(d, axis);
                    return translation;
                }
                GetJointSpeed() {
                ...
                Dump() {
                    if (b2Settings_71.DEBUG) {
                        const indexA = this.m_bodyA.m_islandIndex;
                        const indexB = this.m_bodyB.m_islandIndex;
                        b2Settings_71.b2Log("  const jd: b2WheelJointDef = new b2WheelJointDef();\n");
                        b2Settings_71.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
                        b2Settings_71.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
                        b2Settings_71.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ("true") : ("false"));
                        b2Settings_71.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
                        b2Settings_71.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
                        b2Settings_71.b2Log("  jd.localAxisA.Set(%.15f, %.15f);\n", this.m_localXAxisA.x, this.m_localXAxisA.y);
                        b2Settings_71.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ("true") : ("false"));
                        b2Settings_71.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
                        b2Settings_71.b2Log("  jd.maxMotorTorque = %.15f;\n", this.m_maxMotorTorque);
                        b2Settings_71.b2Log("  jd.frequencyHz = %.15f;\n", this.m_frequencyHz);
                        b2Settings_71.b2Log("  jd.dampingRatio = %.15f;\n", this.m_dampingRatio);
                        b2Settings_71.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
                    }
                }
            };
            b2WheelJoint.InitVelocityConstraints_s_d = new b2Math_163.b2Vec2();
            b2WheelJoint.InitVelocityConstraints_s_P = new b2Math_163.b2Vec2();
            b2WheelJoint.SolveVelocityConstraints_s_P = new b2Math_163.b2Vec2();
            b2WheelJoint.SolvePositionConstraints_s_d = new b2Math_163.b2Vec2();
            b2WheelJoint.SolvePositionConstraints_s_P = new b2Math_163.b2Vec2();
            exports_36("b2WheelJoint", b2WheelJoint);
        }
    }
});
System.register("Box2D/Dynamics/Joints/b2JointFactory", ["Box2D/Common/b2Settings", "Box2D/Dynamics/Joints/b2AreaJoint", "Box2D/Dynamics/Joints/b2DistanceJoint", "Box2D/Dynamics/Joints/b2FrictionJoint", "Box2D/Dynamics/Joints/b2GearJoint", "Box2D/Dynamics/Joints/b2MotorJoint", "Box2D/Dynamics/Joints/b2MouseJoint", "Box2D/Dynamics/Joints/b2PrismaticJoint", "Box2D/Dynamics/Joints/b2PulleyJoint", "Box2D/Dynamics/Joints/b2RevoluteJoint", "Box2D/Dynamics/Joints/b2RopeJoint", "Box2D/Dynamics/Joints/b2WeldJoint", "Box2D/Dynamics/Joints/b2WheelJoint"], function(exports_37, context_37) {
    "use strict";
    var __moduleName = context_37 && context_37.id;
    var b2Settings_74, b2AreaJoint_1, b2DistanceJoint_2, b2FrictionJoint_1, b2GearJoint_1, b2MotorJoint_1, b2MouseJoint_1, b2PrismaticJoint_1, b2PulleyJoint_1, b2RevoluteJoint_1, b2RopeJoint_1, b2WeldJoint_1, b2WheelJoint_1;
    var b2JointFactory;
    return {
        setters:[
            function (b2Settings_74_1) {
                b2Settings_74 = b2Settings_74_1;
            },
        ...
        execute: function() {
                ...
                static Create(def, allocator) {
                    ...
                    switch (def.type) {
                        ...
                        case 12 /* e_areaJoint */:
                            ...
                            break;
                        default:
                            if (b2Settings_74.ENABLE_ASSERTS) {
                                b2Settings_74.b2Assert(false);
                            }
                            break;
                    }
                    return joint;
            ...
            exports_37("b2JointFactory", b2JointFactory);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2ChainAndCircleContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2ChainShape", "Box2D/Collision/Shapes/b2CircleShape", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_38, context_38) {
    "use strict";
    var __moduleName = context_38 && context_38.id;
    var b2Settings_75, b2CollideEdge_1, b2ChainShape_1, b2CircleShape_1, b2EdgeShape_2, b2Contact_1;
    var b2ChainAndCircleContact;
    return {
        setters:[
            function (b2Settings_75_1) {
                b2Settings_75 = b2Settings_75_1;
            },
        ...
        execute: function() {
            b2ChainAndCircleContact = class b2ChainAndCircleContact extends b2Contact_1.b2Contact {
                ...
                Reset(fixtureA, indexA, fixtureB, indexB) {
                    ...
                    if (b2Settings_75.ENABLE_ASSERTS) {
                        b2Settings_75.b2Assert(fixtureA.GetType() === 3 /* e_chainShape */);
                    }
                    if (b2Settings_75.ENABLE_ASSERTS) {
                        b2Settings_75.b2Assert(fixtureB.GetType() === 0 /* e_circleShape */);
                    }
                }
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_75.ENABLE_ASSERTS) {
                        b2Settings_75.b2Assert(shapeA instanceof b2ChainShape_1.b2ChainShape);
                    }
                    if (b2Settings_75.ENABLE_ASSERTS) {
                        b2Settings_75.b2Assert(shapeB instanceof b2CircleShape_1.b2CircleShape);
                    }
                    const chain = shapeA;
            ...
            exports_38("b2ChainAndCircleContact", b2ChainAndCircleContact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2ChainAndPolygonContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2ChainShape", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Collision/Shapes/b2PolygonShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_39, context_39) {
    "use strict";
    var __moduleName = context_39 && context_39.id;
    var b2Settings_76, b2CollideEdge_2, b2ChainShape_2, b2EdgeShape_3, b2PolygonShape_1, b2Contact_2;
    var b2ChainAndPolygonContact;
    return {
        setters:[
            function (b2Settings_76_1) {
                b2Settings_76 = b2Settings_76_1;
            },
        ...
        execute: function() {
            b2ChainAndPolygonContact = class b2ChainAndPolygonContact extends b2Contact_2.b2Contact {
                ...
                Reset(fixtureA, indexA, fixtureB, indexB) {
                    super.Reset(fixtureA, indexA, fixtureB, indexB);
                    if (b2Settings_76.ENABLE_ASSERTS) {
                        b2Settings_76.b2Assert(fixtureA.GetType() === 3 /* e_chainShape */);
                    }
                    if (b2Settings_76.ENABLE_ASSERTS) {
                        b2Settings_76.b2Assert(fixtureB.GetType() === 2 /* e_polygonShape */);
                    }
                }
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_76.ENABLE_ASSERTS) {
                        b2Settings_76.b2Assert(shapeA instanceof b2ChainShape_2.b2ChainShape);
                    }
                    if (b2Settings_76.ENABLE_ASSERTS) {
                        b2Settings_76.b2Assert(shapeB instanceof b2PolygonShape_1.b2PolygonShape);
                    }
                    const chain = shapeA;
            ...
            exports_39("b2ChainAndPolygonContact", b2ChainAndPolygonContact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2CircleContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideCircle", "Box2D/Collision/Shapes/b2CircleShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_40, context_40) {
    "use strict";
    var __moduleName = context_40 && context_40.id;
    var b2Settings_77, b2CollideCircle_1, b2CircleShape_2, b2Contact_3;
    var b2CircleContact;
    return {
        setters:[
            function (b2Settings_77_1) {
                b2Settings_77 = b2Settings_77_1;
            },
        ...
        execute: function() {
            b2CircleContact = class b2CircleContact extends b2Contact_3.b2Contact {
                ...
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_77.ENABLE_ASSERTS) {
                        b2Settings_77.b2Assert(shapeA instanceof b2CircleShape_2.b2CircleShape);
                    }
                    if (b2Settings_77.ENABLE_ASSERTS) {
                        b2Settings_77.b2Assert(shapeB instanceof b2CircleShape_2.b2CircleShape);
                    }
                    b2CollideCircle_1.b2CollideCircles(manifold, shapeA, xfA, shapeB, xfB);
                }
            };
            exports_40("b2CircleContact", b2CircleContact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2EdgeAndCircleContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2CircleShape", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_41, context_41) {
    "use strict";
    var __moduleName = context_41 && context_41.id;
    var b2Settings_78, b2CollideEdge_3, b2CircleShape_3, b2EdgeShape_4, b2Contact_4;
    var b2EdgeAndCircleContact;
    return {
        setters:[
            function (b2Settings_78_1) {
                b2Settings_78 = b2Settings_78_1;
            },
        ...
        execute: function() {
            b2EdgeAndCircleContact = class b2EdgeAndCircleContact extends b2Contact_4.b2Contact {
                ...
                Reset(fixtureA, indexA, fixtureB, indexB) {
                    super.Reset(fixtureA, indexA, fixtureB, indexB);
                    if (b2Settings_78.ENABLE_ASSERTS) {
                        b2Settings_78.b2Assert(fixtureA.GetType() === 1 /* e_edgeShape */);
                    }
                    if (b2Settings_78.ENABLE_ASSERTS) {
                        b2Settings_78.b2Assert(fixtureB.GetType() === 0 /* e_circleShape */);
                    }
                }
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_78.ENABLE_ASSERTS) {
                        b2Settings_78.b2Assert(shapeA instanceof b2EdgeShape_4.b2EdgeShape);
                    }
                    if (b2Settings_78.ENABLE_ASSERTS) {
                        b2Settings_78.b2Assert(shapeB instanceof b2CircleShape_3.b2CircleShape);
                    }
                    b2CollideEdge_3.b2CollideEdgeAndCircle(manifold, shapeA, xfA, shapeB, xfB);
                }
            };
            exports_41("b2EdgeAndCircleContact", b2EdgeAndCircleContact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Collision/Shapes/b2PolygonShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_42, context_42) {
    "use strict";
    var __moduleName = context_42 && context_42.id;
    var b2Settings_79, b2CollideEdge_4, b2EdgeShape_5, b2PolygonShape_2, b2Contact_5;
    var b2EdgeAndPolygonContact;
    return {
        setters:[
            function (b2Settings_79_1) {
                b2Settings_79 = b2Settings_79_1;
            },
        ...
        execute: function() {
            b2EdgeAndPolygonContact = class b2EdgeAndPolygonContact extends b2Contact_5.b2Contact {
                ...
                Reset(fixtureA, indexA, fixtureB, indexB) {
                    super.Reset(fixtureA, indexA, fixtureB, indexB);
                    if (b2Settings_79.ENABLE_ASSERTS) {
                        b2Settings_79.b2Assert(fixtureA.GetType() === 1 /* e_edgeShape */);
                    }
                    if (b2Settings_79.ENABLE_ASSERTS) {
                        b2Settings_79.b2Assert(fixtureB.GetType() === 2 /* e_polygonShape */);
                    }
                }
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_79.ENABLE_ASSERTS) {
                        b2Settings_79.b2Assert(shapeA instanceof b2EdgeShape_5.b2EdgeShape);
                    }
                    if (b2Settings_79.ENABLE_ASSERTS) {
                        b2Settings_79.b2Assert(shapeB instanceof b2PolygonShape_2.b2PolygonShape);
                    }
                    b2CollideEdge_4.b2CollideEdgeAndPolygon(manifold, shapeA, xfA, shapeB, xfB);
                }
            };
            exports_42("b2EdgeAndPolygonContact", b2EdgeAndPolygonContact);
        }
    }
});
/*
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2PolygonAndCircleContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollideCircle", "Box2D/Collision/Shapes/b2CircleShape", "Box2D/Collision/Shapes/b2PolygonShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_43, context_43) {
    "use strict";
    var __moduleName = context_43 && context_43.id;
    var b2Settings_80, b2CollideCircle_2, b2CircleShape_4, b2PolygonShape_3, b2Contact_6;
    var b2PolygonAndCircleContact;
    return {
        setters:[
            function (b2Settings_80_1) {
                b2Settings_80 = b2Settings_80_1;
            },
        ...
        execute: function() {
            b2PolygonAndCircleContact = class b2PolygonAndCircleContact extends b2Contact_6.b2Contact {
                ...
                Reset(fixtureA, indexA, fixtureB, indexB) {
                    super.Reset(fixtureA, indexA, fixtureB, indexB);
                    if (b2Settings_80.ENABLE_ASSERTS) {
                        b2Settings_80.b2Assert(fixtureA.GetType() === 2 /* e_polygonShape */);
                    }
                    if (b2Settings_80.ENABLE_ASSERTS) {
                        b2Settings_80.b2Assert(fixtureB.GetType() === 0 /* e_circleShape */);
                    }
                }
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_80.ENABLE_ASSERTS) {
                        b2Settings_80.b2Assert(shapeA instanceof b2PolygonShape_3.b2PolygonShape);
                    }
                    if (b2Settings_80.ENABLE_ASSERTS) {
                        b2Settings_80.b2Assert(shapeB instanceof b2CircleShape_4.b2CircleShape);
                    }
                    b2CollideCircle_2.b2CollidePolygonAndCircle(manifold, shapeA, xfA, shapeB, xfB);
                }
            };
            exports_43("b2PolygonAndCircleContact", b2PolygonAndCircleContact);
        }
    }
});
/*
...
System.register("Box2D/Dynamics/Contacts/b2PolygonContact", ["Box2D/Common/b2Settings", "Box2D/Collision/b2CollidePolygon", "Box2D/Collision/Shapes/b2PolygonShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_44, context_44) {
    ...
    var b2Settings_81, b2CollidePolygon_1, b2PolygonShape_4, b2Contact_7;
    var b2PolygonContact;
    return {
        setters:[
            function (b2Settings_81_1) {
                b2Settings_81 = b2Settings_81_1;
            },
        ...
        execute: function() {
            b2PolygonContact = class b2PolygonContact extends b2Contact_7.b2Contact {
                ...
                Evaluate(manifold, xfA, xfB) {
                    const shapeA = this.m_fixtureA.GetShape();
                    const shapeB = this.m_fixtureB.GetShape();
                    if (b2Settings_81.ENABLE_ASSERTS) {
                        b2Settings_81.b2Assert(shapeA instanceof b2PolygonShape_4.b2PolygonShape);
                    }
                    if (b2Settings_81.ENABLE_ASSERTS) {
                        b2Settings_81.b2Assert(shapeB instanceof b2PolygonShape_4.b2PolygonShape);
                    }
...
System.register("Box2D/Dynamics/Contacts/b2ContactFactory", ["Box2D/Common/b2Settings", "Box2D/Dynamics/Contacts/b2ChainAndCircleContact", "Box2D/Dynamics/Contacts/b2ChainAndPolygonContact", "Box2D/Dynamics/Contacts/b2CircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndCircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact", "Box2D/Dynamics/Contacts/b2PolygonAndCircleContact", "Box2D/Dynamics/Contacts/b2PolygonContact"], function(exports_45, context_45) {
    ...
    var b2Settings_82, b2Settings_83, b2ChainAndCircleContact_1, b2ChainAndPolygonContact_1, b2CircleContact_1, b2EdgeAndCircleContact_1, b2EdgeAndPolygonContact_1, b2PolygonAndCircleContact_1, b2PolygonContact_1;
    var b2ContactRegister, b2ContactFactory;
    return {
        setters:[
            function (b2Settings_82_1) {
                b2Settings_82 = b2Settings_82_1;
                b2Settings_83 = b2Settings_82_1;
            },
        ...
        execute: function() {
            ...
            b2ContactFactory = class b2ContactFactory {
                ...
                AddType(createFcn, destroyFcn, type1, type2) {
                    const that = this;
                    const pool = b2Settings_83.b2MakeArray(256, function (i) { return createFcn(that.m_allocator); }); // TODO: b2Settings
                ...
                Create(fixtureA, indexA, fixtureB, indexB) {
                    ...
                    if (b2Settings_82.ENABLE_ASSERTS) {
                        b2Settings_82.b2Assert(0 <= type1 && type1 < 4 /* e_shapeTypeCount */);
                    }
                    if (b2Settings_82.ENABLE_ASSERTS) {
                        b2Settings_82.b2Assert(0 <= type2 && type2 < 4 /* e_shapeTypeCount */);
                    }
                ...
                Destroy(contact) {
                    ...
                    if (b2Settings_82.ENABLE_ASSERTS) {
                        b2Settings_82.b2Assert(0 <= typeA && typeB < 4 /* e_shapeTypeCount */);
                    }
                    if (b2Settings_82.ENABLE_ASSERTS) {
                        b2Settings_82.b2Assert(0 <= typeA && typeB < 4 /* e_shapeTypeCount */);
                    }
...
System.register("Box2D/Dynamics/b2ContactManager", ["Box2D/Common/b2Settings", "Box2D/Collision/b2BroadPhase", "Box2D/Dynamics/Contacts/b2ContactFactory", "Box2D/Dynamics/b2Fixture", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_46, context_46) {
    ...
    var b2Settings_84, b2BroadPhase_1, b2ContactFactory_1, b2Fixture_1, b2WorldCallbacks_1, b2WorldCallbacks_2;
    var b2ContactManager;
    return {
        setters:[
            function (b2Settings_84_1) {
                b2Settings_84 = b2Settings_84_1;
            },
        ...
        execute: function() {
            ...
            b2ContactManager = class b2ContactManager {
                ...
                AddPair(proxyUserDataA, proxyUserDataB) {
                    if (b2Settings_84.ENABLE_ASSERTS) {
                        b2Settings_84.b2Assert(proxyUserDataA instanceof b2Fixture_1.b2FixtureProxy);
                    }
                    if (b2Settings_84.ENABLE_ASSERTS) {
                        b2Settings_84.b2Assert(proxyUserDataB instanceof b2Fixture_1.b2FixtureProxy);
                    }
...
System.register("Box2D/Dynamics/Contacts/b2ContactSolver", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Dynamics/b2TimeStep"], function(exports_47, context_47) {
    ...
    var b2Settings_85, b2Settings_86, b2Settings_87, b2Settings_88, b2Settings_89, b2Settings_90, b2Settings_91, b2Settings_92, b2Math_169, b2Math_170, b2Math_171, b2Math_172, b2Math_173, b2Math_174, b2Math_175, b2Math_176, b2Math_177, b2Math_178, b2Math_179, b2Math_180, b2Collision_8, b2TimeStep_1;
    ...
    return {
        setters:[
            function (b2Settings_85_1) {
                b2Settings_85 = b2Settings_85_1;
                b2Settings_86 = b2Settings_85_1;
                b2Settings_87 = b2Settings_85_1;
                b2Settings_88 = b2Settings_85_1;
                b2Settings_89 = b2Settings_85_1;
                b2Settings_90 = b2Settings_85_1;
                b2Settings_91 = b2Settings_85_1;
                b2Settings_92 = b2Settings_85_1;
            },
            function (b2Math_169_1) {
                b2Math_169 = b2Math_169_1;
                b2Math_170 = b2Math_169_1;
                b2Math_171 = b2Math_169_1;
                b2Math_172 = b2Math_169_1;
                b2Math_173 = b2Math_169_1;
                b2Math_174 = b2Math_169_1;
                b2Math_175 = b2Math_169_1;
                b2Math_176 = b2Math_169_1;
                b2Math_177 = b2Math_169_1;
                b2Math_178 = b2Math_169_1;
                b2Math_179 = b2Math_169_1;
                b2Math_180 = b2Math_169_1;
            },
        ...
        execute: function() {
            b2VelocityConstraintPoint = class b2VelocityConstraintPoint {
                constructor() {
                    this.rA = new b2Math_170.b2Vec2();
                    this.rB = new b2Math_170.b2Vec2();
                    this.normalImpulse = 0;
                    this.tangentImpulse = 0;
                    this.normalMass = 0;
                    this.tangentMass = 0;
                ...
                static MakeArray(length) {
                    return b2Settings_92.b2MakeArray(length, function (i) { return new b2VelocityConstraintPoint(); });
                }
            };
            ...
            b2ContactVelocityConstraint = class b2ContactVelocityConstraint {
                constructor() {
                    this.points = b2VelocityConstraintPoint.MakeArray(b2Settings_89.b2_maxManifoldPoints);
                    this.normal = new b2Math_170.b2Vec2();
                    this.tangent = new b2Math_170.b2Vec2();
                    this.normalMass = new b2Math_176.b2Mat22();
                    this.K = new b2Math_176.b2Mat22();
                    this.indexA = 0;
                    this.indexB = 0;
                    this.invMassA = 0;
                    this.invMassB = 0;
                ...
                static MakeArray(length) {
                    return b2Settings_92.b2MakeArray(length, function (i) { return new b2ContactVelocityConstraint(); });
                }
            };
            ...
            b2ContactPositionConstraint = class b2ContactPositionConstraint {
                constructor() {
                    this.localPoints = b2Math_170.b2Vec2.MakeArray(b2Settings_89.b2_maxManifoldPoints);
                    this.localNormal = new b2Math_170.b2Vec2();
                    this.localPoint = new b2Math_170.b2Vec2();
                    this.indexA = 0;
                    this.indexB = 0;
                    this.invMassA = 0;
                    this.invMassB = 0;
                    this.localCenterA = new b2Math_170.b2Vec2();
                    this.localCenterB = new b2Math_170.b2Vec2();
                    this.invIA = 0;
                    this.invIB = 0;
                    this.type = -1 /* e_unknown */;
                    this.radiusA = 0;
                ...
                static MakeArray(length) {
                    return b2Settings_92.b2MakeArray(length, function (i) { return new b2ContactPositionConstraint(); });
                }
            };
            ...
            b2PositionSolverManifold = class b2PositionSolverManifold {
                constructor() {
                    this.normal = new b2Math_170.b2Vec2();
                    this.point = new b2Math_170.b2Vec2();
                    this.separation = 0;
                }
                Initialize(pc, xfA, xfB, index) {
                    ...
                    if (b2Settings_85.ENABLE_ASSERTS) {
                        b2Settings_85.b2Assert(pc.pointCount > 0);
                    }
                    switch (pc.type) {
                        case 0 /* e_circles */:
                            {
                                // b2Vec2 pointA = b2Mul(xfA, pc->localPoint);
                                b2Math_180.b2MulXV(xfA, pc.localPoint, pointA);
                                // b2Vec2 pointB = b2Mul(xfB, pc->localPoints[0]);
                                b2Math_180.b2MulXV(xfB, pc.localPoints[0], pointB);
                                // normal = pointB - pointA;
                                // normal.Normalize();
                                b2Math_171.b2SubVV(pointB, pointA, this.normal).SelfNormalize();
                                // point = 0.5f * (pointA + pointB);
                                b2Math_175.b2MidVV(pointA, pointB, this.point);
                                // separation = b2Dot(pointB - pointA, normal) - pc->radius;
                                this.separation = b2Math_172.b2DotVV(b2Math_171.b2SubVV(pointB, pointA, b2Math_170.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
                            }
                            break;
                        case 1 /* e_faceA */:
                            {
                                // normal = b2Mul(xfA.q, pc->localNormal);
                                b2Math_178.b2MulRV(xfA.q, pc.localNormal, this.normal);
                                // b2Vec2 planePoint = b2Mul(xfA, pc->localPoint);
                                b2Math_180.b2MulXV(xfA, pc.localPoint, planePoint);
                                // b2Vec2 clipPoint = b2Mul(xfB, pc->localPoints[index]);
                                b2Math_180.b2MulXV(xfB, pc.localPoints[index], clipPoint);
                                // separation = b2Dot(clipPoint - planePoint, normal) - pc->radius;
                                this.separation = b2Math_172.b2DotVV(b2Math_171.b2SubVV(clipPoint, planePoint, b2Math_170.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
                                // point = clipPoint;
                        ...
                        case 2 /* e_faceB */:
                            {
                                ...
                                b2Math_178.b2MulRV(xfB.q, pc.localNormal, this.normal);
                                // b2Vec2 planePoint = b2Mul(xfB, pc->localPoint);
                                b2Math_180.b2MulXV(xfB, pc.localPoint, planePoint);
                                // b2Vec2 clipPoint = b2Mul(xfA, pc->localPoints[index]);
                                b2Math_180.b2MulXV(xfA, pc.localPoints[index], clipPoint);
                                // separation = b2Dot(clipPoint - planePoint, normal) - pc->radius;
                                this.separation = b2Math_172.b2DotVV(b2Math_171.b2SubVV(clipPoint, planePoint, b2Math_170.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
                                // point = clipPoint;
                                this.point.Copy(clipPoint);
            ...
            b2PositionSolverManifold.Initialize_s_pointA = new b2Math_170.b2Vec2();
            b2PositionSolverManifold.Initialize_s_pointB = new b2Math_170.b2Vec2();
            b2PositionSolverManifold.Initialize_s_planePoint = new b2Math_170.b2Vec2();
            b2PositionSolverManifold.Initialize_s_clipPoint = new b2Math_170.b2Vec2();
            ...
            b2ContactSolver = class b2ContactSolver {
                ...
                Initialize(def) {
                    ...
                    if (this.m_positionConstraints.length < this.m_count) {
                        const new_length = b2Math_169.b2Max(this.m_positionConstraints.length * 2, this.m_count);
                        if (b2Settings_85.DEBUG) {
                    ...
                    if (this.m_velocityConstraints.length < this.m_count) {
                        const new_length = b2Math_169.b2Max(this.m_velocityConstraints.length * 2, this.m_count);
                        if (b2Settings_85.DEBUG) {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        if (b2Settings_85.ENABLE_ASSERTS) {
                            b2Settings_85.b2Assert(pointCount > 0);
                        }
                ...
                InitializeVelocityConstraints() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        if (b2Settings_85.ENABLE_ASSERTS) {
                            b2Settings_85.b2Assert(manifold.pointCount > 0);
                        }
                        xfA.q.SetAngleRadians(aA);
                        xfB.q.SetAngleRadians(aB);
                        b2Math_171.b2SubVV(cA, b2Math_178.b2MulRV(xfA.q, localCenterA, b2Math_170.b2Vec2.s_t0), xfA.p);
                        b2Math_171.b2SubVV(cB, b2Math_178.b2MulRV(xfB.q, localCenterB, b2Math_170.b2Vec2.s_t0), xfB.p);
                        worldManifold.Initialize(manifold, xfA, radiusA, xfB, radiusB);
                        vc.normal.Copy(worldManifold.normal);
                        b2Math_173.b2CrossVOne(vc.normal, vc.tangent); // compute from normal
                        pointCount = vc.pointCount;
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            vcp = vc.points[j];
                            // vcp->rA = worldManifold.points[j] - cA;
                            b2Math_171.b2SubVV(worldManifold.points[j], cA, vcp.rA);
                            // vcp->rB = worldManifold.points[j] - cB;
                            b2Math_171.b2SubVV(worldManifold.points[j], cB, vcp.rB);
                            rnA = b2Math_172.b2CrossVV(vcp.rA, vc.normal);
                            rnB = b2Math_172.b2CrossVV(vcp.rB, vc.normal);
                            kNormal = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
                            vcp.normalMass = kNormal > 0 ? 1 / kNormal : 0;
                            // b2Vec2 tangent = b2Cross(vc->normal, 1.0f);
                            tangent = vc.tangent; // precomputed from normal
                            rtA = b2Math_172.b2CrossVV(vcp.rA, tangent);
                            rtB = b2Math_172.b2CrossVV(vcp.rB, tangent);
                            kTangent = mA + mB + iA * rtA * rtA + iB * rtB * rtB;
                            vcp.tangentMass = kTangent > 0 ? 1 / kTangent : 0;
                            // Setup a velocity bias for restitution.
                            vcp.velocityBias = 0;
                            // float32 vRel = b2Dot(vc->normal, vB + b2Cross(wB, vcp->rB) - vA - b2Cross(wA, vcp->rA));
                            vRel = b2Math_172.b2DotVV(vc.normal, b2Math_171.b2SubVV(b2Math_174.b2AddVCrossSV(vB, wB, vcp.rB, b2Math_170.b2Vec2.s_t0), b2Math_174.b2AddVCrossSV(vA, wA, vcp.rA, b2Math_170.b2Vec2.s_t1), b2Math_170.b2Vec2.s_t0));
                            if (vRel < (-b2Settings_91.b2_velocityThreshold)) {
                        ...
                        if (vc.pointCount === 2) {
                            vcp1 = vc.points[0];
                            vcp2 = vc.points[1];
                            rn1A = b2Math_172.b2CrossVV(vcp1.rA, vc.normal);
                            rn1B = b2Math_172.b2CrossVV(vcp1.rB, vc.normal);
                            rn2A = b2Math_172.b2CrossVV(vcp2.rA, vc.normal);
                            rn2B = b2Math_172.b2CrossVV(vcp2.rB, vc.normal);
                ...
                WarmStart() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            b2Math_171.b2AddVV(b2Math_171.b2MulSV(vcp.normalImpulse, normal, b2Math_170.b2Vec2.s_t0), b2Math_171.b2MulSV(vcp.tangentImpulse, tangent, b2Math_170.b2Vec2.s_t1), P);
                            // wA -= iA * b2Cross(vcp->rA, P);
                            wA -= iA * b2Math_172.b2CrossVV(vcp.rA, P);
                            // vA -= mA * P;
                            vA.SelfMulSub(mA, P);
                            // wB += iB * b2Cross(vcp->rB, P);
                            wB += iB * b2Math_172.b2CrossVV(vcp.rB, P);
                            // vB += mB * P;
                            vB.SelfMulAdd(mB, P);
                        }
                ...
                SolveVelocityConstraints() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        if (b2Settings_85.ENABLE_ASSERTS) {
                            b2Settings_85.b2Assert(pointCount === 1 || pointCount === 2);
                        }
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            b2Math_171.b2SubVV(b2Math_174.b2AddVCrossSV(vB, wB, vcp.rB, b2Math_170.b2Vec2.s_t0), b2Math_174.b2AddVCrossSV(vA, wA, vcp.rA, b2Math_170.b2Vec2.s_t1), dv);
                            // Compute tangent force
                            // float32 vt = b2Dot(dv, tangent) - vc->tangentSpeed;
                            vt = b2Math_172.b2DotVV(dv, tangent) - vc.tangentSpeed;
                            lambda = vcp.tangentMass * (-vt);
                            // b2Clamp the accumulated force
                            maxFriction = friction * vcp.normalImpulse;
                            newImpulse = b2Math_169.b2Clamp(vcp.tangentImpulse + lambda, (-maxFriction), maxFriction);
                            lambda = newImpulse - vcp.tangentImpulse;
                            vcp.tangentImpulse = newImpulse;
                            // Apply contact impulse
                            // b2Vec2 P = lambda * tangent;
                            b2Math_171.b2MulSV(lambda, tangent, P);
                            // vA -= mA * P;
                            vA.SelfMulSub(mA, P);
                            // wA -= iA * b2Cross(vcp->rA, P);
                            wA -= iA * b2Math_172.b2CrossVV(vcp.rA, P);
                        ...
                        if (vc.pointCount === 1) {
                            ...
                            vn = b2Math_172.b2DotVV(dv, normal);
                            lambda = (-vcp.normalMass * (vn - vcp.velocityBias));
                            // b2Clamp the accumulated impulse
                            // float32 newImpulse = b2Max(vcp->normalImpulse + lambda, 0.0f);
                            newImpulse = b2Math_169.b2Max(vcp.normalImpulse + lambda, 0);
                            lambda = newImpulse - vcp.normalImpulse;
                            vcp.normalImpulse = newImpulse;
                            // Apply contact impulse
                            // b2Vec2 P = lambda * normal;
                            b2Math_171.b2MulSV(lambda, normal, P);
                            // vA -= mA * P;
                            vA.SelfMulSub(mA, P);
                            // wA -= iA * b2Cross(vcp->rA, P);
                            wA -= iA * b2Math_172.b2CrossVV(vcp.rA, P);
                            ...
                            if (b2Settings_85.ENABLE_ASSERTS) {
                                b2Settings_85.b2Assert(a.x >= 0 && a.y >= 0);
                            }
                            // Relative velocity at contact
                            // b2Vec2 dv1 = vB + b2Cross(wB, cp1->rB) - vA - b2Cross(wA, cp1->rA);
                            b2Math_171.b2SubVV(b2Math_174.b2AddVCrossSV(vB, wB, cp1.rB, b2Math_170.b2Vec2.s_t0), b2Math_174.b2AddVCrossSV(vA, wA, cp1.rA, b2Math_170.b2Vec2.s_t1), dv1);
                            // b2Vec2 dv2 = vB + b2Cross(wB, cp2->rB) - vA - b2Cross(wA, cp2->rA);
                            b2Math_171.b2SubVV(b2Math_174.b2AddVCrossSV(vB, wB, cp2.rB, b2Math_170.b2Vec2.s_t0), b2Math_174.b2AddVCrossSV(vA, wA, cp2.rA, b2Math_170.b2Vec2.s_t1), dv2);
                            // Compute normal velocity
                            // float32 vn1 = b2Dot(dv1, normal);
                            vn1 = b2Math_172.b2DotVV(dv1, normal);
                            // float32 vn2 = b2Dot(dv2, normal);
                            vn2 = b2Math_172.b2DotVV(dv2, normal);
                            // b2Vec2 b;
                            b.x = vn1 - cp1.velocityBias;
                            b.y = vn2 - cp2.velocityBias;
                            // Compute b'
                            // b -= b2Mul(vc->K, a);
                            b.SelfSub(b2Math_177.b2MulMV(vc.K, a, b2Math_170.b2Vec2.s_t0));
                            /*
                            ...
                            */
                            for (;;) {
                                ...
                                b2Math_177.b2MulMV(vc.normalMass, b, x).SelfNeg();
                                if (x.x >= 0 && x.y >= 0) {
                                    // Get the incremental impulse
                                    // b2Vec2 d = x - a;
                                    b2Math_171.b2SubVV(x, a, d);
                                    // Apply incremental impulse
                                    // b2Vec2 P1 = d.x * normal;
                                    b2Math_171.b2MulSV(d.x, normal, P1);
                                    // b2Vec2 P2 = d.y * normal;
                                    b2Math_171.b2MulSV(d.y, normal, P2);
                                    b2Math_171.b2AddVV(P1, P2, P1P2);
                                    // vA -= mA * (P1 + P2);
                                    vA.SelfMulSub(mA, P1P2);
                                    // wA -= iA * (b2Cross(cp1->rA, P1) + b2Cross(cp2->rA, P2));
                                    wA -= iA * (b2Math_172.b2CrossVV(cp1.rA, P1) + b2Math_172.b2CrossVV(cp2.rA, P2));
                                    // vB += mB * (P1 + P2);
                                    vB.SelfMulAdd(mB, P1P2);
                                    // wB += iB * (b2Cross(cp1->rB, P1) + b2Cross(cp2->rB, P2));
                                    wB += iB * (b2Math_172.b2CrossVV(cp1.rB, P1) + b2Math_172.b2CrossVV(cp2.rB, P2));
                                    // Accumulate
                ...
                SolvePositionConstraints() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            // b2Vec2 rA = point - cA;
                            b2Math_171.b2SubVV(point, cA, rA);
                            // b2Vec2 rB = point - cB;
                            b2Math_171.b2SubVV(point, cB, rB);
                            // Track max constraint error.
                            minSeparation = b2Math_169.b2Min(minSeparation, separation);
                            // Prevent large corrections and allow slop.
                            C = b2Math_169.b2Clamp(b2Settings_86.b2_baumgarte * (separation + b2Settings_87.b2_linearSlop), (-b2Settings_88.b2_maxLinearCorrection), 0);
                            // Compute the effective mass.
                            // float32 rnA = b2Cross(rA, normal);
                            rnA = b2Math_172.b2CrossVV(rA, normal);
                            // float32 rnB = b2Cross(rB, normal);
                            rnB = b2Math_172.b2CrossVV(rB, normal);
                            // float32 K = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
                            K = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
                            // Compute normal impulse
                            impulse = K > 0 ? -C / K : 0;
                            // b2Vec2 P = impulse * normal;
                            b2Math_171.b2MulSV(impulse, normal, P);
                            // cA -= mA * P;
                            cA.SelfMulSub(mA, P);
                            // aA -= iA * b2Cross(rA, P);
                            aA -= iA * b2Math_172.b2CrossVV(rA, P);
                            // cB += mB * P;
                            cB.SelfMulAdd(mB, P);
                            // aB += iB * b2Cross(rB, P);
                            aB += iB * b2Math_172.b2CrossVV(rB, P);
                        }
                    ...
                    return minSeparation > (-3 * b2Settings_87.b2_linearSlop);
                }
                SolveTOIPositionConstraints(toiIndexA, toiIndexB) {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            minSeparation = b2Math_169.b2Min(minSeparation, separation);
                            // Prevent large corrections and allow slop.
                            C = b2Math_169.b2Clamp(b2Settings_90.b2_toiBaumgarte * (separation + b2Settings_87.b2_linearSlop), (-b2Settings_88.b2_maxLinearCorrection), 0);
                            // Compute the effective mass.
                            // float32 rnA = b2Cross(rA, normal);
                            rnA = b2Math_172.b2CrossVV(rA, normal);
                            // float32 rnB = b2Cross(rB, normal);
                    ...
                    // We can't expect minSpeparation >= -b2_linearSlop because we don't
                    // push the separation above -b2_linearSlop.
                    return minSeparation >= -1.5 * b2Settings_87.b2_linearSlop;
                }
            };
            b2ContactSolver.InitializeVelocityConstraints_s_xfA = new b2Math_179.b2Transform();
            b2ContactSolver.InitializeVelocityConstraints_s_xfB = new b2Math_179.b2Transform();
            b2ContactSolver.InitializeVelocityConstraints_s_worldManifold = new b2Collision_8.b2WorldManifold();
            b2ContactSolver.WarmStart_s_P = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_dv = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_dv1 = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_dv2 = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_P = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_a = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_b = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_x = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_d = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_P1 = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_P2 = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveVelocityConstraints_s_P1P2 = new b2Math_170.b2Vec2();
            b2ContactSolver.SolvePositionConstraints_s_xfA = new b2Math_179.b2Transform();
            b2ContactSolver.SolvePositionConstraints_s_xfB = new b2Math_179.b2Transform();
            b2ContactSolver.SolvePositionConstraints_s_psm = new b2PositionSolverManifold();
            b2ContactSolver.SolvePositionConstraints_s_rA = new b2Math_170.b2Vec2();
            b2ContactSolver.SolvePositionConstraints_s_rB = new b2Math_170.b2Vec2();
            b2ContactSolver.SolvePositionConstraints_s_P = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveTOIPositionConstraints_s_xfA = new b2Math_179.b2Transform();
            b2ContactSolver.SolveTOIPositionConstraints_s_xfB = new b2Math_179.b2Transform();
            b2ContactSolver.SolveTOIPositionConstraints_s_psm = new b2PositionSolverManifold();
            b2ContactSolver.SolveTOIPositionConstraints_s_rA = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveTOIPositionConstraints_s_rB = new b2Math_170.b2Vec2();
            b2ContactSolver.SolveTOIPositionConstraints_s_P = new b2Math_170.b2Vec2();
...
System.register("Box2D/Dynamics/b2Island", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Timer", "Box2D/Dynamics/Contacts/b2ContactSolver", "Box2D/Dynamics/b2TimeStep", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_48, context_48) {
    ...
    var b2Settings_93, b2Settings_94, b2Settings_95, b2Settings_96, b2Settings_97, b2Settings_98, b2Settings_99, b2Math_181, b2Math_182, b2Math_183, b2Math_184, b2Timer_2, b2ContactSolver_1, b2TimeStep_2, b2TimeStep_3, b2TimeStep_4, b2WorldCallbacks_3;
    var b2Island;
    return {
        setters:[
            function (b2Settings_93_1) {
                b2Settings_93 = b2Settings_93_1;
                b2Settings_94 = b2Settings_93_1;
                b2Settings_95 = b2Settings_93_1;
                b2Settings_96 = b2Settings_93_1;
                b2Settings_97 = b2Settings_93_1;
                b2Settings_98 = b2Settings_93_1;
                b2Settings_99 = b2Settings_93_1;
            },
            function (b2Math_181_1) {
                b2Math_181 = b2Math_181_1;
                b2Math_182 = b2Math_181_1;
                b2Math_183 = b2Math_181_1;
                b2Math_184 = b2Math_181_1;
            },
        ...
        execute: function() {
            ...
            */
            b2Island = class b2Island {
                ...
                Initialize(bodyCapacity, contactCapacity, jointCapacity, allocator, listener) {
                    ...
                    if (this.m_positions.length < bodyCapacity) {
                        const new_length = b2Math_181.b2Max(this.m_positions.length * 2, bodyCapacity);
                        if (b2Settings_93.DEBUG) {
                    ...
                    if (this.m_velocities.length < bodyCapacity) {
                        const new_length = b2Math_181.b2Max(this.m_velocities.length * 2, bodyCapacity);
                        if (b2Settings_93.DEBUG) {
                ...
                AddBody(body) {
                    if (b2Settings_93.ENABLE_ASSERTS) {
                        b2Settings_93.b2Assert(this.m_bodyCount < this.m_bodyCapacity);
                    }
                ...
                AddContact(contact) {
                    if (b2Settings_93.ENABLE_ASSERTS) {
                        b2Settings_93.b2Assert(this.m_contactCount < this.m_contactCapacity);
                    }
                    this.m_contacts[this.m_contactCount++] = contact;
                }
                AddJoint(joint) {
                    if (b2Settings_93.ENABLE_ASSERTS) {
                        b2Settings_93.b2Assert(this.m_jointCount < this.m_jointCapacity);
                    }
                ...
                Solve(profile, step, gravity, allowSleep) {
                    ...
                    for (let i = 0; i < this.m_bodyCount; ++i) {
                        ...
                        if (b.m_type === 2 /* b2_dynamicBody */) {
                            ...
                            // Taylor expansion:
                            // v2 = (1.0f - c * dt) * v1
                            v.SelfMul(b2Math_181.b2Clamp(1 - h * b.m_linearDamping, 0, 1));
                            w *= b2Math_181.b2Clamp(1 - h * b.m_angularDamping, 0, 1);
                        }
                    ...
                    for (let i = 0; i < this.m_bodyCount; ++i) {
                        ...
                        const translation = b2Math_183.b2MulSV(h, v, b2Island.s_translation);
                        if (b2Math_184.b2DotVV(translation, translation) > b2Settings_98.b2_maxTranslationSquared) {
                            const ratio = b2Settings_98.b2_maxTranslation / translation.GetLength();
                            v.SelfMul(ratio);
                        }
                        const rotation = h * w;
                        if (rotation * rotation > b2Settings_97.b2_maxRotationSquared) {
                            const ratio = b2Settings_97.b2_maxRotation / b2Math_181.b2Abs(rotation);
                            w *= ratio;
                        }
                        // Integrate
                        c.x += h * v.x;
                    ...
                    if (allowSleep) {
                        let minSleepTime = b2Settings_96.b2_maxFloat;
                        const linTolSqr = b2Settings_95.b2_linearSleepTolerance * b2Settings_95.b2_linearSleepTolerance;
                        const angTolSqr = b2Settings_94.b2_angularSleepTolerance * b2Settings_94.b2_angularSleepTolerance;
                        for (let i = 0; i < this.m_bodyCount; ++i) {
                            const b = this.m_bodies[i];
                            ...
                            if ((b.m_flags & 4 /* e_autoSleepFlag */) === 0 ||
                                ...
                                b2Math_184.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
                                b.m_sleepTime = 0;
                                minSleepTime = 0;
                            }
                            else {
                                b.m_sleepTime += h;
                                minSleepTime = b2Math_181.b2Min(minSleepTime, b.m_sleepTime);
                            }
                        }
                        if (minSleepTime >= b2Settings_99.b2_timeToSleep && positionSolved) {
                            for (let i = 0; i < this.m_bodyCount; ++i) {
                                const b = this.m_bodies[i];
                                b.SetAwake(false);
                            }
                ...
                SolveTOI(subStep, toiIndexA, toiIndexB) {
                    if (b2Settings_93.ENABLE_ASSERTS) {
                        b2Settings_93.b2Assert(toiIndexA < this.m_bodyCount);
                    }
                    if (b2Settings_93.ENABLE_ASSERTS) {
                        b2Settings_93.b2Assert(toiIndexB < this.m_bodyCount);
                    }
            ...
            b2Island.s_translation = new b2Math_182.b2Vec2();
...
System.register("Box2D/Dynamics/b2World", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Timer", "Box2D/Common/b2Draw", "Box2D/Collision/b2Collision", "Box2D/Collision/b2TimeOfImpact", "Box2D/Dynamics/Joints/b2JointFactory", "Box2D/Dynamics/b2Body", "Box2D/Dynamics/b2ContactManager", "Box2D/Dynamics/b2Fixture", "Box2D/Dynamics/b2Island", "Box2D/Dynamics/b2TimeStep", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_49, context_49) {
    ...
    var b2Settings_100, b2Settings_101, b2Settings_102, b2Settings_103, b2Settings_104, b2Math_185, b2Math_186, b2Math_187, b2Math_188, b2Timer_3, b2Draw_1, b2Collision_9, b2Collision_10, b2Collision_11, b2Collision_12, b2TimeOfImpact_4, b2TimeOfImpact_5, b2TimeOfImpact_6, b2JointFactory_1, b2Body_1, b2ContactManager_1, b2Fixture_2, b2Island_1, b2TimeStep_5, b2TimeStep_6, b2WorldCallbacks_4, b2WorldCallbacks_5;
    var b2World;
    return {
        setters:[
            function (b2Settings_100_1) {
                b2Settings_100 = b2Settings_100_1;
                b2Settings_101 = b2Settings_100_1;
                b2Settings_102 = b2Settings_100_1;
                b2Settings_103 = b2Settings_100_1;
                b2Settings_104 = b2Settings_100_1;
            },
            function (b2Math_185_1) {
                b2Math_185 = b2Math_185_1;
                b2Math_186 = b2Math_185_1;
                b2Math_187 = b2Math_185_1;
                b2Math_188 = b2Math_185_1;
            },
            ...
            function (b2Collision_9_1) {
                ...
                b2Collision_11 = b2Collision_9_1;
                b2Collision_12 = b2Collision_9_1;
            },
        ...
        execute: function() {
            ...
            b2World = class b2World {
                ...
                constructor(gravity) {
                    ...
                    this.m_bodyCount = 0;
                    this.m_jointCount = 0;
                    this.m_gravity = new b2Math_186.b2Vec2();
                ...
                CreateBody(def) {
                    if (b2Settings_100.ENABLE_ASSERTS) {
                        b2Settings_100.b2Assert(this.IsLocked() === false);
                    }
                    if (this.IsLocked()) {
                        return null;
                    }
                ...
                DestroyBody(b) {
                    if (b2Settings_100.ENABLE_ASSERTS) {
                        b2Settings_100.b2Assert(this.m_bodyCount > 0);
                    }
                    if (b2Settings_100.ENABLE_ASSERTS) {
                        b2Settings_100.b2Assert(this.IsLocked() === false);
                    }
                ...
                DestroyJoint(j) {
                    ...
                    if (b2Settings_100.ENABLE_ASSERTS) {
                        b2Settings_100.b2Assert(this.m_jointCount > 0);
                    }
                    --this.m_jointCount;
                    // If the joint prevents collisions, then flag any contacts for filtering.
                ...
                QueryAABB(callback, aabb) {
                    ...
                    const WorldQueryWrapper = function (proxy) {
                        ...
                        if (b2Settings_100.ENABLE_ASSERTS) {
                            b2Settings_100.b2Assert(fixture_proxy instanceof b2Fixture_2.b2FixtureProxy);
                        }
                ...
                QueryPoint(callback, point) {
                    ...
                    aabb.lowerBound.SetXY(point.x - b2Settings_102.b2_linearSlop, point.y - b2Settings_102.b2_linearSlop);
                    aabb.upperBound.SetXY(point.x + b2Settings_102.b2_linearSlop, point.y + b2Settings_102.b2_linearSlop);
                    broadPhase.Query(WorldQueryWrapper, aabb);
                }
                ...
                Dump() {
                    if (b2Settings_100.DEBUG) {
                        if ((this.m_flags & 2 /* e_locked */) === 2 /* e_locked */) {
                            return;
                        }
                        b2Settings_100.b2Log("const g: b2Vec2 = new b2Vec2(%.15f, %.15f);\n", this.m_gravity.x, this.m_gravity.y);
                        b2Settings_100.b2Log("this.m_world.SetGravity(g);\n");
                        b2Settings_100.b2Log("const bodies: b2Body[] = new Array(%d);\n", this.m_bodyCount);
                        b2Settings_100.b2Log("const joints: b2Joint[] = new Array(%d);\n", this.m_jointCount);
                        let i = 0;
                        for (let b = this.m_bodyList; b; b = b.m_next) {
                            b.m_islandIndex = i;
                            b.Dump();
                        ...
                        case 0 /* e_circleShape */:
                            {
                                ...
                                const axis = b2Math_186.b2Vec2.UNITX;
                ...
                Solve(step) {
                    ...
                    for (let seed = this.m_bodyList; seed; seed = seed.m_next) {
                        ...
                        while (stackCount > 0) {
                            ...
                            if (b2Settings_100.ENABLE_ASSERTS) {
                                b2Settings_100.b2Assert(b.IsActive() === true);
                            }
                            island.AddBody(b);
                            ...
                            for (let ce = b.m_contactList; ce; ce = ce.next) {
                                ...
                                if (b2Settings_100.ENABLE_ASSERTS) {
                                    b2Settings_100.b2Assert(stackCount < stackSize);
                                }
                ...
                SolveTOI(step) {
                    ...
                    const island = this.m_island;
                    island.Initialize(2 * b2Settings_104.b2_maxTOIContacts, b2Settings_104.b2_maxTOIContacts, 0, null, this.m_contactManager.m_contactListener);
                    ...
                    for (;;) {
                        ...
                        for (let c = this.m_contactManager.m_contactList; c; c = c.m_next) {
                            ...
                            if (c.m_toiCount > b2Settings_103.b2_maxSubSteps) {
                                continue;
                            }
                            let alpha = 1;
                            if (c.m_flags & 32 /* e_toiFlag */) {
                                ...
                                if (b2Settings_100.ENABLE_ASSERTS) {
                                    b2Settings_100.b2Assert(typeA === 2 /* b2_dynamicBody */ || typeB === 2 /* b2_dynamicBody */);
                                }
                                ...
                                if (b2Settings_100.ENABLE_ASSERTS) {
                                    b2Settings_100.b2Assert(alpha0 < 1);
                                }
                                const indexA = c.GetChildIndexA();
                                const indexB = c.GetChildIndexB();
                                ...
                                if (output.state === 3 /* e_touching */) {
                                    alpha = b2Math_185.b2Min(alpha0 + (1 - alpha0) * beta, 1);
                                }
                                else {
                                    alpha = 1;
                                }
                        ...
                        if (minContact === null || 1 - 10 * b2Settings_101.b2_epsilon < minAlpha) {
            ...
            b2World.DrawDebugData_s_vs = b2Math_186.b2Vec2.MakeArray(4);
            b2World.DrawDebugData_s_xf = new b2Math_187.b2Transform();
            ...
            b2World.RayCast_s_point = new b2Math_186.b2Vec2();
            b2World.DrawJoint_s_p1 = new b2Math_186.b2Vec2();
            b2World.DrawJoint_s_p2 = new b2Math_186.b2Vec2();
            b2World.DrawJoint_s_color = new b2Draw_1.b2Color(0.5, 0.8, 0.8);
            b2World.SolveTOI_s_subStep = new b2TimeStep_6.b2TimeStep();
            b2World.SolveTOI_s_backup = new b2Math_188.b2Sweep();
            b2World.SolveTOI_s_backup1 = new b2Math_188.b2Sweep();
            b2World.SolveTOI_s_backup2 = new b2Math_188.b2Sweep();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2Body", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape", "Box2D/Dynamics/b2Fixture"], function(exports_50, context_50) {
    "use strict";
    var __moduleName = context_50 && context_50.id;
    var b2Settings_105, b2Math_189, b2Math_190, b2Math_191, b2Math_192, b2Math_193, b2Math_194, b2Math_195, b2Math_196, b2Math_197, b2Shape_6, b2Fixture_3;
    var b2BodyDef, b2Body;
    return {
        setters:[
            function (b2Settings_105_1) {
                b2Settings_105 = b2Settings_105_1;
            },
            function (b2Math_189_1) {
                b2Math_189 = b2Math_189_1;
                b2Math_190 = b2Math_189_1;
                b2Math_191 = b2Math_189_1;
                b2Math_192 = b2Math_189_1;
                b2Math_193 = b2Math_189_1;
                b2Math_194 = b2Math_189_1;
                b2Math_195 = b2Math_189_1;
                b2Math_196 = b2Math_189_1;
                b2Math_197 = b2Math_189_1;
            },
        ...
        execute: function() {
            ...
            b2BodyDef = class b2BodyDef {
                constructor() {
                    ...
                    this.position = new b2Math_190.b2Vec2(0, 0);
                    /// The world angle of the body in radians.
                    this.angle = 0;
                    /// The linear velocity of the body's origin in world co-ordinates.
                    this.linearVelocity = new b2Math_190.b2Vec2(0, 0);
            ...
            exports_50("b2BodyDef", b2BodyDef);
            ...
            b2Body = class b2Body {
                ...
                constructor(bd, world) {
                    ...
                    this.m_xf = new b2Math_195.b2Transform(); // the body origin transform
                    this.m_sweep = new b2Math_197.b2Sweep(); // the swept motion for CCD
                    this.m_linearVelocity = new b2Math_190.b2Vec2();
                    this.m_angularVelocity = 0;
                    this.m_force = new b2Math_190.b2Vec2;
                    this.m_torque = 0;
                    this.m_world = null;
                    this.m_prev = null;
                    this.m_next = null;
                    ...
                    this.m_sleepTime = 0;
                    this.m_userData = null;
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(bd.position.IsValid());
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(bd.linearVelocity.IsValid());
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(b2Math_189.b2IsValid(bd.angle));
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(b2Math_189.b2IsValid(bd.angularVelocity));
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(b2Math_189.b2IsValid(bd.gravityScale) && bd.gravityScale >= 0);
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(b2Math_189.b2IsValid(bd.angularDamping) && bd.angularDamping >= 0);
                    }
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(b2Math_189.b2IsValid(bd.linearDamping) && bd.linearDamping >= 0);
                    }
                    this.m_flags = 0 /* e_none */;
                    if (bd.bullet) {
                ...
                CreateFixture(def) {
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(this.m_world.IsLocked() === false);
                    }
                ...
                DestroyFixture(fixture) {
                    ...
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(fixture.m_body === this);
                    }
                    // Remove the fixture from this body's singly linked list.
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(this.m_fixtureCount > 0);
                    }
                ...
                SetTransformXYRadians(x, y, angle) {
                    ...
                    b2Math_196.b2MulXV(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c);
                ...
                GetInertia() {
                    return this.m_I + this.m_mass * b2Math_192.b2DotVV(this.m_sweep.localCenter, this.m_sweep.localCenter);
                }
                /// Get the mass data of the body.
                /// @return a struct containing the mass, inertia and center of the body.
                GetMassData(data) {
                    data.mass = this.m_mass;
                    data.I = this.m_I + this.m_mass * b2Math_192.b2DotVV(this.m_sweep.localCenter, this.m_sweep.localCenter);
                ...
                SetMassData(massData) {
                    ...
                    if (massData.I > 0 && (this.m_flags & 16 /* e_fixedRotationFlag */) === 0) {
                        this.m_I = massData.I - this.m_mass * b2Math_192.b2DotVV(massData.center, massData.center);
                        if (b2Settings_105.ENABLE_ASSERTS) {
                            b2Settings_105.b2Assert(this.m_I > 0);
                        }
                    ...
                    b2Math_193.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, b2Math_191.b2SubVV(this.m_sweep.c, oldCenter, b2Math_190.b2Vec2.s_t0), this.m_linearVelocity);
                }
                ResetMassData() {
                    ...
                    if (b2Settings_105.ENABLE_ASSERTS) {
                        b2Settings_105.b2Assert(this.m_type === 2 /* b2_dynamicBody */);
                    }
                    ...
                    if (this.m_I > 0 && (this.m_flags & 16 /* e_fixedRotationFlag */) === 0) {
                        ...
                        this.m_I -= this.m_mass * b2Math_192.b2DotVV(localCenter, localCenter);
                        if (b2Settings_105.ENABLE_ASSERTS) {
                            b2Settings_105.b2Assert(this.m_I > 0);
                        }
                        this.m_invI = 1 / this.m_I;
                ...
                GetWorldPoint(localPoint, out) {
                    return b2Math_196.b2MulXV(this.m_xf, localPoint, out);
                }
                /// Get the world coordinates of a vector given the local coordinates.
                /// @param localVector a vector fixed in the body.
                /// @return the same vector expressed in world coordinates.
                GetWorldVector(localVector, out) {
                    return b2Math_194.b2MulRV(this.m_xf.q, localVector, out);
                }
                /// Gets a local point relative to the body's origin given a world point.
                /// @param a point in world coordinates.
                /// @return the corresponding local point relative to the body's origin.
                GetLocalPoint(worldPoint, out) {
                    return b2Math_196.b2MulTXV(this.m_xf, worldPoint, out);
                }
                /// Gets a local vector given a world vector.
                /// @param a vector in world coordinates.
                /// @return the corresponding local vector.
                GetLocalVector(worldVector, out) {
                    return b2Math_194.b2MulTRV(this.m_xf.q, worldVector, out);
                }
                /// Get the world linear velocity of a world point attached to this body.
                /// @param a point in world coordinates.
                /// @return the world velocity of a point.
                GetLinearVelocityFromWorldPoint(worldPoint, out) {
                    return b2Math_193.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, b2Math_191.b2SubVV(worldPoint, this.m_sweep.c, b2Math_190.b2Vec2.s_t0), out);
                }
                ...
                Dump() {
                    if (b2Settings_105.DEBUG) {
                        const bodyIndex = this.m_islandIndex;
                        b2Settings_105.b2Log("{\n");
                        b2Settings_105.b2Log("  const bd: b2BodyDef = new b2BodyDef();\n");
                        let type_str = "";
                        switch (this.m_type) {
                            ...
                            default:
                                if (b2Settings_105.ENABLE_ASSERTS) {
                                    b2Settings_105.b2Assert(false);
                                }
                                break;
                        }
                        b2Settings_105.b2Log("  bd.type = %s;\n", type_str);
                        b2Settings_105.b2Log("  bd.position.SetXY(%.15f, %.15f);\n", this.m_xf.p.x, this.m_xf.p.y);
                        b2Settings_105.b2Log("  bd.angle = %.15f;\n", this.m_sweep.a);
                        b2Settings_105.b2Log("  bd.linearVelocity.SetXY(%.15f, %.15f);\n", this.m_linearVelocity.x, this.m_linearVelocity.y);
                        b2Settings_105.b2Log("  bd.angularVelocity = %.15f;\n", this.m_angularVelocity);
                        b2Settings_105.b2Log("  bd.linearDamping = %.15f;\n", this.m_linearDamping);
                        b2Settings_105.b2Log("  bd.angularDamping = %.15f;\n", this.m_angularDamping);
                        b2Settings_105.b2Log("  bd.allowSleep = %s;\n", (this.m_flags & 4 /* e_autoSleepFlag */) ? ("true") : ("false"));
                        b2Settings_105.b2Log("  bd.awake = %s;\n", (this.m_flags & 2 /* e_awakeFlag */) ? ("true") : ("false"));
                        b2Settings_105.b2Log("  bd.fixedRotation = %s;\n", (this.m_flags & 16 /* e_fixedRotationFlag */) ? ("true") : ("false"));
                        b2Settings_105.b2Log("  bd.bullet = %s;\n", (this.m_flags & 8 /* e_bulletFlag */) ? ("true") : ("false"));
                        b2Settings_105.b2Log("  bd.active = %s;\n", (this.m_flags & 32 /* e_activeFlag */) ? ("true") : ("false"));
                        b2Settings_105.b2Log("  bd.gravityScale = %.15f;\n", this.m_gravityScale);
                        b2Settings_105.b2Log("\n");
                        b2Settings_105.b2Log("  bodies[%d] = this.m_world.CreateBody(bd);\n", this.m_islandIndex);
                        b2Settings_105.b2Log("\n");
                        for (let f = this.m_fixtureList; f; f = f.m_next) {
                            b2Settings_105.b2Log("  {\n");
                            f.Dump(bodyIndex);
                ...
                SynchronizeFixtures() {
                    ...
                    b2Math_194.b2MulRV(xf1.q, this.m_sweep.localCenter, xf1.p);
                    b2Math_191.b2SubVV(this.m_sweep.c0, xf1.p, xf1.p);
                    const broadPhase = this.m_world.m_contactManager.m_broadPhase;
                    for (let f = this.m_fixtureList; f; f = f.m_next) {
                ...
                SynchronizeTransform() {
                    ...
                    b2Math_194.b2MulRV(this.m_xf.q, this.m_sweep.localCenter, this.m_xf.p);
                    b2Math_191.b2SubVV(this.m_sweep.c, this.m_xf.p, this.m_xf.p);
                }
            ...
            b2Body.SetMassData_s_oldCenter = new b2Math_190.b2Vec2();
            /// This resets the mass properties to the sum of the mass properties of the fixtures.
            /// This normally does not need to be called unless you called SetMassData to override
            /// the mass and you later want to reset the mass.
            b2Body.ResetMassData_s_localCenter = new b2Math_190.b2Vec2();
            b2Body.ResetMassData_s_oldCenter = new b2Math_190.b2Vec2();
            b2Body.ResetMassData_s_massData = new b2Shape_6.b2MassData();
            b2Body.SynchronizeFixtures_s_xf1 = new b2Math_195.b2Transform();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2Fixture", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Collision/Shapes/b2Shape"], function(exports_51, context_51) {
    "use strict";
    var __moduleName = context_51 && context_51.id;
    var b2Settings_106, b2Settings_107, b2Math_198, b2Math_199, b2Collision_13, b2Shape_7;
    var b2Filter, b2FixtureDef, b2FixtureProxy, b2Fixture;
    return {
        setters:[
            function (b2Settings_106_1) {
                b2Settings_106 = b2Settings_106_1;
                b2Settings_107 = b2Settings_106_1;
            },
            function (b2Math_198_1) {
                b2Math_198 = b2Math_198_1;
                b2Math_199 = b2Math_198_1;
            },
        ...
        execute: function() {
            ...
            exports_51("b2FixtureDef", b2FixtureDef);
            /// This proxy is used internally to connect fixtures to the broad-phase.
            b2FixtureProxy = class b2FixtureProxy {
                constructor() {
                    this.aabb = new b2Collision_13.b2AABB();
                    this.fixture = null;
                    this.childIndex = 0;
                    this.proxy = null;
                }
                static MakeArray(length) {
                    return b2Settings_107.b2MakeArray(length, function (i) { return new b2FixtureProxy(); });
                }
            };
            exports_51("b2FixtureProxy", b2FixtureProxy);
            ...
            b2Fixture = class b2Fixture {
                ...
                /// the body transform.
                GetAABB(childIndex) {
                    if (b2Settings_106.ENABLE_ASSERTS) {
                        b2Settings_106.b2Assert(0 <= childIndex && childIndex < this.m_proxyCount);
                    }
                    return this.m_proxies[childIndex].aabb;
                }
                /// Dump this fixture to the log file.
                Dump(bodyIndex) {
                    if (b2Settings_106.DEBUG) {
                        b2Settings_106.b2Log("    const fd: b2FixtureDef = new b2FixtureDef();\n");
                        b2Settings_106.b2Log("    fd.friction = %.15f;\n", this.m_friction);
                        b2Settings_106.b2Log("    fd.restitution = %.15f;\n", this.m_restitution);
                        b2Settings_106.b2Log("    fd.density = %.15f;\n", this.m_density);
                        b2Settings_106.b2Log("    fd.isSensor = %s;\n", (this.m_isSensor) ? ("true") : ("false"));
                        b2Settings_106.b2Log("    fd.filter.categoryBits = %d;\n", this.m_filter.categoryBits);
                        b2Settings_106.b2Log("    fd.filter.maskBits = %d;\n", this.m_filter.maskBits);
                        b2Settings_106.b2Log("    fd.filter.groupIndex = %d;\n", this.m_filter.groupIndex);
                        this.m_shape.Dump();
                        ...
                        //        return;
                        //      }
                        b2Settings_106.b2Log("\n");
                        b2Settings_106.b2Log("    fd.shape = shape;\n");
                        b2Settings_106.b2Log("\n");
                        b2Settings_106.b2Log("    bodies[%d].CreateFixture(fd);\n", bodyIndex);
                    }
                }
                ...
                Destroy() {
                    ...
                    if (b2Settings_106.ENABLE_ASSERTS) {
                        b2Settings_106.b2Assert(this.m_proxyCount === 0);
                    }
                ...
                Synchronize(broadPhase, transform1, transform2) {
                    ...
                    for (let i = 0; i < this.m_proxyCount; ++i) {
                        ...
                        const displacement = b2Math_199.b2SubVV(transform2.p, transform1.p, b2Fixture.Synchronize_s_displacement);
            ...
            b2Fixture.Synchronize_s_displacement = new b2Math_198.b2Vec2();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Rope/b2Rope", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Draw"], function(exports_52, context_52) {
    "use strict";
    var __moduleName = context_52 && context_52.id;
    var b2Settings_108, b2Settings_109, b2Settings_110, b2Math_200, b2Math_201, b2Math_202, b2Math_203, b2Math_204, b2Draw_2;
    var b2RopeDef, b2Rope;
    return {
        setters:[
            function (b2Settings_108_1) {
                b2Settings_108 = b2Settings_108_1;
                b2Settings_109 = b2Settings_108_1;
                b2Settings_110 = b2Settings_108_1;
            },
            function (b2Math_200_1) {
                b2Math_200 = b2Math_200_1;
                b2Math_201 = b2Math_200_1;
                b2Math_202 = b2Math_200_1;
                b2Math_203 = b2Math_200_1;
                b2Math_204 = b2Math_200_1;
            },
            function (b2Draw_2_1) {
                b2Draw_2 = b2Draw_2_1;
            }],
        execute: function() {
            ...
            b2RopeDef = class b2RopeDef {
                constructor() {
                    ...
                    ///
                    this.gravity = new b2Math_201.b2Vec2(0, 0);
                    ///
                    this.damping = 0.1;
            ...
            b2Rope = class b2Rope {
                constructor() {
                    ...
                    this.m_Ls = null;
                    this.m_as = null;
                    this.m_gravity = new b2Math_201.b2Vec2();
                    this.m_damping = 0;
                    this.m_k2 = 1;
                    this.m_k3 = 0.1;
                }
                ...
                ///
                Initialize(def) {
                    if (b2Settings_108.ENABLE_ASSERTS) {
                        b2Settings_108.b2Assert(def.count >= 3);
                    }
                    this.m_count = def.count;
                    // this.m_ps = (b2Vec2*)b2Alloc(this.m_count * sizeof(b2Vec2));
                    this.m_ps = b2Math_201.b2Vec2.MakeArray(this.m_count);
                    // this.m_p0s = (b2Vec2*)b2Alloc(this.m_count * sizeof(b2Vec2));
                    this.m_p0s = b2Math_201.b2Vec2.MakeArray(this.m_count);
                    // this.m_vs = (b2Vec2*)b2Alloc(this.m_count * sizeof(b2Vec2));
                    this.m_vs = b2Math_201.b2Vec2.MakeArray(this.m_count);
                    // this.m_ims = (float32*)b2Alloc(this.m_count * sizeof(float32));
                    this.m_ims = b2Settings_110.b2MakeNumberArray(this.m_count);
                    for (let i = 0; i < this.m_count; ++i) {
                    ...
                    this.m_Ls = b2Settings_110.b2MakeNumberArray(count2);
                    // this.m_as = (float32*)b2Alloc(count3 * sizeof(float32));
                    this.m_as = b2Settings_110.b2MakeNumberArray(count3);
                    for (let i = 0; i < count2; ++i) {
                        const p1 = this.m_ps[i];
                        const p2 = this.m_ps[i + 1];
                        this.m_Ls[i] = b2Math_202.b2DistanceVV(p1, p2);
                    }
                    for (let i = 0; i < count3; ++i) {
                        const p1 = this.m_ps[i];
                        const p2 = this.m_ps[i + 1];
                        const p3 = this.m_ps[i + 2];
                        const d1 = b2Math_203.b2SubVV(p2, p1, b2Math_201.b2Vec2.s_t0);
                        const d2 = b2Math_203.b2SubVV(p3, p2, b2Math_201.b2Vec2.s_t1);
                        const a = b2Math_204.b2CrossVV(d1, d2);
                        const b = b2Math_204.b2DotVV(d1, d2);
                        this.m_as[i] = b2Math_200.b2Atan2(a, b);
                    }
                ...
                Step(h, iterations) {
                    ...
                    const inv_h = 1 / h;
                    for (let i = 0; i < this.m_count; ++i) {
                        b2Math_203.b2MulSV(inv_h, b2Math_203.b2SubVV(this.m_ps[i], this.m_p0s[i], b2Math_201.b2Vec2.s_t0), this.m_vs[i]);
                    }
                }
                SolveC2() {
                    const count2 = this.m_count - 1;
                    for (let i = 0; i < count2; ++i) {
                        const p1 = this.m_ps[i];
                        const p2 = this.m_ps[i + 1];
                        const d = b2Math_203.b2SubVV(p2, p1, b2Rope.s_d);
                        const L = d.Normalize();
                ...
                SolveC3() {
                    ...
                    for (let i = 0; i < count3; ++i) {
                        ...
                        const d1 = b2Math_203.b2SubVV(p2, p1, b2Rope.s_d1);
                        const d2 = b2Math_203.b2SubVV(p3, p2, b2Rope.s_d2);
                        ...
                        const a = b2Math_204.b2CrossVV(d1, d2);
                        const b = b2Math_204.b2DotVV(d1, d2);
                        let angle = b2Math_200.b2Atan2(a, b);
                        const Jd1 = b2Math_203.b2MulSV((-1 / L1sqr), d1.SelfSkew(), b2Rope.s_Jd1);
                        const Jd2 = b2Math_203.b2MulSV((1 / L2sqr), d2.SelfSkew(), b2Rope.s_Jd2);
                        const J1 = b2Math_203.b2NegV(Jd1, b2Rope.s_J1);
                        const J2 = b2Math_203.b2SubVV(Jd1, Jd2, b2Rope.s_J2);
                        const J3 = Jd2;
                        let mass = m1 * b2Math_204.b2DotVV(J1, J1) + m2 * b2Math_204.b2DotVV(J2, J2) + m3 * b2Math_204.b2DotVV(J3, J3);
                        if (mass === 0) {
                            continue;
                        }
                        mass = 1 / mass;
                        let C = angle - this.m_as[i];
                        while (C > b2Settings_109.b2_pi) {
                            angle -= 2 * b2Settings_109.b2_pi;
                            C = angle - this.m_as[i];
                        }
                        while (C < -b2Settings_109.b2_pi) {
                            angle += 2 * b2Settings_109.b2_pi;
                ...
                Draw(draw) {
                    const c = new b2Draw_2.b2Color(0.4, 0.5, 0.7);
            ...
            ///
            b2Rope.s_d = new b2Math_201.b2Vec2();
            b2Rope.s_d1 = new b2Math_201.b2Vec2();
            b2Rope.s_d2 = new b2Math_201.b2Vec2();
            b2Rope.s_Jd1 = new b2Math_201.b2Vec2();
            b2Rope.s_Jd2 = new b2Math_201.b2Vec2();
            b2Rope.s_J1 = new b2Math_201.b2Vec2();
            b2Rope.s_J2 = new b2Math_201.b2Vec2();
...
System.register("Box2D/Box2D", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Draw", "Box2D/Common/b2Timer", "Box2D/Common/b2GrowableStack", "Box2D/Common/b2BlockAllocator", "Box2D/Common/b2StackAllocator", "Box2D/Collision/b2Collision", "Box2D/Collision/b2Distance", "Box2D/Collision/b2BroadPhase", "Box2D/Collision/b2DynamicTree", "Box2D/Collision/b2TimeOfImpact", "Box2D/Collision/b2CollideCircle", "Box2D/Collision/b2CollidePolygon", "Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2Shape", "Box2D/Collision/Shapes/b2CircleShape", "Box2D/Collision/Shapes/b2PolygonShape", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Collision/Shapes/b2ChainShape", "Box2D/Dynamics/b2Fixture", "Box2D/Dynamics/b2Body", "Box2D/Dynamics/b2World", "Box2D/Dynamics/b2WorldCallbacks", "Box2D/Dynamics/b2Island", "Box2D/Dynamics/b2TimeStep", "Box2D/Dynamics/b2ContactManager", "Box2D/Dynamics/Contacts/b2Contact", "Box2D/Dynamics/Contacts/b2ContactFactory", "Box2D/Dynamics/Contacts/b2ContactSolver", "Box2D/Dynamics/Contacts/b2CircleContact", "Box2D/Dynamics/Contacts/b2PolygonContact", "Box2D/Dynamics/Contacts/b2PolygonAndCircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndCircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact", "Box2D/Dynamics/Contacts/b2ChainAndCircleContact", "Box2D/Dynamics/Contacts/b2ChainAndPolygonContact", "Box2D/Dynamics/Joints/b2Joint", "Box2D/Dynamics/Joints/b2JointFactory", "Box2D/Dynamics/Joints/b2AreaJoint", "Box2D/Dynamics/Joints/b2DistanceJoint", "Box2D/Dynamics/Joints/b2FrictionJoint", "Box2D/Dynamics/Joints/b2GearJoint", "Box2D/Dynamics/Joints/b2MotorJoint", "Box2D/Dynamics/Joints/b2MouseJoint", "Box2D/Dynamics/Joints/b2PrismaticJoint", "Box2D/Dynamics/Joints/b2PulleyJoint", "Box2D/Dynamics/Joints/b2RevoluteJoint", "Box2D/Dynamics/Joints/b2RopeJoint", "Box2D/Dynamics/Joints/b2WeldJoint", "Box2D/Dynamics/Joints/b2WheelJoint", "Box2D/Rope/b2Rope"], function(exports_53, context_53) {
    ...
    return {
        setters:[
            function (b2Settings_111_1) {
                exportStar_1(b2Settings_111_1);
            },
            function (b2Math_205_1) {
                exportStar_1(b2Math_205_1);
            },
            function (b2Draw_3_1) {
                exportStar_1(b2Draw_3_1);
            },
            ...
            function (b2TimeOfImpact_7_1) {
                exportStar_1(b2TimeOfImpact_7_1);
            },
            ...
            function (b2TimeStep_7_1) {
                exportStar_1(b2TimeStep_7_1);
            },
...
System.register("Testbed/Framework/Main", ["Box2D/Box2D", "Testbed/Testbed"], function(exports_54, context_54) {
    "use strict";
        ...
        execute: function() {
            Main = class Main {
                constructor() {
                    ...
                    for (let i = 0; i < this.m_test_entries.length; ++i) {
                ...
                HandleMouseMove(e) {
                    ...
                    const world = this.ConvertElementToWorld(element, new box2d.b2Vec2());
                    ...
                    if (this.m_rMouseDown) {
                        ...
                        const diff = box2d.b2SubVV(projection, this.m_projection0, new box2d.b2Vec2());
                        const viewCenter = box2d.b2SubVV(this.m_viewCenter0, diff, new box2d.b2Vec2());
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Testbed/Framework/Render", ["Box2D/Box2D"], function(exports_55, context_55) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_55("DebugDraw", DebugDraw);
        }
    }
});
System.register("Testbed/Framework/Test", ["Box2D/Box2D", "Testbed/Testbed"], function(exports_56, context_56) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            exports_56("DRAW_STRING_NEW_LINE", DRAW_STRING_NEW_LINE = 25);
            ...
            exports_56("TestEntry", TestEntry);
            ...
            exports_56("DestructionListener", DestructionListener);
            ...
            exports_56("ContactPoint", ContactPoint);
            Test = class Test extends box2d.b2ContactListener {
                constructor(canvas, settings) {
                    ...
                    for (let i = 0; i < Test.k_maxContactPoints; ++i) {
                ...
                CompleteBombSpawn(p) {
                    ...
                    const multiplier = 30;
                    const vel = box2d.b2SubVV(this.m_bombSpawnPoint, p, new box2d.b2Vec2());
                ...
                LaunchBomb() {
                    ...
                    const v = box2d.b2MulSV(-5, p, new box2d.b2Vec2());
                    ...
                    if (settings.drawContactPoints) {
                        ...
                        for (let i = 0; i < this.m_pointCount; ++i) {
                            ...
                            if (settings.drawContactNormals) {
                                ...
                                const p2 = box2d.b2AddVV(p1, box2d.b2MulSV(k_axisScale, point.normal, box2d.b2Vec2.s_t0), new box2d.b2Vec2());
                                this.m_debugDraw.DrawSegment(p1, p2, new box2d.b2Color(0.9, 0.9, 0.9));
                            }
                            else if (settings.drawContactImpulse) {
                                const p1 = point.position;
                                const p2 = box2d.b2AddVMulSV(p1, k_impulseScale * point.normalImpulse, point.normal, new box2d.b2Vec2());
                                this.m_debugDraw.DrawSegment(p1, p2, new box2d.b2Color(0.9, 0.9, 0.3));
                            }
                            if (settings.drawFrictionImpulse) {
                                const tangent = box2d.b2CrossVOne(point.normal, new box2d.b2Vec2());
                                const p1 = point.position;
                                const p2 = box2d.b2AddVMulSV(p1, k_impulseScale * point.tangentImpulse, tangent, new box2d.b2Vec2());
                                this.m_debugDraw.DrawSegment(p1, p2, new box2d.b2Color(0.9, 0.9, 0.3));
                            }
                        }
                    }
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Testbed/Tests/Car", ["Box2D/Box2D", "Testbed/Testbed"], function(exports_57, context_57) {
    "use strict";
            ...
            Car = class Car extends testbed.Test {
                constructor(canvas, settings) {
                    ...
                    if (true) {
                        ...
                        const edge_shape = new box2d.b2EdgeShape();
                        const fd = new box2d.b2FixtureDef();
                        fd.shape = edge_shape;
                        fd.density = 0.0;
                        fd.friction = 0.6;
                    ...
                    if (true) {
                        ...
                        const wjd = new box2d.b2WheelJointDef();
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Testbed/Tests/SphereStack", ["Box2D/Box2D", "Testbed/Testbed"], function(exports_58, context_58) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_58("SphereStack", SphereStack);
        }
    }
});
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Testbed/Tests/TestEntries", ["Testbed/Testbed", "Testbed/Tests/Car", "Testbed/Tests/SphereStack"], function(exports_59, context_59) {
    "use strict";
    var __moduleName = context_59 && context_59.id;
    var testbed, Car_1, SphereStack_1;
    ...
    function GetTestEntries(entries) {
        ...
        entries.push(new testbed.TestEntry("Car", Car_1.Car.Create));
        ...
        entries.push(new testbed.TestEntry("SphereStack", SphereStack_1.SphereStack.Create));
    ...
    exports_59("GetTestEntries", GetTestEntries);
    return {
        setters:[
            function (testbed_5) {
                testbed = testbed_5;
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Testbed/Testbed", ["Testbed/Framework/Main", "Testbed/Framework/Render", "Testbed/Framework/Test", "Testbed/Tests/TestEntries"], function(exports_60, context_60) {
    "use strict";
    ...
    return {
        setters:[
            function (Main_1_1) {
                exportStar_2(Main_1_1);
            },
            function (Render_1_1) {
                exportStar_2(Render_1_1);
            },
            function (Test_1_1) {
                exportStar_2(Test_1_1);
            },
            function (TestEntries_1_1) {
                exportStar_2(TestEntries_1_1);
            }],
        execute: function() {
        }
    }
