    ...
    function b2Distance(output, cache, input) {
        ...
        while (iter < k_maxIters) {
            ...
            */
            ...
            if (d.GetLengthSquared() < b2Settings_2.b2_epsilon_sq) {
    ...
    return {
        ...
        execute: function() {
            ...
            b2Manifold = class b2Manifold {
                ...
                Reset() {
                    for (let i = 0, ict = b2Settings_3.b2_maxManifoldPoints; i < ict; ++i) {
...
System.register("Box2D/Collision/b2CollideCircle", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math"], function(exports_14, context_14) {
    ...
    function b2CollidePolygonAndCircle(manifold, polygonA, xfA, circleB, xfB) {
        ...
        let normalIndex = 0;
        let separation = (-b2Settings_6.b2_maxFloat);
        ...
        if (separation < b2Settings_6.b2_epsilon) {
            manifold.pointCount = 1;
...
System.register("Box2D/Collision/b2CollidePolygon", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision"], function(exports_15, context_15) {
    ...
    var b2Settings_7, b2Math_8, b2Collision_3;
    ...
    function b2EdgeSeparation(poly1, xf1, edge1, poly2, xf2) {
        ...
        let index = 0;
        let minDot = b2Settings_7.b2_maxFloat;
    ...
    function b2FindMaxSeparation(edgeIndex, poly1, xf1, poly2, xf2) {
        ...
        let edge = 0;
        let maxDot = (-b2Settings_7.b2_maxFloat);
    ...
    function b2CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
        ...
        let pointCount = 0;
        for (let i = 0; i < b2Settings_7.b2_maxManifoldPoints; ++i) {
    ...
    return {
        ...
        execute: function() {
            ...
            b2CollidePolygons_s_edgeA = b2Settings_7.b2MakeNumberArray(1);
            b2CollidePolygons_s_edgeB = b2Settings_7.b2MakeNumberArray(1);
...
System.register("Box2D/Collision/b2CollideEdge", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision"], function(exports_16, context_16) {
    ...
    var b2Settings_8, b2Math_9, b2Collision_4, b2Collision_5;
    ...
    return {
        ...
        execute: function() {
            ...
            b2TempPolygon = class b2TempPolygon {
                constructor() {
                    this.vertices = b2Math_9.b2Vec2.MakeArray(b2Settings_8.b2_maxPolygonVertices);
                    this.normals = b2Math_9.b2Vec2.MakeArray(b2Settings_8.b2_maxPolygonVertices);
                    this.count = 0;
                }
            };
            ...
            b2EPCollider = class b2EPCollider {
                ...
                Collide(manifold, edgeA, xfA, polygonB, xfB) {
                    ...
                    this.m_radius = 2 * b2Settings_8.b2_polygonRadius;
                    manifold.pointCount = 0;
                    ...
                    if (np < b2Settings_8.b2_maxManifoldPoints) {
                        return;
                    }
                    // Clip to negative box side 1
                    ...
                    let pointCount = 0;
                    for (let i = 0, ict = b2Settings_8.b2_maxManifoldPoints; i < ict; ++i) {
                        let separation;
                ...
                ComputeEdgeSeparation(out) {
                    ...
                    axis.separation = b2Settings_8.b2_maxFloat;
                ...
                ComputePolygonSeparation(out) {
                    ...
                    for (let i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
                        ...
                        if (b2Math_9.b2Vec2.DotVV(n, perp) >= 0) {
                            if (b2Math_9.b2Vec2.DotVV(b2Math_9.b2Vec2.SubVV(n, this.m_upperLimit, b2Math_9.b2Vec2.s_t0), this.m_normal) < -b2Settings_8.b2_angularSlop) {
                                continue;
                            }
                        }
                        else {
                            if (b2Math_9.b2Vec2.DotVV(b2Math_9.b2Vec2.SubVV(n, this.m_lowerLimit, b2Math_9.b2Vec2.s_t0), this.m_normal) < -b2Settings_8.b2_angularSlop) {
                                continue;
                            }
                        }
                        if (s > axis.separation) {
...
System.register("Box2D/Collision/Shapes/b2CircleShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape"], function(exports_17, context_17) {
    ...
    var b2Settings_9, b2Math_10, b2Shape_1;
    var b2CircleShape;
    return {
        setters:[
        ...
        execute: function() {
            ...
            b2CircleShape = class b2CircleShape extends b2Shape_1.b2Shape {
                ...
                RayCast(output, input, transform, childIndex) {
                    ...
                    if (sigma < 0 || rr < b2Settings_9.b2_epsilon) {
                        return false;
                    }
                ...
                ComputeMass(massData, density) {
                    ...
                    massData.mass = density * b2Settings_9.b2_pi * radius_sq;
                ...
                ComputeSubmergedArea(normal, offset, xf, c) {
                    ...
                    if (l < (-this.m_radius) + b2Settings_9.b2_epsilon) {
                        // Completely dry
                        return 0;
                    }
                    if (l > this.m_radius) {
                        // Completely wet
                        c.Copy(p);
                        return b2Settings_9.b2_pi * this.m_radius * this.m_radius;
                    }
                    // Magic
                    const r2 = this.m_radius * this.m_radius;
                    const l2 = l * l;
                    const area = r2 * (b2Math_10.b2Asin(l / this.m_radius) + b2Settings_9.b2_pi / 2) + l * b2Math_10.b2Sqrt(r2 - l2);
...
System.register("Box2D/Collision/Shapes/b2PolygonShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape"], function(exports_18, context_18) {
    ...
    var b2Settings_10, b2Math_11, b2Shape_2, b2Shape_3;
    var b2PolygonShape;
    return {
        setters:[
        ...
        execute: function() {
            ...
            b2PolygonShape = class b2PolygonShape extends b2Shape_3.b2Shape {
                constructor() {
                    super(2 /* e_polygonShape */, b2Settings_10.b2_polygonRadius);
                    this.m_centroid = new b2Math_11.b2Vec2(0, 0);
                    this.m_vertices = b2Math_11.b2Vec2.MakeArray(b2Settings_10.b2_maxPolygonVertices);
                    this.m_normals = b2Math_11.b2Vec2.MakeArray(b2Settings_10.b2_maxPolygonVertices);
                    this.m_count = 0;
                }
                /// Implement b2Shape.
                Clone() {
                ...
                SetAsVector(vertices, count) {
                    ...
                    const n = b2Math_11.b2Min(count, b2Settings_10.b2_maxPolygonVertices);
                    ...
                    for (let i = 0, ict = m; i < ict; ++i) {
                        ...
                        ///b2Assert(edge.GetLengthSquared() > b2_epsilon_sq);
                ...
                ComputeSubmergedArea(normal, offset, xf, c) {
                    ...
                    for (let i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        const isSubmerged = depths[i] < (-b2Settings_10.b2_epsilon);
                        if (i > 0) {
                            if (isSubmerged) {
                                if (!lastSubmerged) {
                                    intoIndex = i - 1;
            ...
            b2PolygonShape.SetAsVector_s_ps = b2Math_11.b2Vec2.MakeArray(b2Settings_10.b2_maxPolygonVertices);
            b2PolygonShape.SetAsVector_s_hull = b2Settings_10.b2MakeNumberArray(b2Settings_10.b2_maxPolygonVertices);
            ...
            b2PolygonShape.ComputeSubmergedArea_s_depths = b2Settings_10.b2MakeNumberArray(b2Settings_10.b2_maxPolygonVertices);
    ...
    return {
        ...
        execute: function() {
            ...
            b2EdgeShape = class b2EdgeShape extends b2Shape_4.b2Shape {
                constructor() {
                    super(1 /* e_edgeShape */, b2Settings_11.b2_polygonRadius);
...
System.register("Box2D/Collision/Shapes/b2ChainShape", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape", "Box2D/Collision/Shapes/b2EdgeShape"], function(exports_20, context_20) {
    ...
    var b2Settings_12, b2Math_13, b2Shape_5, b2EdgeShape_1;
    var b2ChainShape;
    return {
        setters:[
        ...
        execute: function() {
            ...
            b2ChainShape = class b2ChainShape extends b2Shape_5.b2Shape {
                constructor() {
                    super(3 /* e_chainShape */, b2Settings_12.b2_polygonRadius);
                    this.m_vertices = null;
                    this.m_count = 0;
    ...
    return {
        ...
        execute: function() {
            ...
            b2Position = class b2Position {
                ...
                static MakeArray(length) {
                    return b2Settings_13.b2MakeArray(length, function (i) { return new b2Position(); });
                }
            };
            ...
            b2Velocity = class b2Velocity {
                ...
                static MakeArray(length) {
                    return b2Settings_13.b2MakeArray(length, function (i) { return new b2Velocity(); });
                }
            };
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2Joint", ["Box2D/Common/b2Math"], function(exports_22, context_22) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            b2ContactImpulse = class b2ContactImpulse {
                constructor() {
                    this.normalImpulses = b2Settings_14.b2MakeNumberArray(b2Settings_14.b2_maxManifoldPoints);
                    this.tangentImpulses = b2Settings_14.b2MakeNumberArray(b2Settings_14.b2_maxManifoldPoints);
                    this.count = 0;
                }
            };
...
System.register("Box2D/Dynamics/Contacts/b2Contact", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Collision/b2TimeOfImpact"], function(exports_24, context_24) {
    ...
    var b2Settings_15, b2Math_16, b2Collision_6, b2Collision_7, b2TimeOfImpact_1, b2TimeOfImpact_2, b2TimeOfImpact_3;
        ...
        execute: function() {
            ...
            b2Contact = class b2Contact {
                ...
                ComputeTOI(sweepA, sweepB) {
                    ...
                    input.tMax = b2Settings_15.b2_linearSlop;
...
System.register("Box2D/Dynamics/Joints/b2DistanceJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_25, context_25) {
    ...
    var b2Settings_16, b2Math_17, b2Joint_1;
        ...
        execute: function() {
            ...
            b2DistanceJoint = class b2DistanceJoint extends b2Joint_1.b2Joint {
                ...
                InitVelocityConstraints(data) {
                    ...
                    if (length > b2Settings_16.b2_linearSlop) {
                    ...
                    if (this.m_frequencyHz > 0) {
                        ...
                        // Frequency
                        const omega = 2 * b2Settings_16.b2_pi * this.m_frequencyHz;
                        // Damping coefficient
                ...
                SolvePositionConstraints(data) {
                    ...
                    C = b2Math_17.b2Clamp(C, (-b2Settings_16.b2_maxLinearCorrection), b2Settings_16.b2_maxLinearCorrection);
                    ...
                    return b2Math_17.b2Abs(C) < b2Settings_16.b2_linearSlop;
                }
            };
...
System.register("Box2D/Dynamics/Joints/b2AreaJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint", "Box2D/Dynamics/Joints/b2DistanceJoint"], function(exports_26, context_26) {
    ...
    var b2Settings_17, b2Math_18, b2Joint_2, b2DistanceJoint_1;
        ...
        execute: function() {
            ...
            b2AreaJoint = class b2AreaJoint extends b2Joint_2.b2Joint {
                constructor(def) {
                    ...
                    this.m_frequencyHz = def.frequencyHz;
                    this.m_dampingRatio = def.dampingRatio;
                    this.m_targetLengths = b2Settings_17.b2MakeNumberArray(def.bodies.length);
                ...
                SolvePositionConstraints(data) {
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        if (dist < b2Settings_17.b2_epsilon) {
                            dist = 1;
                        }
                    ...
                    for (let i = 0, ict = this.m_bodies.length; i < ict; ++i) {
                        ...
                        if (norm_sq > b2Math_18.b2Sq(b2Settings_17.b2_maxLinearCorrection)) {
                            delta.SelfMul(b2Settings_17.b2_maxLinearCorrection / b2Math_18.b2Sqrt(norm_sq));
                        }
                        if (norm_sq > b2Math_18.b2Sq(b2Settings_17.b2_linearSlop)) {
                            done = false;
                        }
                        body_c.x += delta.x;
                        body_c.y += delta.y;
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Joints/b2FrictionJoint", ["Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_27, context_27) {
    "use strict";
    var __moduleName = context_27 && context_27.id;
    var b2Math_19, b2Joint_3;
...
System.register("Box2D/Dynamics/Joints/b2PrismaticJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_28, context_28) {
    ...
    var b2Settings_18, b2Math_20, b2Joint_4;
            ...
            b2PrismaticJoint = class b2PrismaticJoint extends b2Joint_4.b2Joint {
                ...
                InitVelocityConstraints(data) {
                    ...
                    if (this.m_enableLimit) {
                        ...
                        if (b2Math_20.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings_18.b2_linearSlop) {
                ...
                SolvePositionConstraints(data) {
                    ...
                    if (this.m_enableLimit) {
                        ...
                        if (b2Math_20.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings_18.b2_linearSlop) {
                            ...
                            C2 = b2Math_20.b2Clamp(translation, (-b2Settings_18.b2_maxLinearCorrection), b2Settings_18.b2_maxLinearCorrection);
                            linearError = b2Math_20.b2Max(linearError, b2Math_20.b2Abs(translation));
                            active = true;
                        }
                        else if (translation <= this.m_lowerTranslation) {
                            // Prevent large linear corrections and allow some slop.
                            C2 = b2Math_20.b2Clamp(translation - this.m_lowerTranslation + b2Settings_18.b2_linearSlop, (-b2Settings_18.b2_maxLinearCorrection), 0);
                            linearError = b2Math_20.b2Max(linearError, this.m_lowerTranslation - translation);
                            active = true;
                        }
                        else if (translation >= this.m_upperTranslation) {
                            // Prevent large linear corrections and allow some slop.
                            C2 = b2Math_20.b2Clamp(translation - this.m_upperTranslation - b2Settings_18.b2_linearSlop, 0, b2Settings_18.b2_maxLinearCorrection);
                    ...
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return linearError <= b2Settings_18.b2_linearSlop && angularError <= b2Settings_18.b2_angularSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
...
System.register("Box2D/Dynamics/Joints/b2RevoluteJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_29, context_29) {
    ...
    var b2Settings_19, b2Math_21, b2Joint_5;
            ...
            b2RevoluteJoint = class b2RevoluteJoint extends b2Joint_5.b2Joint {
                ...
                InitVelocityConstraints(data) {
                    ...
                    if (this.m_enableLimit && fixedRotation === false) {
                        ...
                        if (b2Math_21.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * b2Settings_19.b2_angularSlop) {
                            this.m_limitState = 3 /* e_equalLimits */;
                        }
                ...
                SolvePositionConstraints(data) {
                    ...
                    if (this.m_enableLimit && this.m_limitState !== 0 /* e_inactiveLimit */ && fixedRotation === false) {
                        ...
                        if (this.m_limitState === 3 /* e_equalLimits */) {
                            // Prevent large angular corrections
                            const C = b2Math_21.b2Clamp(angle - this.m_lowerAngle, -b2Settings_19.b2_maxAngularCorrection, b2Settings_19.b2_maxAngularCorrection);
                            ...
                            C = b2Math_21.b2Clamp(C + b2Settings_19.b2_angularSlop, -b2Settings_19.b2_maxAngularCorrection, 0);
                            limitImpulse = -this.m_motorMass * C;
                        }
                        else if (this.m_limitState === 2 /* e_atUpperLimit */) {
                            ...
                            angularError = C;
                            // Prevent large angular corrections and allow some slop.
                            C = b2Math_21.b2Clamp(C - b2Settings_19.b2_angularSlop, 0, b2Settings_19.b2_maxAngularCorrection);
                            limitImpulse = -this.m_motorMass * C;
                        }
                    ...
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return positionError <= b2Settings_19.b2_linearSlop && angularError <= b2Settings_19.b2_angularSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
...
System.register("Box2D/Dynamics/Joints/b2GearJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_30, context_30) {
    ...
    var b2Settings_20, b2Math_22, b2Joint_6;
        ...
        execute: function() {
            ...
            b2GearJoint = class b2GearJoint extends b2Joint_6.b2Joint {
                ...
                SolvePositionConstraints(data) {
                    ...
                    return linearError < b2Settings_20.b2_linearSlop;
                }
                GetAnchorA(out) {
                    return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, out);
                }
...
System.register("Box2D/Dynamics/Joints/b2MotorJoint", ["Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_31, context_31) {
    "use strict";
    var __moduleName = context_31 && context_31.id;
    var b2Math_23, b2Joint_7;
...
System.register("Box2D/Dynamics/Joints/b2MouseJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_32, context_32) {
    ...
    var b2Settings_21, b2Math_24, b2Joint_8;
...
System.register("Box2D/Dynamics/Joints/b2PulleyJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_33, context_33) {
    ...
    var b2Settings_22, b2Math_25, b2Joint_9;
...
System.register("Box2D/Dynamics/Joints/b2RopeJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_34, context_34) {
    ...
    var b2Settings_23, b2Math_26, b2Joint_10;
        ...
        execute: function() {
            ...
            b2RopeJoint = class b2RopeJoint extends b2Joint_10.b2Joint {
                ...
                SolvePositionConstraints(data) {
                    ...
                    C = b2Math_26.b2Clamp(C, 0, b2Settings_23.b2_maxLinearCorrection);
                    const impulse = -this.m_mass * C;
                    // b2Vec2 P = impulse * u;
...
System.register("Box2D/Dynamics/Joints/b2WeldJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_35, context_35) {
    ...
    var b2Settings_24, b2Math_27, b2Joint_11;
...
System.register("Box2D/Dynamics/Joints/b2WheelJoint", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Dynamics/Joints/b2Joint"], function(exports_36, context_36) {
    ...
    var b2Settings_25, b2Math_28, b2Joint_12;
        ...
        execute: function() {
            ...
            b2WheelJoint = class b2WheelJoint extends b2Joint_12.b2Joint {
                ...
                SolvePositionConstraints(data) {
                    ...
                    // data.positions[this.m_indexB].c = cB;
                    data.positions[this.m_indexB].a = aB;
                    return b2Math_28.b2Abs(C) <= b2Settings_25.b2_linearSlop;
                }
                GetDefinition(def) {
                    ///b2Assert(false); // TODO
                    return def;
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2ChainAndCircleContact", ["Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_38, context_38) {
    "use strict";
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2ChainAndPolygonContact", ["Box2D/Collision/b2CollideEdge", "Box2D/Collision/Shapes/b2EdgeShape", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_39, context_39) {
    "use strict";
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2EdgeAndCircleContact", ["Box2D/Collision/b2CollideEdge", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_41, context_41) {
    "use strict";
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact", ["Box2D/Collision/b2CollideEdge", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_42, context_42) {
    "use strict";
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/Contacts/b2PolygonContact", ["Box2D/Collision/b2CollidePolygon", "Box2D/Dynamics/Contacts/b2Contact"], function(exports_44, context_44) {
    "use strict";
...
System.register("Box2D/Dynamics/Contacts/b2ContactFactory", ["Box2D/Common/b2Settings", "Box2D/Dynamics/Contacts/b2ChainAndCircleContact", "Box2D/Dynamics/Contacts/b2ChainAndPolygonContact", "Box2D/Dynamics/Contacts/b2CircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndCircleContact", "Box2D/Dynamics/Contacts/b2EdgeAndPolygonContact", "Box2D/Dynamics/Contacts/b2PolygonAndCircleContact", "Box2D/Dynamics/Contacts/b2PolygonContact"], function(exports_45, context_45) {
    ...
    var b2Settings_26, b2ChainAndCircleContact_1, b2ChainAndPolygonContact_1, b2CircleContact_1, b2EdgeAndCircleContact_1, b2EdgeAndPolygonContact_1, b2PolygonAndCircleContact_1, b2PolygonContact_1;
        ...
        execute: function() {
            ...
            b2ContactFactory = class b2ContactFactory {
                ...
                AddType(createFcn, destroyFcn, type1, type2) {
                    const that = this;
                    const pool = b2Settings_26.b2MakeArray(256, function (i) { return createFcn(that.m_allocator); }); // TODO: b2Settings
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2ContactManager", ["Box2D/Collision/b2BroadPhase", "Box2D/Dynamics/Contacts/b2ContactFactory", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_46, context_46) {
    "use strict";
...
System.register("Box2D/Dynamics/Contacts/b2ContactSolver", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Dynamics/b2TimeStep"], function(exports_47, context_47) {
    ...
    var b2Settings_27, b2Math_29, b2Collision_8, b2TimeStep_1;
    ...
    return {
        ...
        execute: function() {
            b2VelocityConstraintPoint = class b2VelocityConstraintPoint {
                ...
                static MakeArray(length) {
                    return b2Settings_27.b2MakeArray(length, function (i) { return new b2VelocityConstraintPoint(); });
                }
            };
            ...
            b2ContactVelocityConstraint = class b2ContactVelocityConstraint {
                constructor() {
                    this.points = b2VelocityConstraintPoint.MakeArray(b2Settings_27.b2_maxManifoldPoints);
                ...
                static MakeArray(length) {
                    return b2Settings_27.b2MakeArray(length, function (i) { return new b2ContactVelocityConstraint(); });
                }
            };
            ...
            b2ContactPositionConstraint = class b2ContactPositionConstraint {
                constructor() {
                    this.localPoints = b2Math_29.b2Vec2.MakeArray(b2Settings_27.b2_maxManifoldPoints);
                ...
                static MakeArray(length) {
                    return b2Settings_27.b2MakeArray(length, function (i) { return new b2ContactPositionConstraint(); });
                }
            };
                ...
                InitializeVelocityConstraints() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            if (vRel < (-b2Settings_27.b2_velocityThreshold)) {
                ...
                SolvePositionConstraints() {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            C = b2Math_29.b2Clamp(b2Settings_27.b2_baumgarte * (separation + b2Settings_27.b2_linearSlop), (-b2Settings_27.b2_maxLinearCorrection), 0);
                    ...
                    return minSeparation > (-3 * b2Settings_27.b2_linearSlop);
                }
                SolveTOIPositionConstraints(toiIndexA, toiIndexB) {
                    ...
                    for (i = 0, ict = this.m_count; i < ict; ++i) {
                        ...
                        for (j = 0, jct = pointCount; j < jct; ++j) {
                            ...
                            minSeparation = b2Math_29.b2Min(minSeparation, separation);
                            // Prevent large corrections and allow slop.
                            C = b2Math_29.b2Clamp(b2Settings_27.b2_toiBaumgarte * (separation + b2Settings_27.b2_linearSlop), (-b2Settings_27.b2_maxLinearCorrection), 0);
                            // Compute the effective mass.
                            // float32 rnA = b2Cross(rA, normal);
                            rnA = b2Math_29.b2Vec2.CrossVV(rA, normal);
                            // float32 rnB = b2Cross(rB, normal);
                    ...
                    // We can't expect minSpeparation >= -b2_linearSlop because we don't
                    // push the separation above -b2_linearSlop.
                    return minSeparation >= -1.5 * b2Settings_27.b2_linearSlop;
                }
            };
...
System.register("Box2D/Dynamics/b2Island", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Timer", "Box2D/Dynamics/Contacts/b2ContactSolver", "Box2D/Dynamics/b2TimeStep", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_48, context_48) {
    ...
    var b2Settings_28, b2Settings_29, b2Settings_30, b2Settings_31, b2Math_30, b2Timer_2, b2ContactSolver_1, b2TimeStep_2, b2TimeStep_3, b2TimeStep_4, b2WorldCallbacks_3;
    var b2Island;
    return {
        setters:[
            function (b2Settings_28_1) {
                b2Settings_28 = b2Settings_28_1;
                b2Settings_29 = b2Settings_28_1;
                b2Settings_30 = b2Settings_28_1;
                b2Settings_31 = b2Settings_28_1;
            },
            ...
            b2Island = class b2Island {
                ...
                Solve(profile, step, gravity, allowSleep) {
                    ...
                    for (let i = 0; i < this.m_bodyCount; ++i) {
                        ...
                        if (b2Math_30.b2Vec2.DotVV(translation, translation) > b2Settings_29.b2_maxTranslationSquared) {
                            const ratio = b2Settings_29.b2_maxTranslation / translation.GetLength();
                            v.SelfMul(ratio);
                        }
                        const rotation = h * w;
                        if (rotation * rotation > b2Settings_30.b2_maxRotationSquared) {
                            const ratio = b2Settings_30.b2_maxRotation / b2Math_30.b2Abs(rotation);
                            w *= ratio;
                        }
                        // Integrate
                        c.x += h * v.x;
                    ...
                    if (allowSleep) {
                        let minSleepTime = b2Settings_28.b2_maxFloat;
                        const linTolSqr = b2Settings_31.b2_linearSleepTolerance * b2Settings_31.b2_linearSleepTolerance;
                        const angTolSqr = b2Settings_31.b2_angularSleepTolerance * b2Settings_31.b2_angularSleepTolerance;
                        for (let i = 0; i < this.m_bodyCount; ++i) {
                            const b = this.m_bodies[i];
                        ...
                        if (minSleepTime >= b2Settings_28.b2_timeToSleep && positionSolved) {
                            for (let i = 0; i < this.m_bodyCount; ++i) {
                                const b = this.m_bodies[i];
                                b.SetAwake(false);
                            }
...
System.register("Box2D/Dynamics/b2World", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Common/b2Timer", "Box2D/Common/b2Draw", "Box2D/Collision/b2Collision", "Box2D/Collision/b2TimeOfImpact", "Box2D/Dynamics/Joints/b2JointFactory", "Box2D/Dynamics/b2Body", "Box2D/Dynamics/b2ContactManager", "Box2D/Dynamics/b2Island", "Box2D/Dynamics/b2TimeStep", "Box2D/Dynamics/b2WorldCallbacks"], function(exports_49, context_49) {
    ...
    var b2Settings_32, b2Math_31, b2Timer_3, b2Draw_1, b2Collision_9, b2Collision_10, b2Collision_11, b2Collision_12, b2TimeOfImpact_4, b2TimeOfImpact_5, b2TimeOfImpact_6, b2JointFactory_1, b2Body_1, b2ContactManager_1, b2Island_1, b2TimeStep_5, b2TimeStep_6, b2WorldCallbacks_4, b2WorldCallbacks_5;
    var b2World;
    return {
        setters:[
        ...
        execute: function() {
            ...
            b2World = class b2World {
                ...
                QueryPoint(callback, point) {
                    ...
                    aabb.lowerBound.SetXY(point.x - b2Settings_32.b2_linearSlop, point.y - b2Settings_32.b2_linearSlop);
                    aabb.upperBound.SetXY(point.x + b2Settings_32.b2_linearSlop, point.y + b2Settings_32.b2_linearSlop);
                    broadPhase.Query(WorldQueryWrapper, aabb);
                }
                ...
                Dump(log) {
                    ...
                    log("const bodies: b2Body[] = new Array(%d);\n", this.m_bodyCount);
                    log("const joints: b2Joint[] = new Array(%d);\n", this.m_jointCount);
                    let i = 0;
                    for (let b = this.m_bodyList; b; b = b.m_next) {
                        b.m_islandIndex = i;
                        b.Dump(log);
                ...
                SolveTOI(step) {
                    ...
                    const island = this.m_island;
                    island.Initialize(2 * b2Settings_32.b2_maxTOIContacts, b2Settings_32.b2_maxTOIContacts, 0, null, this.m_contactManager.m_contactListener);
                    ...
                    for (;;) {
                        ...
                        for (let c = this.m_contactManager.m_contactList; c; c = c.m_next) {
                            ...
                            if (c.m_toiCount > b2Settings_32.b2_maxSubSteps) {
                                continue;
                            }
                            let alpha = 1;
                        ...
                        if (minContact === null || 1 - 10 * b2Settings_32.b2_epsilon < minAlpha) {
...
* 3. This notice may not be removed or altered from any source distribution.
*/
System.register("Box2D/Dynamics/b2Body", ["Box2D/Common/b2Math", "Box2D/Collision/Shapes/b2Shape", "Box2D/Dynamics/b2Fixture"], function(exports_50, context_50) {
    "use strict";
    var __moduleName = context_50 && context_50.id;
    var b2Math_32, b2Shape_6, b2Fixture_1;
...
System.register("Box2D/Dynamics/b2Fixture", ["Box2D/Common/b2Settings", "Box2D/Common/b2Math", "Box2D/Collision/b2Collision", "Box2D/Collision/Shapes/b2Shape"], function(exports_51, context_51) {
    ...
    var b2Settings_33, b2Math_33, b2Collision_13, b2Shape_7;
    ...
    return {
        ...
        execute: function() {
            ...
            b2FixtureProxy = class b2FixtureProxy {
                ...
                static MakeArray(length) {
                    return b2Settings_33.b2MakeArray(length, function (i) { return new b2FixtureProxy(); });
                }
            };
            ...
            Main = class Main {
                ...
                HandleMouseMove(e) {
                    ...
                    if (this.m_rMouseDown) {
                        ...
                        const viewCenter = box2d.b2Vec2.SubVV(this.m_viewCenter0, diff, new box2d.b2Vec2());
