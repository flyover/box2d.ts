    ...
    var b2World = (function () {
        ...
        b2World.prototype.Step = function (dt, velocityIterations, positionIterations) {
            ...
            if (this.m_stepComplete && step.dt > 0) {
                var timer_1 = new box2d.b2Timer();
                this.Solve(step);
                this.m_profile.solve = timer_1.GetMilliseconds();
            }
            // Handle TOI events.
            if (this.m_continuousPhysics && step.dt > 0) {
                var timer_2 = new box2d.b2Timer();
                this.SolveTOI(step);
...
})(box2d || (box2d = {})); // namespace box2d.Testbed
/// <reference path="../../../Box2D/Box2D/Box2D.ts"/>
            ...
            function Car(canvas, settings) {
                ...
                if (true) {
                    ...
                    for (var i = 0; i < N; ++i) {
                        ...
                        var anchor_1 = new box2d.b2Vec2(160.0 + 2.0 * i, -0.125);
                        jd.Initialize(prevBody, body, anchor_1);
                        this.m_world.CreateJoint(jd);
                        prevBody = body;
                    }
