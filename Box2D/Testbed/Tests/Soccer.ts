...
export class Soccer extends testbed.Test {

  private wallFixDef:box2d.b2FixtureDef;
  private ballFixDef:box2d.b2FixtureDef;
  private goalFixDef:box2d.b2FixtureDef;
  private heightShift = 15;
  ...
  private scale(x:number, y:number) {
    return function (v: box2d.b2Vec2) {
