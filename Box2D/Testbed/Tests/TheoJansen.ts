...
export class TheoJansen extends testbed.Test {
  m_offset = new box2d.b2Vec2();
  m_chassis: box2d.b2Body = null;
  m_wheel: box2d.b2Body = null;
  m_motorJoint: box2d.b2RevoluteJoint = null;
  m_motorOn = false;
  m_motorSpeed = 0;
  ...
  CreateLeg(s: number, wheelAnchor: box2d.b2Vec2) {
