...
export class Test extends box2d.b2ContactListener {
  ...
  static k_ParticleColors: box2d.b2Color[] = [
    ...
    new box2d.b2Color(0x00 / 0xff, 0x00 / 0xff, 0xff / 0xff, 0xff / 0xff), // blue
    new box2d.b2Color(0xff / 0xff, 0x8c / 0xff, 0x00 / 0xff, 0xff / 0xff), // orange
    new box2d.b2Color(0x00 / 0xff, 0xce / 0xff, 0xd1 / 0xff, 0xff / 0xff), // turquoise
    new box2d.b2Color(0xff / 0xff, 0x00 / 0xff, 0xff / 0xff, 0xff / 0xff), // magenta
    new box2d.b2Color(0xff / 0xff, 0xd7 / 0xff, 0x00 / 0xff, 0xff / 0xff), // gold
