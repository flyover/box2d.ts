...
System.register(["../common/b2_settings.js", "../common/b2_math.js", "./b2_joint.js", "../common/b2_draw.js"], function (exports_1, context_1) {
    "use strict";
    var b2_settings_js_1, b2_math_js_1, b2_joint_js_1, b2_draw_js_1, b2DistanceJointDef, b2DistanceJoint;
        ...
        execute: function () {
            ...
            b2DistanceJointDef = class b2DistanceJointDef extends b2_joint_js_1.b2JointDef {
                constructor() {
                    ...
                    this.length = 1;
                    this.minLength = 0;
                    this.maxLength = b2_settings_js_1.b2_maxFloat; // FLT_MAX;
                    this.stiffness = 0;
                    this.damping = 0;
                }
                Initialize(b1, b2, anchor1, anchor2) {
                    ...
                    this.length = b2_math_js_1.b2Max(b2_math_js_1.b2Vec2.DistanceVV(anchor1, anchor2), b2_settings_js_1.b2_linearSlop);
            ...
            b2DistanceJoint = class b2DistanceJoint extends b2_joint_js_1.b2Joint {
                constructor(def) {
                    ...
                    this.m_length = b2_math_js_1.b2Max(b2_settings_js_1.b2Maybe(def.length, this.GetCurrentLength()), b2_settings_js_1.b2_linearSlop);
                    this.m_minLength = b2_math_js_1.b2Max(b2_settings_js_1.b2Maybe(def.minLength, this.m_length), b2_settings_js_1.b2_linearSlop);
                    this.m_maxLength = b2_math_js_1.b2Max(b2_settings_js_1.b2Maybe(def.maxLength, this.m_length), this.m_minLength);
                ...
                SetLength(length) {
                    this.m_impulse = 0;
                    this.m_length = b2_math_js_1.b2Max(b2_settings_js_1.b2_linearSlop, length);
                ...
                SetMinLength(minLength) {
                    this.m_lowerImpulse = 0;
                    this.m_minLength = b2_math_js_1.b2Clamp(minLength, b2_settings_js_1.b2_linearSlop, this.m_maxLength);
                    return this.m_minLength;
                }
                SetMaxLength(maxLength) {
                    this.m_upperImpulse = 0;
                    this.m_maxLength = b2_math_js_1.b2Max(maxLength, this.m_minLength);
                    return this.m_maxLength;
                }
                GetCurrentLength() {
                    const pA = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, new b2_math_js_1.b2Vec2());
                    const pB = this.m_bodyB.GetWorldPoint(this.m_localAnchorB, new b2_math_js_1.b2Vec2());
                    return b2_math_js_1.b2Vec2.DistanceVV(pA, pB);
                }
                ...
                InitVelocityConstraints(data) {
                    ...
                    if (this.m_currentLength > b2_settings_js_1.b2_linearSlop) {
                    ...
                    if (data.step.warmStarting) {
                        ...
                        const P = b2_math_js_1.b2Vec2.MulSV(this.m_impulse + this.m_lowerImpulse - this.m_upperImpulse, this.m_u, b2DistanceJoint.InitVelocityConstraints_s_P);
                ...
                SolveVelocityConstraints(data) {
                    ...
                    if (this.m_minLength < this.m_maxLength) {
                        ...
                        // lower
                        {
                            ...
                            const bias = b2_math_js_1.b2Max(0, C) * data.step.inv_dt;
                            const vpA = b2_math_js_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                            const vpB = b2_math_js_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                            const Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_u, b2_math_js_1.b2Vec2.SubVV(vpB, vpA, b2_math_js_1.b2Vec2.s_t0));
                            let impulse = -this.m_mass * (Cdot + bias);
                            const oldImpulse = this.m_lowerImpulse;
                            this.m_lowerImpulse = b2_math_js_1.b2Max(0, this.m_lowerImpulse + impulse);
                        ...
                        // upper
                        {
                            ...
                            const vpA = b2_math_js_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
                            const vpB = b2_math_js_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
                            const Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_u, b2_math_js_1.b2Vec2.SubVV(vpA, vpB, b2_math_js_1.b2Vec2.s_t0));
                            let impulse = -this.m_mass * (Cdot + bias);
                            const oldImpulse = this.m_upperImpulse;
                            this.m_upperImpulse = b2_math_js_1.b2Max(0, this.m_upperImpulse + impulse);
                ...
                Draw(draw) {
                    ...
                    const pA = b2_math_js_1.b2Transform.MulXV(xfA, this.m_localAnchorA, b2DistanceJoint.Draw_s_pA);
                    const pB = b2_math_js_1.b2Transform.MulXV(xfB, this.m_localAnchorB, b2DistanceJoint.Draw_s_pB);
                    const axis = b2_math_js_1.b2Vec2.SubVV(pB, pA, b2DistanceJoint.Draw_s_axis);
                    axis.Normalize();
                    ...
                    const pRest = b2_math_js_1.b2Vec2.AddVMulSV(pA, this.m_length, axis, b2DistanceJoint.Draw_s_pRest);
                    draw.DrawPoint(pRest, 8.0, c1);
                    if (this.m_minLength != this.m_maxLength) {
                        if (this.m_minLength > b2_settings_js_1.b2_linearSlop) {
                            // b2Vec2 pMin = pA + this.m_minLength * axis;
                            const pMin = b2_math_js_1.b2Vec2.AddVMulSV(pA, this.m_minLength, axis, b2DistanceJoint.Draw_s_pMin);
                            draw.DrawPoint(pMin, 4.0, c2);
                        }
                        if (this.m_maxLength < b2_settings_js_1.b2_maxFloat) {
                            // b2Vec2 pMax = pA + this.m_maxLength * axis;
                            const pMax = b2_math_js_1.b2Vec2.AddVMulSV(pA, this.m_maxLength, axis, b2DistanceJoint.Draw_s_pMax);
            ...
            b2DistanceJoint.Draw_s_pA = new b2_math_js_1.b2Vec2();
            b2DistanceJoint.Draw_s_pB = new b2_math_js_1.b2Vec2();
            b2DistanceJoint.Draw_s_axis = new b2_math_js_1.b2Vec2();
            b2DistanceJoint.Draw_s_c1 = new b2_draw_js_1.b2Color(0.7, 0.7, 0.7);
            b2DistanceJoint.Draw_s_c2 = new b2_draw_js_1.b2Color(0.3, 0.9, 0.3);
            b2DistanceJoint.Draw_s_c3 = new b2_draw_js_1.b2Color(0.9, 0.3, 0.3);
            b2DistanceJoint.Draw_s_c4 = new b2_draw_js_1.b2Color(0.4, 0.4, 0.4);
            b2DistanceJoint.Draw_s_pRest = new b2_math_js_1.b2Vec2();
            b2DistanceJoint.Draw_s_pMin = new b2_math_js_1.b2Vec2();
            b2DistanceJoint.Draw_s_pMax = new b2_math_js_1.b2Vec2();
        }
    };
});
