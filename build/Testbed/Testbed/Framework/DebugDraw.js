...
class DebugDraw extends box2d.b2Draw {
    ...
    DrawPoint(p, size, color) {
        ...
        if (ctx) {
            ctx.fillStyle = color.MakeStyleString();
            size *= exports.g_camera.m_zoom;
            size /= exports.g_camera.m_extent;
            const hsize = size / 2;
    ...
    DrawStringWorld(x, y, message) {
        ...
        if (ctx) {
            ...
            // world -> viewport
            const vt = exports.g_camera.m_center;
            box2d.b2Vec2.SubVV(p, vt, p);
            ///const vr = g_camera.m_roll;
            ///box2d.b2Rot.MulTRV(vr, p, p);
            const vs = exports.g_camera.m_zoom;
            box2d.b2Vec2.MulSV(vs, p, p);
            // viewport -> canvas
            const cs = exports.g_camera.m_extent;
...
exports.g_debugDraw = new DebugDraw();
exports.g_camera = new Camera();
