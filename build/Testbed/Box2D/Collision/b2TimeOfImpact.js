...
const b2Timer_1 = require("../Common/b2Timer");
const b2Distance_1 = require("./b2Distance");
...
const b2TimeOfImpact_s_xfA = new b2Math_1.b2Transform();
const b2TimeOfImpact_s_xfB = new b2Math_1.b2Transform();
const b2TimeOfImpact_s_pointA = new b2Math_1.b2Vec2();
const b2TimeOfImpact_s_pointB = new b2Math_1.b2Vec2();
const b2TimeOfImpact_s_normal = new b2Math_1.b2Vec2();
const b2TimeOfImpact_s_axisA = new b2Math_1.b2Vec2();
const b2TimeOfImpact_s_axisB = new b2Math_1.b2Vec2();
...
const b2TimeOfImpact_s_timer = new b2Timer_1.b2Timer();
const b2TimeOfImpact_s_cache = new b2Distance_1.b2SimplexCache();
const b2TimeOfImpact_s_distanceInput = new b2Distance_1.b2DistanceInput();
const b2TimeOfImpact_s_distanceOutput = new b2Distance_1.b2DistanceOutput();
const b2TimeOfImpact_s_fcn = new b2SeparationFunction();
const b2TimeOfImpact_s_indexA = [0];
const b2TimeOfImpact_s_indexB = [0];
const b2TimeOfImpact_s_sweepA = new b2Math_1.b2Sweep();
const b2TimeOfImpact_s_sweepB = new b2Math_1.b2Sweep();
