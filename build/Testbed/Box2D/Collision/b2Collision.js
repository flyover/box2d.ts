...
const b2TestOverlapShape_s_input = new b2Distance_1.b2DistanceInput();
const b2TestOverlapShape_s_simplexCache = new b2Distance_1.b2SimplexCache();
const b2TestOverlapShape_s_output = new b2Distance_1.b2DistanceOutput();
