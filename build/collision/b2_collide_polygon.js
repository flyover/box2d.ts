...
System.register(["../common/b2_settings.js", "../common/b2_math.js", "./b2_collision.js"], function (exports_1, context_1) {
    "use strict";
    var b2_settings_js_1, b2_math_js_1, b2_collision_js_1, b2FindMaxSeparation_s_xf, b2FindMaxSeparation_s_n, b2FindMaxSeparation_s_v1, b2FindIncidentEdge_s_normal1, b2CollidePolygons_s_incidentEdge, b2CollidePolygons_s_clipPoints1, b2CollidePolygons_s_clipPoints2, b2CollidePolygons_s_edgeA, b2CollidePolygons_s_edgeB, b2CollidePolygons_s_localTangent, b2CollidePolygons_s_localNormal, b2CollidePolygons_s_planePoint, b2CollidePolygons_s_normal, b2CollidePolygons_s_tangent, b2CollidePolygons_s_ntangent, b2CollidePolygons_s_v11, b2CollidePolygons_s_v12;
    ...
    function b2FindMaxSeparation(edgeIndex, poly1, xf1, poly2, xf2) {
        ...
        const xf = b2_math_js_1.b2Transform.MulTXX(xf2, xf1, b2FindMaxSeparation_s_xf);
        let bestIndex = 0;
        let maxSeparation = -b2_settings_js_1.b2_maxFloat;
        for (let i = 0; i < count1; ++i) {
            // Get poly1 normal in frame2.
            const n = b2_math_js_1.b2Rot.MulRV(xf.q, n1s[i], b2FindMaxSeparation_s_n);
            const v1 = b2_math_js_1.b2Transform.MulXV(xf, v1s[i], b2FindMaxSeparation_s_v1);
            // Find deepest point for normal i.
            let si = b2_settings_js_1.b2_maxFloat;
            for (let j = 0; j < count2; ++j) {
                const sij = b2_math_js_1.b2Vec2.DotVV(n, b2_math_js_1.b2Vec2.SubVV(v2s[j], v1, b2_math_js_1.b2Vec2.s_t0));
                if (sij < si) {
                    si = sij;
                }
            }
    ...
    function b2CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
        ...
        let flip = 0;
        const k_tol = 0.1 * b2_settings_js_1.b2_linearSlop;
    ...
    return {
        ...
        execute: function () {
            ...
            b2FindMaxSeparation_s_xf = new b2_math_js_1.b2Transform();
            b2FindMaxSeparation_s_n = new b2_math_js_1.b2Vec2();
            b2FindMaxSeparation_s_v1 = new b2_math_js_1.b2Vec2();
            ...
            b2CollidePolygons_s_incidentEdge = [new b2_collision_js_1.b2ClipVertex(), new b2_collision_js_1.b2ClipVertex()];
            b2CollidePolygons_s_clipPoints1 = [new b2_collision_js_1.b2ClipVertex(), new b2_collision_js_1.b2ClipVertex()];
            b2CollidePolygons_s_clipPoints2 = [new b2_collision_js_1.b2ClipVertex(), new b2_collision_js_1.b2ClipVertex()];
